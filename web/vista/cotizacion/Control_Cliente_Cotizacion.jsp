...
<html>
    ...
    <body onload="listClients()">
        ...
        <div class="page-header">
            <div  class="h5 titulo bg-success" ><i class="fas fa-dollar-sign"></i> COTIZACION  </div> </div>
        <div id ="tabs" class="container col-12">

            <div id ="alertas"></div>
            <ul class="nav nav-tabs" id="contenedor">
                <li class="nav-item" style="font-weight: bold" >
                    <a class="nav-link active" data-toggle="tab" href="#COTIZACION"><i class="fas fa-user-shield"></i> COTIZACIÓN</a>
                </li>
                   <li class="nav-item" style="font-weight: bold">
                ...
                <li class="nav-item" style="font-weight: bold">
                    <a class="nav-link" data-toggle="tab" href="#REPORTE">  <i class="fas fa-clipboard-list"></i> REPORTE</a>
            ...
            <div class="tab-content">
                ...
                <div id="COTIZACION" class="container tab-pane  active   col-12">  <div class="content-wrapper">
...
Cordialmente,</textarea>
                                ...
                                <div class="input-group mb-2 input-group-sm mt-3">
                                    ...
                                    <div class="input-group-append">
                                        <select title="Cliente" class="custom-select-sm  " name="listaclientes" onchange="listRefs()" id="listaCliente2">
                                            ...
                                            <%
                                                DAO_Cliente dao2 = new DAO_Cliente();
                        ...
                        <div id="REPORTE" class="container tab-pane fade col-12">
                            <form method="POST" action="GralControladorServlet">
                                <div class="panel panel-primary">
                                    <div class="input-group mb-2 input-group-sm"> 
                                        ...
                                        <select title="Cliente" class="custom-select-sm  " name="listaClientes4" onchange="listRefsRevenue()" id="listaClientes4">
                                            <option class="text-md-center" value ="0" >Todos</option>    
                                            <%
                                        ...
                                        <div class="input-group-append">
                                            <button id ="botonBuscarReporteMargenes" class="btn btn-outline-success  btn-sm"  type="button" onclick="listRefsRevenue()" title="Buscar margenes"><span class="fa fa-search"></span> Buscar </button>  
                                            <button type="submit" value="ImprimirPDFReporte" name ="xoption" class="btn btn-outline-success  btn-sm" style="margin-right: 5px;">
                                                <i class="fa fa-file-pdf"></i> Generar PDF
                                            </button>
                                            <input type="hidden" name="nombrePaginaRequest" value="/potPermisoCotizacion.ctr">
        ...
        <script src="resourcs/js/cotizacion/cotizacion.js"></script>
