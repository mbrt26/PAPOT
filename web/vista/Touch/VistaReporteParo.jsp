...
<html>
    ...
    <body onload="printListaMaquinasReporteUnaVez()">
        ...
        <div class="page-header">
            <div class="p-1 h5 titulo bg-success "><i class="fas fa-stopwatch"></i> HISTORIAL PARO </div>
        </div>
    </form>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="input-group mb-0 input-group-sm ">
                    ...
                    <select title="Operador" class="custom-select  col-md-8" name="listaOperadores" id="listaOperadores">
        ...
        <nav class="navbar navbar-expand-lg mb-2    navbar-dark bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="input-group mb-2 input-group-sm">
                    ...
                    <select id="listaProcesos" name="listaProcesos" title="Proceso" onchange="printListaMaquinas()" class="custom-select col-md-2">
                        <option class="text-md-center" value ="0" >TODOS</option>    
                    ...
                    <div class="input-group-append">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" id="botonBuscarTraslado" onclick="consultarHistorico()" class="btn btn-outline-success btn-sm ">
    ...
    <!--script src="resourcs/js/chart-bar-demo.js"></script-->
    <!--script src="resourcs/js/chart-pie-demo.js"></script-->
