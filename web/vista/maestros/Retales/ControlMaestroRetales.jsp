...
<html>
    ...
    <body onload="cargarBodegas()" >
        ...
        <div  class="h5 titulo" >MAESTRO RETALES</div> 
        <div class="container col-12">
            <div class="input-group mb-3 input-group-sm">
                <div class="input-group-prepend">
                    <span class="input-group-text">RETAL</span>
                </div>
                <input class="form-control input-group-append" type="text" id ="bodega" title="Escriba el nombre del retal" placeholder="Nombre del nuevo Retal" onkeypress="validar(event)">
            ...
            <script src="resourcs/js/maestros/retales/retales.js"></script>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header tituloModal">
                            <h5 class="modal-title text-md-left ">EDITA RETAL</h5>
                        ...
                        <div class="modal-body container">
                            <table border="0" width="100%" class="table table-sm">
                                <thead class="thead-light">
                                    <tr>
                                        <th width="100%" class="text-md-center">RETAL</th>
                                    </tr>
                                    <tr>
                                        <td align="center">
