function cargarBodegas() {
    ...
    $.post('UnidadesServlet', {xopcion: 'listaBodegas'}, function (e) {
        $('#detalle').html(e);
    });
}
function creaBodega() {
    ...
    if (bod == "") {
        ...
        $.post('UnidadesServlet', {xopcion: 'crear', xbodega: bod}, function (e) {
            $('#detalle').html(e);
            $('#bodega').val('');
            $('#bodega').focus();
...
function editar(_id) {
    $.post('UnidadesServlet', {xopcion: 'ListaBodegaEditar', xskmarca: _id}, function (e) {
...
function ActualizarBodega() {
    ...
    $.post('UnidadesServlet', {xopcion: 'ActualizarNombre', xnombre: nombre, skbodega: bodega}, function (e) {
        $('#detalle').html(e);
    });
}
...
function eliminar(_id) {
    $.post('UnidadesServlet', {xopcion: 'EliminaBodega', skbodega: _id}, function (e) {
        $('#detalle').html(e);
    });
}
