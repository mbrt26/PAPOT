...
function focusCantRetal() {
    ...
    if (validado && (listaTurnos.selectedIndex !== 0 || !(idProceso == '6' || idProceso == '5' || idProceso == '4'))) {
        ...
        if (listaTurnos.selectedIndex === 0 && (idProceso == '6'||idProceso == '5' || idProceso == '4')) {
...
function guardarRetal() {
    ...
    document.getElementById('orden').setAttribute('disabled', true);
    document.getElementById('guardarRetal').setAttribute('disabled', true);
    document.getElementById('listaProcesos').setAttribute('disabled', true);
    document.getElementById('ControlTextarea').setAttribute('disabled', true);
    document.getElementById('listaMaquinas').setAttribute('disabled', true);
    ...
    $.post('TouchRetalServlet', {xopcion: 'guardarRetal',
        idProceso: idProceso, idDcto: idDcto, idRetal: idRetal,
        idOperador: idOperador, comentario: comentario, cantidad: cantidad,
        idMaquina: idMaquina, fechaProduccion: fechaProduccion, listaTurnos: listaTurnos},
            function (e) {
...
function consultarHistorico() {
    ...
    $.post('TouchRetalServlet', {xopcion: 'printHistorial', fechaInicial: fechaInicial, fechaFinal: fechaFinal,
