<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngRemisionFacturaRemision.jsp">
            <input type="hidden" name="xIdCliente" value="<%=fachadaDctoOrdenBean.getIdCliente()%>">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">ELABORA REMISION</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                ...
                idClienteTag = "<%=fachadaDctoOrdenBean.getIdCliente()%>">
                    ...
                    <tr>
                        <td width="1%" align="center" class="letraDetalle">
                            <input type="checkbox" name="xLocalTipoOrdenOrdenItem" value="<%=idLocalVar%>~<%=idTipoOrdenVar%>~<%=idOrdenVar%>~<%=itemVar%>~<%=cantidadTerminadaStrVar%>~<%=idOperacionVar%>"/>
                        </td>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="25%" align="center" class="letraTitulo">
                        <input type="submit" value="Trae Remision" name="accionContenedor">
                    </td>
