  ...
  <lista:listaDetallePedidoIdLog idOrdenTag = "<%=fachadaColaboraDctoOrdenBean.getIdOrdenStr()%>"
	...
	<tr>
       ...
       <table border="1" width="100%" id="table5">
		<tr>
			<td><input type="submit" value="Regresar" name="accionContenedor" style="font-weight: 700"></td>
			<td><input type="submit" value="Autorizar" name="accionContenedor" style="font-weight: 700"></td>
			<td><input type="submit" value="Cancelar" name="accionContenedor" style="font-weight: 700"></td>
		</tr>
       </table>

       <font face="Verdana">

       <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstClienteAutorizaPedidoFinanciero.jsp" style="font-weight: 700">
