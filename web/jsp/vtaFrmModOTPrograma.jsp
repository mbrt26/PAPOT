<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaOTUnMaquina.tld" prefix="lsu" %>
    ...
    <head>
        <title>Modifica Maquina Orden Trabajo</title>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmModOTPrograma.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">MODIFICA MAQUINA ORDEN TRABAJO</td>
            ...
            <table border="0" width="90%" id="tablaDetalle">
                <tr>
                    <td width="!%" align="right" class="letraTitulo">&nbsp;</td>
                ...
                <lsu:listaOTUnMaquina idLocalTag  = "<%=fachadaPluFicha.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="1%" align="center" class="letraDetalle">
                            <input type="checkbox" name="xLocalTipoOrdenOrdenItem" value="<%=idLocalVar%>~<%=idTipoOrdenVar%>~<%=idOrdenVar%>~<%=itemPadreVar%>"/>
                        </td>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="33%" class="letraTitulo">
                        <input type="submit" value="Modificar Maquina" name="accionContenedor">
                    </td>
                </tr>
            </table>
