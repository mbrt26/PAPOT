...
<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorResurtidoNota.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    <!--td width="33%" align="center" class="letraTitulo">
                        <input type="text" name="fechaInicial" size="10" value="<--%=fachadaColaboraReporteDctoBean.getFechaInicial()%>">
                    </td-->
                    <td width="33%" align="center" class="letraTitulo">
                        <input type="text" name="fechaInicial" id="fechainicial" readonly="readonly"
                               value="<%=fachadaColaboraReporteDctoBean.getFechaInicial()%>"/>
                        <img src="./img/img.gif" id="selectorinicial" />
                    </td>

                    <!--td width="34%" align="center" class="letraTitulo">
                        <input type="text" name="fechaFinal" size="10" value="<--%=fachadaColaboraReporteDctoBean.getFechaFinal()%>">
                    </td-->

                    <td width="34%" align="center" class="letraTitulo">
                        <input type="text" name="fechaFinal" id="fechafinal" readonly="readonly"
