<html>
    <head>
        <title>Movimiento Ajuste M.P.</title>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaAllOpcion" prefix="lsu" %>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorInventarioAjuste.jsp">
            <input type="hidden" name="xIdTercero" value="<%=fachadaDctoOrdenBean.getIdCliente()%>">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">MOVIMIENTO AJUSTE M.P.</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="25%" align="center" class="letraDetalle">
                        <select name="xIdTipoOrden">
                            <lsu:listaAllOpcion idTipoOrdenOpcionTag="<%=xIdTipoOrdenOpcion%>">
