<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmTieOTProducto.jsp">
                ...
                numeroOrdenTag  = "<%=fachadaPluFicha.getNumeroOrdenStr()%>">
                    <tr>
                        <td width="5%" align="right" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmTieOTProducto.jsp&accionContenedor=traetiempo&xIdLocal=<%=fachadaPluFicha.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaPluFicha.getIdTipoOrdenStr()%>&xIdOperacion=<%=fachadaPluFicha.getIdOperacionStr()%>&xIdLog=<%=idLogVar%>&xNumeroOrden=<%=numeroOrdenVar%>&xItem=<%=itemVar%>"><%=numeroOrdenVar%></a>
                        </td>
