...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorEmpresaHPagoCxP.jsp">
<input type="hidden" name="xIdCliente" value="<%=fachadaTerceroBean.getIdCliente()%>">
<input type="hidden" name="xIdTipoOrden" value="<%=fachadaTerceroBean.getIdTipoTerceroStr()%>">
