<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmRetOTExterna.jsp">
            ...
            <input type="hidden" name="xIdOrdenCruce" value="<%=fachadaDctoOrdenProgreso.getIdOrdenCruceStr()%>">            
