<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmModClienteElaboraPedido.jsp">
            <input type="hidden" name="item" value="<%=xItem%>">
            <input type="hidden" name="idLog" value="<%=xIdLog%>">
            <input type="hidden" name="vrVentaUnitario" value="<%=fachadaDctoOrdenDetalleBean.getVrVentaUnitarioSf0()%>">
            <input type="hidden" name="xPorcentajeDescuento" value="<%=fachadaDctoOrdenDetalleBean.getPorcentajeDsctoStr()%>">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    ...
                    <td width="34%" align="center" class="letraDetalle"><%=fachadaDctoOrdenDetalleBean.getVrVentaUnitarioSf0()%>
                    </td>
                    <td width="33%" align="center" class="letraDetalle"><%=fachadaDctoOrdenDetalleBean.getPorcentajeDsctoStr()%>
                    </td>
                </tr>
            </table>
