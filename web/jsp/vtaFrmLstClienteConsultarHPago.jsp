...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstClienteConsultarHPago.jsp">
    ...
    <lista:listaHPagoCxC idLocalTag  = "<%=fachadaColaboraLogisticaBean.getIdLocalStr()%>"
            ...
            <tr>
                <td width="10%" align="center" class="letraDetalle">
                    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstClienteConsultarHPago.jsp&accionContenedor=listaRecibo&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=fachadaColaboraLogisticaBean.getIdTipoOrdenStr()%>&xIndicador=<%=indicadorVar%>&xIdRecibo=<%=idReciboVar%>"><%=idReciboVar%></a>
                </td>
                ...
                <td width="10%" align="center" class="letraDetalle">
                    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstClienteConsultarHPago.jsp&accionContenedor=listaPlanilla&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=fachadaColaboraLogisticaBean.getIdTipoOrdenStr()%>&xIdPlanilla=<%=idPlanillaVar%>"><%=idPlanillaVar%></a>
                </td>
            </tr>
