...
<html>
<head>
    <title>Reporte Resurtido Autoconsumo</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepResurtidoAutoconsumo.jsp">

        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE RESURTIDO AUTOCONSUMO</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
        ...
        <table border="0" width="90%" id="tablaTitulo">
            ...
            <tr>
                    ...
                    <td width="33%" align="center" class="letraTitulo">ALCANCE</td>
            </tr>
            ...
            <tr>
                ...
                <td width="33%" align="center" class="letraDetalle">
                     <jsp:include page="./comboUsuarioLocalTodos.jsp"/>
                    </td>
            </tr>
