<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaPrecioListaActivo" prefix="lista" %>
    ...
    <head>
        <title>Adicionar Productos Despacho</title>
        <link href="./styles/estiloTabla.css" rel="stylesheet" type="text/css">
        <link href="./styles/estiloLetra.css" rel="stylesheet" type="text/css">
        
        <script language="javascript" src="js/validadorTiposDeDatos.js"></script>
        
    </head>
    <body>

        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstResurtidoTrasladoManual.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">ADICIONAR PRODUCTOS TRASLADO MANUAL</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="5%" align="right" class="letraTitulo">SUBTOTAL</td>
                    <td width="35%" nowrap align="left" class="letraTitulo">NOMBRE REFERENCIA</td>
                ...
                <lista:listaPrecioListaActivo idLineaTag = "<%=fachadaColaboraHistoriaBean.getIdLinea()%>"
                    ...
                    <tr>
                        ...
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="chkCantidad" id="chkCantidad" value="" size="6"
                                   onkeypress='return aceptarNum(event)'>
                        </td>
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="chkSubtotal" id="chkSubtotal" value="" size="6"
                                   onkeypress='return aceptarNum(event)'>
                        </td>
                        <td width="35%" nowrap align="left" class="letraDetalle">
                            <%=nombrePluVar.trim()%>
                        </td>
