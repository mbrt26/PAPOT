...
<%@ taglib uri="/WEB-INF/tlds/listaPlanillaVendedor" prefix="lst" %>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstPagoCxCPlanilla.jsp">
    ...
    <lst:listaPlanillaVendedor idLocalTag="<%=fachadaPagoBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="10%" align="center" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstPagoCxCPlanilla.jsp&accionContenedor=listaPlanilla&xIdLocal=<%=fachadaPagoBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaPagoBean.getIdTipoOrdenStr()%>&xIdPlanilla=<%=idPlanillaVar%>"><%=idPlanillaVar%></a>
                </td>
