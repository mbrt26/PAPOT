            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    <td width="33%" align="center" class="letraResaltadaTitulo">
                        <select name='xIdOperacion' onchange=location.href="GralControladorServlet?nombrePaginaRequest=/potPermisoAdmOTPrograma.ctr&xIdOperacion="+xIdOperacion.value+"&xFechaPrograma="+xFechaPrograma.value>
