...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmConInventarioAjuste.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="34%" align="center" class="letraTitulo">LISTA AJUSTE</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
    ...
    <lst:listaResurtidoAjuste idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmConInventarioAjuste.jsp&accionContenedor=tomar&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrden=<%=idOrdenVar%>"><%=idDctoVar%></a>
            </td>
