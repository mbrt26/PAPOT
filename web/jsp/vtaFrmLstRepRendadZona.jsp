<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaAudtoriarepRentabilidadZona" prefix="lst" %>
    ...
    <body>
        ...
        <table border="2" width="90%" id="tablaTitulo">
            <tr bgcolor="green">
            <b>
                <td width="40%" align="left" class="letraTitulo">ZONA GEOGRAFICA</td>
            ...
            <lst:listaAudtoriarepRentabilidadZona
                ...
                <tr>
                    <td width="40%" align="right" class="letraDetalle"><%=zonaVar%></td>
