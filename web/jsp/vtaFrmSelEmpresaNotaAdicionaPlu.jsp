<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelEmpresaNotaAdicionaPlu.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">REFERENCIAS NOTA CREDITO
                        <br> FACTURA ORIGEN <%=fachadaDctoBean.getIdDctoStr()%>
                    </td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                indicadorTag = "<%=fachadaDctoBean.getIndicadorStr()%>">
                    ...
                    <input type="hidden" name="chkUnidadVenta" value="<%=unidadVentaVar%>">
                    <input type="hidden" name="chkItem" value="<%=itemVar%>">
                    <tr>
                        ...
                        <td width="10%" align="right" class="letraDetalle">
                            <input type="text"   name="chkPesoFacturado" value="" size="6">
                        </td>
                        <td width="10%" align="right" class="letraDetalle">
                            <%=pesoFacturadoVar%>
                        </td>
