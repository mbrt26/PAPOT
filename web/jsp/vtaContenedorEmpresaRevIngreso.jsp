...
<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorEmpresaRevIngreso.jsp">
            <input type="hidden" name="xIdAlcance" value="<%=fachadaDctoOrdenBean.getIdAlcanceStr()%>">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo"><%=fachadaDctoOrdenBean.getTituloConsulta()%></td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
