...
<%@ taglib uri="/WEB-INF/tlds/listaOrdenResurtido" prefix="lst" %>
...
<head>
    <title>SELECCIONA TRASLADO</title>
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmTraeResurtidoDespacho.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>       
        <td width="10%" align="right" class="letraTitulo">#ORDEN TRASLADO</td>
     ...
     <lst:listaOrdenResurtido idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
                          idTerceroTag="<%=fachadaDctoOrdenBean.getIdCliente()%>"
                          idTipoOrdenTag="<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>"
                          idLocalOrigenTag="<%=fachadaDctoOrdenBean.getIdCliente()%>">
        <tr>
            <td width="10%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmTraeResurtidoDespacho.jsp&accionContenedor=selecciona_traslado&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrdenOrigen=<%=idOrdenOrigenVar%>"><%=idOrdenOrigenVar%></a>
            </td>
