<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaResurtidoTrasladoDetalleTx" prefix="lst" %>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLegResurtidoTrasladoTx.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <lst:listaResurtidoTrasladoDetalleTx idLocalTag="<%=fachadaColaboraDctoOrdenBean.getIdLocalStr()%>"
                     ...
                     <input type="hidden" name="xVrCosto" value="<%=vrCostoVar%>">
                     <input type="hidden" name="xVrCostoIND" value="<%=vrCostoINDVar%>">
                    <tr>
                ...
                </lst:listaResurtidoTrasladoDetalleTx>
            </table>
