...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelEmpresaElaboraProveedorAdicionaPlu.jsp">

<table border="0" width="100%" id="tablaTitulo">
    <tr>
...
<table border="0" width="100%" id="tablaTitulo">
    <tr>
        ...
        <td width="10%" align="right" class="letraTitulo">VR.COSTO</td>
        <td width="5%" align="center" class="letraTitulo">REF</td>
        <td width="10%" align="right" class="letraTitulo">VR.VTA</td>
        <% if (inventarioVisible) {%> <td width="5%" align="right" class="letraTitulo">EXISTENCIA</td> <%}%>
    </tr>
    ...
    <lista:listaGrupoNombrePlu idLineaTag = "<%=fachadaColaboraHistoriaBean.getIdLinea()%>"
        ...
        <tr>
            ...
            <td width="10%" align="right" class="letraDetalle">
                <input type="text"   name="chkVrSubtotal" value="" size="12">
            </td>
            ...
            <% if (inventarioVisible) {%> <td width="5%" align="right" class="letraDetalle"><%=existenciaVar%></td> <%}%>
        </tr>
