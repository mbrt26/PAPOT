...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLiqPagoCxP.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    ...
    <input type="hidden" name="xIdDctoNitCC" value=<%=fachadaPagoBean.getIdDctoNitCC()%>>
    ...
    <tr>
        <td width="10%" align="center" class="letraTitulo"><%=fachadaPagoBean.getIdDctoNitCC()%></td>
