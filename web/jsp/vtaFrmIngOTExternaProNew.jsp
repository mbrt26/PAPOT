<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngOTExternaProNew.jsp">
            ...
            <input type="hidden" name="xCantidadTerminada" value="0">
            <input type="hidden" name="xIdOT" value="<%=fachadaDctoOrdenBean.getNumeroOrdenStr()%>">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">
                        <input type="submit" value="Guarda Salida" name="accionContenedor">
                    </td>
                    <td width="34%" align="center" class="letraTitulo">
                        <input type="submit" value="Elabora Entrada" name="accionContenedor">                        
                    </td>
                </tr>
            </table>
