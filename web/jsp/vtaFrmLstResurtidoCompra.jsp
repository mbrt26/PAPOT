...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstResurtidoCompra.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="34%" align="center" class="letraTitulo">Lista Resurtido Compra</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
    ...
    <lst:listaLegalizaAll idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoCompra.jsp&accionContenedor=coger&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>"><%=idOrdenVar%></a>
            </td>
            ...
            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoCompra.jsp&accionContenedor=cumplir&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>">Cumplida</a>
            </td>
