...
<html>
<head>
    <title>Reporte Resurtido Compra</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepResurtidoCompra.jsp">

        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE RESURTIDO COMPRA</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
