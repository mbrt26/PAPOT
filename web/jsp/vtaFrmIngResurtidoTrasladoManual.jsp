<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngResurtidoTrasladoManual.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">TRASLADO MANUAL</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                ...
                <lsu:liquidaOrden idTipoOrdenTag="<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>"
                    ...
                    <tr>
                        ...
                        <td width="33%" align="right" class="letraDetalle"><%=vrCostoSinIvaVar%></td>
                    </tr>
                ...
                <lsv:listaOrden idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="5%"  nowrap align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngResurtidoTrasladoManual.jsp&accionContenedor=retira&xItem=<%=itemVar%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTercero=<%=fachadaDctoOrdenBean.getIdCliente()%>&xFechaCorte=<%=fachadaDctoOrdenBean.getFechaOrdenCorta()%>">R</a>
                        </td>
                        ...
                        <!--td width="15%" nowrap align="right" class="<!--%=letraDetalleInventarioVar%>"><!--%=vrCostoSinIvaVar%></td-->
                    </tr>
