<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmModEmpresaElaboraRetiraPlu.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="25%" align="center" class="letraTitulo">NUEVA CANTIDAD</td>
                    <td width="25%" align="center" class="letraTitulo">NUEVO VR.UNITARIO</td>
                    <td width="25%" align="center" class="letraTitulo">%DESCUENTO</td>
                    <td width="25%" align="center" class="letraTitulo">AUTORIZACION</td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="25%" align="center" class="letraDetalle">
                        <input type="password" name="xAutorizacion" value="" size="8" maxlength="8">
                    </td>
                </tr>
            </table>
