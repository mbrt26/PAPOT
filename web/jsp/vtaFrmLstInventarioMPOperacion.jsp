<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaInventarioMPOperacion" prefix="lst" %>
    ...
    <head>
        <title>Inventario M.P. Operacion</title>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstInventarioMPOperacion.jsp">


            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">INVENTARIO M.P. OPERACION</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
        ...
        <table border="0" width="90%" id="tablaTitulo">
            ...
            <tr>
                <td width="5%" align="right" class="letraTitulo">IDPLU</td>
                <td width="30%" align="left" class="letraTitulo">REFERENCIA CLIENTE /
                    <br>M.P.</td>
                <td width="5%" align="right" class="letraTitulo">O.T.</td>
                <td width="10%" align="right" class="letraTitulo">INVENTARIO
                                                             <br>PESO (KG)</td>
                <td width="30%" align="left" class="letraTitulo">TERCERO</td>                
                <td width="20%" align="right" class="letraTitulo">&nbsp;</td>
            </tr>
            <lst:listaInventarioMPOperacion idLocalTag="<%=fachadaDctoOrdenDetalleBean.getIdLocalStr()%>"
