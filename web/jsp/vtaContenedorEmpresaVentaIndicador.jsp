<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorEmpresaVentaIndicador.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <lista:listaClienteControlAgendaNit idClienteTag="<%=fachadaTerceroBean.getIdCliente()%>"
                    ...
                    <tr>
                        ...
                        <td width="33%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorEmpresaVentaIndicador.jsp&accionContenedor=ModificaDescuento&xIdLog=<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>"><%=fachadaDctoOrdenBean.getDescuentoComercialStr()%></a>
                        </td>
                ...
                <lsv:listaOrden idLocalTag="<%=fachadaTerceroBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="5%"  nowrap align="center" class="<%=letraDetalleInventarioVar%>">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorEmpresaVentaIndicador.jsp&accionContenedor=retira&xItem=<%=itemVar%>&xIdLog=<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>">R</a>
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorEmpresaVentaIndicador.jsp&accionContenedor=modifica&xItem=<%=itemVar%>&xIdLog=<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>">M</a>
                        </td>
