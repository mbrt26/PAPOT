...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngPagoCxPPlanillaParcial.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="10%" align="center" class="letraTitulo">VR.RTECREE</td>
        <td width="10%" align="right" class="letraTitulo">&nbsp;</td>
    </tr>

    <tr>
        <td width="10%" align="center" class="letraDetalle"><%=fachadaDctoPagoBean.getIdDctoNitCC()%></td>
        <td width="10%" align="right" class="letraDetalle"><%=fachadaDctoPagoBean.getVrSaldoDf0()%></td>
        ...
        <td width="10%" align="right" class="letraDetalle">
            <input type="text" value="0" name="xVrRteCree" size="10">
        </td>
