...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstResurtidoTraslado.jsp">
    ...
    <lst:listaLegalizaAll idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoTraslado.jsp&accionContenedor=coger&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>"><%=idOrdenVar%></a>
            </td>
