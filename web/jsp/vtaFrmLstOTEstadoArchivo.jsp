                ...
                idTipoTerceroTag = "<%=fachadaColaboraReporteDctoBean.getIdTipoTerceroStr()%>">
                    <tr>
                        <td width="5%" align="right" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstOTEstado.jsp&accionContenedor=trae&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=idTipoOrdenVar%>&xIdOrden=<%=idOrdenVar%>&xNumeroOrden=<%=numeroOrdenVar%>&xItem=<%=itemVar%>"><%=numeroOrdenVar%>-<%=itemVar%></a>
                        </td>
