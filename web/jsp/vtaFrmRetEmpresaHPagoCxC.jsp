<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmRetEmpresaHPagoCxC.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">RETIRA PAGOS</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                ...
                <lista:listaHPagoCxC idLocalTag  = "<%=fachadaColaboraLogisticaBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="10%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmRetEmpresaHPagoCxC.jsp&accionContenedor=retiraRecibo&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=fachadaColaboraLogisticaBean.getIdTipoOrdenStr()%>&xIndicador=<%=indicadorVar%>&xIdRecibo=<%=idReciboVar%>&xFechaInicial=<%=fachadaColaboraLogisticaBean.getFechaInicial()%>&xFechaFinal=<%=fachadaColaboraLogisticaBean.getFechaFinal()%>&xIdCliente=<%=fachadaColaboraLogisticaBean.getIdCliente()%>"><%=idReciboVar%></a>
                        </td>
                        ...
                        <td width="10%" align="center" class="letraDetalle"><%=idDctoVar%></td>
                        <td width="10%" align="center" class="letraDetalle"><%=idPlanillaVar%></td>
                    </tr>
