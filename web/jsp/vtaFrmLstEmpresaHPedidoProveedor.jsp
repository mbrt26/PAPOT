<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstEmpresaHPedidoProveedor.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">HISTORICO COMPRAS</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    ...
                    <td width="10%" align="right" class="letraTitulo">#ARTICULOS</td>
                    <td width="20%" align="right" class="letraTitulo">VR.DCTO</td>
                    <td width="10%" align="center" class="letraTitulo">FRA.ORIGEN</td>
                    <td width="10%" align="center" class="letraTitulo">O.COMPRA</td>
                </tr>
                <lsu:listaPedidoPeriodoLocal idTipoOrdenCadenaTag = "<%=fachadaColaboraLogisticaBean.getIdTipoOrdenCadena()%>"
                    ...
                    <tr>
                        <td width="20%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaHPedidoProveedor.jsp&accionContenedor=detallarCotizacion&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&idOrden=<%=idOrdenVar%>"><%=idDctoNitCCVar%></a>
                        </td>
                        ...
                        <td width="20%" align="right" class="letraDetalle"><%=vrVentaConIvaVar%></td>
                        <td width="10%" align="center" class="letraDetalle"><%=idDctoCruceVar%></td>
                        <td width="10%" align="center" class="letraDetalle"><%=idOrdenOrigenVar%></td>
                    </tr>
