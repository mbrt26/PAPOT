    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest"
                   value="/jsp/vtaFrmFinResurtidoNota.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="20%" nowrap align="right" class="letraTitulo">VR.COSTO</td>
                ...
                <lss:listaClienteCotizacionArticulos idLocalTag="<%=fachadaDctoBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        ...
                        <td width="20%" nowrap align="right" class="letraDetalle"><%=vrVentaSinIvaVar%></td>
