<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngPagoCxCPlanillaParcial.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    <td width="10%" align="center" class="letraDetalle"><%=fachadaDctoBean.getIdDctoSf0()%></td>
