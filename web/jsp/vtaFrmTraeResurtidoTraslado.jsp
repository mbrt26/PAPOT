...
<jsp:useBean id="fachadaLocalIp"
             scope="request"
             type="com.solucionesweb.losbeans.fachada.FachadaLocalIp" />
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmTraeResurtidoTraslado.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        <td width="10%" align="right" class="letraTitulo">#ORDEN</td>
     ...
     <lst:listaLegalizaAll idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmTraeResurtidoTraslado.jsp&accionContenedor=selecciona_despacho&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>"><%=idOrdenVar%></a>
            </td>
