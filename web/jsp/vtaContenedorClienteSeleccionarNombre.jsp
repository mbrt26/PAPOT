...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorClienteSeleccionarNombre.jsp">
    ...
    <lista:listaEmpresaNombre idTipoTerceroTag = "<%=fachadaTerceroBean.getIdTipoTerceroStr()%>"
        ...
        <tr>
            <td width="10%" align="left" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorClienteSeleccionarNombre.jsp&accionContenedor=Confirmar&radIdCliente=<%=idClienteSinFormatoVar%>&xIdLocalTercero=<%=idLocalTerceroVar%>"><%=idClienteVar%></a>
            </td>
