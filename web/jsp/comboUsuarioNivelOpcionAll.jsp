<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaUsuarioNivelOpcionAll" prefix="lst" %>
    ...
    <%
        ...
        String xIdNivelVendedor = "1,2";
        String xIdUsuarioActivo = usuarioBean.getIdUsuarioStr();
    %>
       <select name=xIdVendedor>
           <lst:listaUsuarioNivelOpcionAll idUsuarioTag="<%=xIdUsuarioActivo%>"
           ...
           </lst:listaUsuarioNivelOpcionAll>
       </select>
</html>