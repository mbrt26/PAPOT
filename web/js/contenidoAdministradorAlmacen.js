...
nodo = getFromRoot(1,0); // Catalogos Tercero
...
nodo = getFromRoot(1,1); // Catalogos Comercial
...
nodo = getFromRoot(2,1); // Administrador Inventario
...
nodo = getFromRoot(2,2); // Administrador Comision
...
nodo = getFromRoot(2,3); // Administrador Bonificacion
...
nodo = getFromRoot(2,4); // Administrador Cuadre Caja
...
nodo = getFromRoot(3,0); // Reportes Ventas
...
nodo = getFromRoot(3,1); // Reportes Inventarios
...
nodo = getFromRoot(3,2); // Reportes Resurtido
...
nodo = getFromRoot(3,3); // Reportes Margen
...
nodo = getFromRoot(3,4); // Reportes Cuadre Caja
...
nodo = getFromRoot(3,5); //Auditorias
...
//nodo.addBranch(new Node("","Rta Proveedor","../GralControladorServlet?nombrePaginaRequest=/potPermisoRepRentbilidadProveedor.ctr"));
//nodo.addBranch(new Node("","Rta Zona","../GralControladorServlet?nombrePaginaRequest=/potPermisoRepRentbilidadZonaGeografica.ctr"));
...
//
nodo = getFromRoot(5) // Salida Segura
