...
// ------------------- Administrador --------------------- //
nodo = getFromRoot(1);  // Administrador
...
nodo = getFromRoot(1,0); // Administrador Comision
...
nodo = getFromRoot(1,1); // Administrador Bonificacion
...
//
nodo = getFromRoot(2,0); // Reportes Ventas
...
//
nodo = getFromRoot(2,1); // Reportes Inventarios
...
//
nodo = getFromRoot(2,2); // Reportes Resurtido
...
nodo = getFromRoot(2,3); // Reportes Cuadre Caja
...
nodo = getFromRoot(2,4); //Auditorias
...
nodo = getFromRoot(2,4,0); //Auditorias
...
nodo = getFromRoot(2,4,1); //Auditorias
...
nodo.addBranch(new Node("","Copia de Seguridad","../GralControladorServlet?nombrePaginaRequest=/potPermisoEan.ctr"));
