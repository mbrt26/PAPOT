...
@WebServlet(name = "CotizacionServletRef", urlPatterns = {"/CotizacionServletRef"})
public class CotizacionServletRef extends HttpServlet {
    ...
    private final DAO_Referencia daoReferencia = new DAO_Referencia();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (xOpcion.equals("crear")) {
                ...
                int xficha = ficha.equals("") ? obtenerIdFichaMaximo() : Integer.parseInt(ficha);
            ...
            Logger.getLogger(CotizacionServletRef.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
    ...
    private String headerReportMargin() {
        String encabezado = "<table border=\"0\" width=\"100%\" class=\"table table-sm table-striped\">\n "
                + "<thead>\n"
                + "                                    <tr>\n"
                + "                                        <th class=\"text-center\" width=\"3%\">IdPlu</th> \n"
                + "                                        <th class=\"text-center\" width=\"5%\">Ficha</th> \n"
                + "                                        <th class=\"text-left\" width=\"15%\">Cliente</th> \n"
                + "                                        <th class=\"text-left\" width=\"15%\">Nombre Referencia</th> \n"
                + "                                        <th class=\"text-left\" width=\"5%\">Ancho</th> \n"
                + "                                        <th class=\"text-left\" width=\"5%\">Largo</th> \n"
                + "                                        <th class=\"text-left\" width=\"5%\">Calibre</th> \n"
                + "                                        <th class=\"text-left\" width=\"5%\">Referencia</th> \n"
    ...
    private String encabezadoMatPrima() {
        String encabezado = "<table border=\"0\" width=\"100%\" class=\"table table-sm table-striped\">\n "
                ...
                + "                                        <th class=\"text-left\" width=\"5%\">Batch</th> \n"
                + "                                        <th class=\"text-left\" width=\"5%\">Acción</th> \n"
                + "                                    </tr></thead>";
        return encabezado;
    }
    ...
    private void printTablaReporteMargen(PrintWriter out, DAO_Referencia bdao) {
        ...
        for (DTO_Referencia bdto : lista) {
            String print
                    ...
                    + "<td width=\"3%\" align=\"center\">" + bdto.getIdPlu() + "</td>"
                    + "<td width=\"5%\" align=\"center\">" + bdto.getFicha() + "</td>"
                    + "<td width=\"5%\" align=\"left\">" + bdto.getNombreCliente() + "</td>"
                    + "<td width=\"25%\" align=\"left\">" + bdto.getNombreReferencia() + "</td>"
                    + "<td width=\"5%\" align=\"left\">" + bdto.getAncho() + "</td>"
                    + "<td width=\"5%\" align=\"left\">" + bdto.getLargo() + "</td>"
                    + "<td width=\"5%\" align=\"left\">" + bdto.getCalibre() + "</td>"
                    + "<td width=\"5%\" align=\"left\">" + bdto.getReferencia() + "</td>"
                    + "<td width=\"5%\" align=\"right\">" + bdto.getPrecioVenta() + "</td>"
                    + "<td width=\"5%\" align=\"right\">" + bdto.getMargen() + " %</td>"
                    + "</tr>";
            out.println(print);
        }
        out.println("</table>");
    ...
    private void printTabla(PrintWriter out, List<Proceso_Materia_DTO> listaMP) {
        out.println(encabezadoMatPrima());
        df.setMaximumFractionDigits(2);

        for (Proceso_Materia_DTO bdto : listaMP) {
            String print
                    = "<tr>\n"
                    + "<td width=\"25%\" align=\"left\">" + bdto.getNombre() + "</td>"
                    + "<td width=\"5%\" align=\"center\">" + bdto.getCantidad() + "</td>"
                    + "<td width=\"5%\" align=\"center\">" + df.format(bdto.getBache()) + "</td>"
                    + "<td width=\"10%\" align=\"center\"><button type=\"button\" class=\"btn-danger\"  name=\"xoption\" onclick = removerMateria(\"" + bdto.getSk_operacion_materia() + "\") value=\"Editar\" ><i class=\"fas fa-trash\"></i></button></td>"
                    + "</tr>";
            out.println(print);
        }
        out.println("</table>");
    ...
    private int obtenerIdFichaMaximo() {
        
        return daoReferencia.obtenerIdFichaMaximo();
    }
}
