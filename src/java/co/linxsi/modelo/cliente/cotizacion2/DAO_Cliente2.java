 ...
 */
public class DAO_Cliente2 extends DTO_Cliente {
...
//Permite ingresar las bodegas por primera vez en la tabla
    ...
    public List<DTO_Cliente> getAllClientesHaveReferences() {
        ...
        String sql = 
                ...
                + " FROM tblTerceros                         "
                + " WHERE tblTerceros.idTipoTercero =   1 ORDER BY nombreTercero ";
        ...
        try {
            ...
            while (rs.next()) {
                DTO_Cliente dto = new DTO_Cliente();
                dto.setNit(rs.getInt("idTercero"));
    ...
    public List<DTO_Cliente> getAllBusqueda() {
        ...
        String sql = "SELECT TOP 15 "
                ...
                + " INNER JOIN [BDCommerce].[dbo].[tblCotClienteRef] "
                + " ON [BDCommerce].[dbo].[tblCotClienteRef].[idCliente] = [BDCommerce].[dbo].[tblClienteCotizacion].[idCliente]"
                + " WHERE nombreCliente LIKE '%" + getRazonSocial() + "%' AND [BDCommerce].[dbo].[tblClienteCotizacion].estado = 1 "
                + "GROUP BY [nombreCliente],[BDCommerce].[dbo].[tblClienteCotizacion].[idCliente]   \n"
                + ", [nombreCliente]   \n"
    ...
    public DTO_Cliente getUnCliente() {
        ...
        String sql = "SELECT TOP 1 [idCliente]"
                ...
                + "      ,[creado]"
                + " FROM [BDCommerce].[dbo].[tblClienteCotizacion] "
                + " WHERE estado = 1  AND idCliente = " + getNit()
