...
//
public class ListaResurtidoDetalleTxTag
    ...
    private String idOrdenOrigenTag;
    ...
    public int getIdTipoOrden() {
       ...
       public String getIdOrdenOrigenTag() {
        return idOrdenOrigenTag;
    }

    public void setIdOrdenOrigenTag(String idOrdenOrigenTag) {
        this.idOrdenOrigenTag = idOrdenOrigenTag;
    }
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("xvrCostoINDVar", fachada.getVrCostoINDStr());
        pageContext.setAttribute("xvrCostoVar", fachada.getVrCostoStr());
    }
    ...
    public int doStartTag() throws JspTagException {
        ...
        colabora.setIdOrdenOrigen(getIdOrdenOrigenTag());

        System.out.println(getIdOrdenOrigenTag());

        //
        Vector vectorBean = colabora.listaLegalizaDespacho();
