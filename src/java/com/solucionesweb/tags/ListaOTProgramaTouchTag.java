...
public class ListaOTProgramaTouchTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("idColorVar", fachadaPluFicha.getIdColor());
        pageContext.setAttribute("idLogVar", fachadaPluFicha.getIdLogStr());
    ...
    public int doStartTag() throws JspTagException {
        ...
        /*
        Vector vectorBean =
        colaboraOrdenTrabajo.listaOTProgramaTouch();*/

        Vector vectorBean =
                colaboraOrdenTrabajo.listaOTProgramaTouch_Operacion_Pedido(
                                                            xPorcentajeAdicion);
