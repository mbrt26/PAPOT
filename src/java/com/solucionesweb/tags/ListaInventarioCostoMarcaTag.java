...
public class ListaInventarioCostoMarcaTag extends TagSupport
    ...
    public int doStartTag() throws JspTagException {
        ...
        if (getIdMarca() == 0) {
            ...
            //
            listaLineaVector = colaboraInventarioBean.listaAllMarca(
                                                               getIdLocal());
            ...
            //
            listaLineaVector = colaboraInventarioBean.listaUnaMarca(
                                                                  getIdLocal());
        }
