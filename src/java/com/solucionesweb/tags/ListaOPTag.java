...
public class ListaOPTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("cantidadVar",
                fachadaDctoOrdenDetalleBean.getCantidadDf0());
        ...
        pageContext.setAttribute("cantidadStrVar",
                fachadaDctoOrdenDetalleBean.getCantidadSf1());
        pageContext.setAttribute("cantidadPendienteVar",
                fachadaDctoOrdenDetalleBean.getCantidadPendienteSf1());
        pageContext.setAttribute("pesoPendienteVar",
                fachadaDctoOrdenDetalleBean.getPesoPendienteSf1());
        pageContext.setAttribute("vrVentaOriginal",
                String.valueOf(fachadaDctoOrdenDetalleBean.getVrVentaUnitario() / (fachadaDctoOrdenDetalleBean.getPorcentajeIva() / 100 + 1)));
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean = colaboraOrdenDetalleBean.listaOP();
