...
public class ListaResurtidoAjusteCompraTag
    ...
    //
    String xNombreEstado = "";
    int   xEstadoAnulado = 1;
    int   xIdEstadoVisitaCumplido = 7;
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        //
        if (fachada.getEstado() == xEstadoAnulado) {

           //
           xNombreEstado = "ANULADO" ;

        }

        //
        if (fachada.getIdEstadoVisita() == xIdEstadoVisitaCumplido) {

           //
           xNombreEstado = "CUMPLIDO" ;
        ...
        pageContext.setAttribute("fechaEntregaVar",
                                                fachada.getFechaEntregaCorta());
        pageContext.setAttribute("diasHistoriaVar",
                                                  fachada.getDiasHistoriaStr());
        pageContext.setAttribute("diasInventarioVar",
                fachada.getDiasInventarioStr());
        pageContext.setAttribute("nombreUsuarioVar",
                                                    fachada.getNombreUsuario());
        ...
        pageContext.setAttribute("idOrdenVar", fachada.getIdOrdenStr());
        pageContext.setAttribute("nombreEstadoVar", xNombreEstado);
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        if (getIdTerceroTag() != null) {

            //
            vectorBean = colaboraResurtidoOrden.listaOrdenCompraUn();

        } else {

            //
            vectorBean = colaboraResurtidoOrden.listaOrdenCompraAll();
