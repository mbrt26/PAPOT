...
public class ListaOTTiempoPerdidoTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("cantidadMinutoVar",
                fachadaDctoOrdenProgreso.getCantidadMinutoDf0());
        pageContext.setAttribute("nombreItemVar",
                fachadaDctoOrdenProgreso.getNombreItem());
        pageContext.setAttribute("nombreCausaVar",
                fachadaDctoOrdenProgreso.getNombreCausa());
    ...
    public int doStartTag() throws JspTagException {
        ...
        colaboraCosto.setIdTipoCausa(xIdTipoCausaTiempoPerdido);

        //
        Vector vectorBean  = colaboraCosto.listaTiempoPerdido();
