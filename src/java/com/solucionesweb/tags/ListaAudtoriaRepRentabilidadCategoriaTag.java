...
public class ListaAudtoriaRepRentabilidadCategoriaTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("nombreCategoriaVar",fachada.getNombreCategoria());
      ...
      pageContext.setAttribute("idCategoriaVar",fachada.getIdMarcaStr());
	...
	public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean =
             colaboraRentabilidad.listaIndicadorRentabilidadCategoria();
