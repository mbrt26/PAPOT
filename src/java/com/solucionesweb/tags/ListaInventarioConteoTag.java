...
public class ListaInventarioConteoTag extends TagSupport
    ...
    public int getIdTipoOrden() {
        return new Integer(getIdBodegaTag());
    }
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("existenciaVar",
                                             fachadaPluBean.getExistenciaStr());
	}
	...
	public int doStartTag() throws JspTagException 	{
        ...
        colaboraPlu.setIdTipo(getIdTipoTag());

        //
		Vector listaLineaVector = colaboraPlu.listaAllBodegaTipo();
