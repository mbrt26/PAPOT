...
public class ListaRecaudoTag extends TagSupport implements IterationTag {
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        //
        fachada = (FachadaPagoBean) iteratorBean.next();

        // Variable que retornan al JSP
        pageContext.setAttribute("nitCCVar", fachada.getNitCC());
        ...
        pageContext.setAttribute("fechaPagoVar", fachada.getFechaPagoCorta());
        pageContext.setAttribute("indicadorVar", fachada.getIndicadorStr());
        pageContext.setAttribute("vrPagoVar", fachada.getVrPagoDf0());
        pageContext.setAttribute("vrRteFuenteVar", fachada.getVrRteFuenteDf0());
        pageContext.setAttribute("vrDescuentoVar", fachada.getVrDescuentoDf0());
        pageContext.setAttribute("vrRteIvaVar", fachada.getVrRteIvaDf0());
        pageContext.setAttribute("vrRteIcaVar", fachada.getVrRteIcaDf0());
        ...
        pageContext.setAttribute("idPlanillaVar", fachada.getIdPlanillaStr());
        pageContext.setAttribute("nombreTerceroVar", fachada.getNombreCliente());
        pageContext.setAttribute("horaPagoVar", fachada.getHoraTx());
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        colaboraPago.setIdLocal(getIdLocalTag());
        colaboraPago.setIdTipoOrdenCadena(getIdTipoOrdenCadenaTag());
        colaboraPago.setIndicadorInicial(getIndicadorInicialTag());
        colaboraPago.setIndicadorFinal(getIndicadorFinalTag());
        colaboraPago.setIdVendedor(getIdVendedorTag());
        ...
        if (getIdVendedor() == 0) {
            ...
            //
            vectorBean = colaboraPago.listaRecaudo(getIdLocalTag());
            ...
            //
            vectorBean = colaboraPago.listaRecaudoVendedor(getIdLocalTag());
