...
public class ListaPluCategoriaTag extends TagSupport
                                    implements IterationTag
{
	...
	public int doStartTag() throws JspTagException
	{
        ...
        if ((getIdLinea() == 0) &&
            ...
            //
		    listaLineaVector = colaboraPlu.listaAllPluCategoria();

        } else {

            //
		    colaboraPlu.setIdLinea(getIdLinea());
            colaboraPlu.setIdCategoria(getIdCategoria());

            //
  		    listaLineaVector = colaboraPlu.listaPluCategoria();
