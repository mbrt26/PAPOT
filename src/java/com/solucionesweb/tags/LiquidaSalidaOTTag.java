...
public class LiquidaSalidaOTTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("idOperarioVar",
                fachadaDctoOrdenProgreso.getIdOperarioStr());
        ...
        pageContext.setAttribute("pesoTaraVar",
                                 fachadaDctoOrdenProgreso.getPesoTaraDf1());
        pageContext.setAttribute("idControlVar",
                                 fachadaDctoOrdenProgreso.getIdControlSf0());        
        pageContext.setAttribute("idDctoNitCCVar",
                                 fachadaDctoOrdenProgreso.getIdDctoNitCC()); 
        pageContext.setAttribute("idOrdenCruceVar",
                                 fachadaDctoOrdenProgreso.getIdOrdenCruceSf0());           
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean = colaboraOrdenProgreso.listaSalidaOT(getIdLog());
