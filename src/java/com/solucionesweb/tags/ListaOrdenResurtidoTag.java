...
public class ListaOrdenResurtidoTag
    ...
    private String idLocalOrigenTag;
    ...
    public String getIdLocalOrigenTag() {
        return idLocalOrigenTag;
    }

    public int getIdLocalOrigen() {
        return new Integer(getIdLocalOrigenTag()).intValue();
    }

    public void setIdLocalOrigenTag(String idLocalOrigenTag) {
        this.idLocalOrigenTag = idLocalOrigenTag;
    }
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idOrdenOrigenVar",fachada.getIdOrdenOrigenStr());
	...
	public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean    = colaboraResurtidoOrden.listaOrdenResurtido(getIdLocalOrigen());
