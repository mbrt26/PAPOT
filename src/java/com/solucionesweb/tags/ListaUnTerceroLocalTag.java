...
public class ListaUnTerceroLocalTag extends TagSupport
                                     implements IterationTag {

    // Variable que recibe del JSP
    private String idClienteTag;
    private String idTipoTerceroTag;
    private String idLocalTerceroTag;
    ...
    public void setIdLocalTerceroTag( String idLocalTerceroTag )
    {
        this.idLocalTerceroTag = idLocalTerceroTag ;
    }

    public String getIdLocalTerceroTag()
    {
        return idLocalTerceroTag;
    }

    public int getIdLocalTercero()
    {
        return  new Integer(getIdLocalTerceroTag()).intValue();
    }
	...
	public int doStartTag() throws JspTagException {
        ...
        colaboraTercero.setIdLocalTercero(getIdLocalTerceroTag());
        ...
        //
        if (getIdLocalTercero()>0) {

           //
		   vectorBean    = colaboraTercero.listaUnTerceroLocal();


        } else {

           //
		   vectorBean    = colaboraTercero.listaUnTercero();
