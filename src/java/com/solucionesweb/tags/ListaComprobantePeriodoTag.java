...
public class ListaComprobantePeriodoTag extends TagSupport
 ...
 public String getFechaInicialTag() {
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("idLocalVar",
                fachadaTipoOrdenSubcuenta.getIdLocalStr());
    ...
    public int doStartTag() throws JspTagException {
        ...
        colaboraOrdenSubcuenta.setFechaInicial(getFechaInicialTag());
        colaboraOrdenSubcuenta.setFechaFinal(getFechaFinalTag());

        //
        Vector vectorBean = colaboraOrdenSubcuenta.listaAlcancePeriodo();
