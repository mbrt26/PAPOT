...
public class ListaAudtoriaRepRentabilidadVendPluTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("vrPagoVar",fachada.getVrPago());
      pageContext.setAttribute("cantidadVar",fachada.getCantidad());
	...
	public int doStartTag() throws JspTagException {
        ...
        System.out.println(getIdTipoOrdenInicialTag());
        System.out.println(colaboraRentabilidad.getIdTipoOrdenINI());

        //
        Vector vectorBean =
             colaboraRentabilidad.listaIndicadorRentabilidadVendPlu();
