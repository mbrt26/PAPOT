...
public class ValidacionDctoOrdenDetalleBean implements Serializable {
    ...
    public ValidacionDctoOrdenDetalleBean() {
		setValido(true);
    ...
    public ValidacionDctoOrdenDetalleBean(String nombreCampo, String valorCampo) {
		setValido(true);
		setCodigoError("noError");
		setDescripcionError("No hay Descripcion del Error");
	...
	int valor;
	if (nombreCampo.compareTo("vrVentaUnitario") == 0) {
	   if (valorCampo.length() == 0) {
	      setValido(false);
	      setCodigoError("vrVentaUnitario");
	      setDescripcionError("La identificacion de vrVentaUnitario esta vacia");
		...
		try {
              ...
              setValido(false);
   		      setCodigoError("vrVentaUnitario");
			  setDescripcionError("La identificacion del vrVentaUnitario contiene caracteres no numericos");
			  setSolucion("Proporcione un valor numerico en el campo");
			  return;
		}
		...
		if (valor <= 0) {
		   setValido(false);
		   setCodigoError("vrVentaUnitario");
		   setDescripcionError("La Identificacion del vrVentaUnitario no puede ser un numero negativo");
		   setSolucion("Proporcione un valor valido en el campo");
		   return;
		}
	...
	if (nombreCampo.compareTo("cantidad") == 0) {
	   if (valorCampo.length() == 0) {
	      setValido(false);
	      setCodigoError("cantidad");
	      setDescripcionError("La identificacion del cantidad esta vacia");
	      setSolucion("Proporcione un valor valido en el campo");
	      return;
	   }
		try {
              ...
              setValido(false);
   		      setCodigoError("cantidad");
			  setDescripcionError("La identificacion del cantidad contiene caracteres no numericos");
			  setSolucion("Proporcione un valor numerico en el campo");
			  return;
		}
		...
		if (valor <= 0) {
		   setValido(false);
		   setCodigoError("cantidad");
		   setDescripcionError("La Identificacion del cantidad no puede ser un numero negativo");
		   setSolucion("Proporcione un valor valido en el campo");
		   return;
		}
	...
	if (nombreCampo.compareTo("porcentajeDscto") == 0) {
	   if (valorCampo.length() == 0) {
	      setValido(false);
	      setCodigoError("porcentajeDscto");
	      setDescripcionError("La identificacion del cantidad esta vacia");
	      setSolucion("Proporcione un valor valido en el campo");
	      return;
	   }
    ...
    public void validarCampoString(){
		...
		if (nombreCampo.compareTo("idLocalIdbodegaDisponible") == 0) {

			if (valorCampo == null) {
				setValido(false);
				setCodigoError("idLocalIdbodegaDisponible");
				setDescripcionError("La idLocalIdbodega esta vacia");
				setSolucion("Proporcione un valor valido en el campo");
			}
			else {
				setValido(true);
			...
			return;
		}  if (nombreCampo.compareTo("idLocalIdBodega") == 0) {

			if (valorCampo == null) {
				setValido(false);
				setCodigoError("idLocalIdBodega");
				setDescripcionError("La idLocalIdBodega esta vacia");
				setSolucion("Proporcione un valor valido en el campo");
			}
			else {
