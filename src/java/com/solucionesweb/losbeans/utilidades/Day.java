...
{  /**
   ...
   public String getFechaFormateada() {
	 ...
	 String añoStr = new Integer(getYear()).toString();
	 String mesStr = new Integer(getMonth()).toString();
	 String diaStr = new Integer(getDay()).toString();

	 longitudMes = mesStr.length();
	 longitudDia = diaStr.length();


     if (longitudMes == 1) {
		mesDosDigitos = "0" + mesStr;
     }
	 else {
	    mesDosDigitos = mesStr;
	 }

     if (longitudDia == 1) {
		diaDosDigitos = "0" + diaStr;
     }
	 else {
	    diaDosDigitos = diaStr;
	 }

	 fechaFormat = añoStr + "/" + mesDosDigitos + "/" + diaDosDigitos;
   ...
   public String getFechaFormateadaFactAmbi() {
     int longitudMes;
     String mesDosDigitos;
	 int longitudDia;
	 String diaDosDigitos;
	 ...
	 fechaFormat = diaDosDigitos +"        "+ mesDosDigitos +"      "+ añoStr;

	 return fechaFormat;

   }

   //Fecha getFechaNoFormateada AAAA/MM/DD
   public String getFechaNoFormateada() {
     int longitudMes;
     String mesDosDigitos;
	 int longitudDia;
	 String diaDosDigitos;
