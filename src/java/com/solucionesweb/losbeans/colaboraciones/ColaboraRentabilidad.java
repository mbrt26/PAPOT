...
public class ColaboraRentabilidad
        extends FachadaColaboraReporteDctoBean
...
"  		tmpExt.idVendedor ";
        ...
        // Metodo listaIndicadorRentabilidadVendCliente
...
" ORDER BY  1 , 3   " ;
        ...
        try {
         ...
         fachadaColaboraReporteDctoBean.setAliasUsuario(
                                                  rs.getString("aliasUsuario"));
         fachadaColaboraReporteDctoBean.setIdCliente(rs.getString("Nit"));
         fachadaColaboraReporteDctoBean.setIdVendedor(
                                                    rs.getString("idVendedor"));
...
" ORDER BY	7 DESC ";
    ...
    // Metodo listaIndicadorRentabilidadMarca
    public Vector listaIndicadorRentabilidadVendedor() {
...
" ORDER BY  2   ";
        ...
        try {
         ...
         //
          ...
          fachadaColaboraReporteDctoBean.setAliasUsuario(
                                                rs.getString("aliasUsuario"));
          fachadaColaboraReporteDctoBean.setIdVendedor(rs.getString("idVendedor"));
          fachadaColaboraReporteDctoBean.setVrCostoMV(rs.getDouble("vrCostoMv"));
          fachadaColaboraReporteDctoBean.setVrIva(rs.getDouble("vrIva"));
          fachadaColaboraReporteDctoBean.setVrPago(rs.getDouble("vrPago"));
          fachadaColaboraReporteDctoBean.setVrBase(rs.getDouble("vrBase"));
      ...
      // Metodo listaIndicadorRentabilidadProveedor
    public Vector listaIndicadorRentabilidadProveedor() {
...
" SELECT		                                       " +
" 			SUM(tmpTemp.vrBase) AS vrBase,         " +
" 			SUM(tmpTemp.vrCostoIND) AS vrCostoIND, " +
" 			SUM(tmpTemp.vrCostoMV) AS vrCostoMV,   " +
" 			(CASE                                  " +
"             WHEN (SUM(tmpTemp.vrBase)) = 0                   " +
"             THEN 0                                           " +
"             ELSE (SUM(tmpTemp.vrBase)-                       " +
" 				  SUM(tmpTemp.vrCostoIND))/    " +
" 				  (SUM(tmpTemp.vrBase))        " +
"             END)   AS margenIND,                             " +
" 			tmpTemp.idLocal,                       " +
" 			tmpPLT.idTercero,                      " +
...
" )  AS tmpTemp                                                " +
" INNER JOIN (                                                 " +
" SELECT tblDctos.idCliente AS idTercero,                      " +
"        tblDctosOrdenesDetalle.IDPLU                          " +
" FROM   tblDctos                                              " +
" INNER JOIN tblDctosOrdenesDetalle                            " +
" ON tblDctos.IDLOCAL      =                                   " +
...
" AND tblDctos.IDORDEN =                                       " +
"       tblDctosOrdenesDetalle.IDORDEN                         " +
" WHERE tblDctos.idTipoOrden = 1                               " +
" GROUP BY tblDctos.idCliente,                                 " +
"        tblDctosOrdenesDetalle.IDPLU                          " +
" ) AS tmpPLT                                                  " +
" ON tmpTemp.idPlu    = tmpPLT.idPlu                           " +
" GROUP BY tmpTemp.idLocal,                                    " +
" 		 tmpPLT.idTercero                              " +
" ORDER BY margenIND DESC ";
        ...
        try {
         ...
         //
          ...
          fachadaColaboraReporteDctoBean.setIdCliente(rs.getString("idTercero"));
          fachadaColaboraReporteDctoBean.setVrCostoMV(rs.getDouble("vrCostoMV"));
                    fachadaColaboraReporteDctoBean.setVrBase(rs.getDouble("vrBase"));
          fachadaColaboraReporteDctoBean.setVrCostoIND(
                                                    rs.getDouble("vrCostoIND"));
          fachadaColaboraReporteDctoBean.setMargenIND(
                                                   rs.getDouble("margenIND"));
          fachadaColaboraReporteDctoBean.setNombreTercero(rs.getString("proveedor"));
    ...
    // Metodo listaIndicadorRentabilidadZona
    public Vector listaIndicadorRentabilidadZona() {
...
" ORDER BY margenZona                               ";
        ...
        try {
         ...
         //
          ...
          fachadaColaboraReporteDctoBean.setIdLocal(rs.getString("idLocal"));
          fachadaColaboraReporteDctoBean.setIdCiudad(rs.getInt("idCiudad"));
          fachadaColaboraReporteDctoBean.setNombreCiudad(rs.getString("zona"));
          fachadaColaboraReporteDctoBean.setVrBase(rs.getDouble("vrBase"));
          fachadaColaboraReporteDctoBean.setVrCostoIND(
                                                    rs.getDouble("vrCostoIND"));
          fachadaColaboraReporteDctoBean.setVrCostoMV(rs.getDouble("vrCostoMV"));
    ...
    // Metodo listaIndicadorRentabilidadCategoria
    public Vector listaIndicadorRentabilidadCategoria() {
...
"                 GROUP BY tmpMVT.idPlu) AS tmpVTA                          " +
"                 ON tmpVTA.idPlu       = tblPlus.idPlu                     " +
" GROUP BY		tblCategorias.nombreCategoria,                      " +
"                 tblPlus.porcentajeIva,                                    " +
"                 tblCategorias.idCategoria                                 " +
"                                                                           " +
" ORDER BY	7 DESC   " ;
        ...
        try {
         ...
         //
          ...
          fachadaColaboraReporteDctoBean.setNombreCategoria(
                                               rs.getString("nombreCategoria"));
          fachadaColaboraReporteDctoBean.setPorcentajeIva(
                                                rs.getDouble("porcentajeIva"));
          fachadaColaboraReporteDctoBean.setIdCategoria(
      ...
      // Metodo listaIndicadorRentabilidadListaPrecio
    public Vector listaIndicadorRentabilidadListaPrecio() {
...
"       ,SUM(tblDctos.vrIva)            " +
"             AS vrIva                  " +
"       ,SUM(tblDctos.vrCostoMV)        " +
"             AS vrCostoMV              " +
"       ,SUM(tblDctos.vrCostoIND)       " +
"             AS vrCostoIND             " +
"       ,(CASE                          " +
"         WHEN SUM(tblDctos.vrBase) = 0 " +
"         THEN 0                        " +
"         ELSE                          " +
"         ((SUM(tblDctos.vrBase))       " +
"          -(SUM(tblDctos.vrCostoIND))  " +
...
" ORDER BY margenLista DESC ";
        ...
        try {
         ...
         //
          ...
          fachadaColaboraReporteDctoBean.setIdLocal(rs.getInt("IDLOCAL"));
          fachadaColaboraReporteDctoBean.setIdListaPrecio(rs.getInt("idListaPrecio"));
          fachadaColaboraReporteDctoBean.setVrCostoMV(rs.getDouble("vrCostoMv"));
          fachadaColaboraReporteDctoBean.setVrIva(rs.getDouble("vrIva"));
          fachadaColaboraReporteDctoBean.setVrPago(rs.getDouble("vrPago"));
          fachadaColaboraReporteDctoBean.setVrBase(rs.getDouble("vrBase"));
