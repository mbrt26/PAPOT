...
/**
 * Este servlet permite revisar el listado de pagos. /
 * vtaContenedorEmpresaHPagoCxC.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 * 
 */
public class VtasAdmEmpresaHPagoCxCManejadorRequest
        implements GralManejadorRequest {
     /**
     * BUTTON--
     * ("Consultar")-Permite consultar un listado de pagos de un cliente/vtaContenedorEmpresaHPagoCxC.jsp /
     * ("Retirar")-Permite borrar un listado de pagos de un cliente/vtaFrmRetEmpresaHPagoCxC.jsp /
     * ("Listar")-Genera un pdf de un listado de pagos /vtaFrmLstEmpresaHPagoCxC.jsp /
     * ("Regresar")-Regresa al menu principal /
     * 
     *  Metodo contructor por defecto, es decir, sin parametros /
     */

    public VtasAdmEmpresaHPagoCxCManejadorRequest() { }
     /**
     * PARAMETER BUTTON--
     * "FechaInicial"-Fecha inicial para ver un historico de pago / 
     * "FechaFinal"-Fecha final para ver un historico de pago /
     * 
    ...
    public String generaPdf(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Retirar") == 0) {
                ...
                //
                return "/jsp/vtaFrmRetEmpresaHPagoCxC.jsp";
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                request.setAttribute("fachadaColaboraLogisticaBean",
                        fachadaColaboraLogisticaBean);
                return "/jsp/vtaFrmLstEmpresaHPagoCxC.jsp";
