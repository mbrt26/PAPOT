...
public class GeneraPdfAllRentbilidadVendedor implements GralManejadorRequest {
   ...
   //
    public String generaPdf(HttpServletRequest request,
       ...
       ColaboraIndicadorRentabilidad colaboraIndicadorRentabilidad =
                                           new ColaboraIndicadorRentabilidad();

       Vector vector = new Vector();



       colaboraIndicadorRentabilidad.setIdLocal(getIdLocal());
       colaboraIndicadorRentabilidad.setFechaInicialStr(
                                                    getFechaInicial());
       colaboraIndicadorRentabilidad.setFechaFinalStr(getFechaFinal());
       colaboraIndicadorRentabilidad.setIdTipoOrdenINI(getIdTipoOrdenINI());
       colaboraIndicadorRentabilidad.setIdTipoOrdenFIN(getIdTipoOrdenFIN());
       colaboraIndicadorRentabilidad.setIndicadorInicial(getIndicadorINI());
       colaboraIndicadorRentabilidad.setIndicadorFinal(getIndicadorFIN());
      ...
      //
       ...
       lista =
            colaboraIndicadorRentabilidad.listaIndicadorRentabilidadVendPlu();

        fachadaColaboraReporteDctoBean =
        colaboraIndicadorRentabilidad.listaIndicadorRentabilidadVendPluTotal();

       pars.put("p_vrCostoMv", fachadaColaboraReporteDctoBean.getVrCostoMV());
       pars.put("p_vrIva", fachadaColaboraReporteDctoBean.getVrIva() );
       pars.put("p_vrPago", fachadaColaboraReporteDctoBean.getVrPago());
       pars.put("p_vrBase", fachadaColaboraReporteDctoBean.getVrBase());
       pars.put("p_vrCostoIND", fachadaColaboraReporteDctoBean.getVrCostoIND());
       pars.put("p_margenIND", fachadaColaboraReporteDctoBean.getMargenIND());
