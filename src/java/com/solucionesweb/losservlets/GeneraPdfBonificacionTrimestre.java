...
public class GeneraPdfBonificacionTrimestre implements GralManejadorRequest {
    ...
    public GeneraPdfBonificacionTrimestre() { }
	...
	anoStr = getFechaInicial().substring(0,4);
	mesStr = getFechaInicial().substring(5,7);
	diaStr = getFechaInicial().substring(8,10);
	...
	diaInt = Integer.parseInt(diaStr);
        ...
        //
	Day fechaInicialFormateada = new Day(anoInt,mesInt,diaInt);

	// Extrae el A?o, Mes y Dia
	anoStr = getFechaFinal().substring(0,4);
	mesStr = getFechaFinal().substring(5,7);
	diaStr = getFechaFinal().substring(8,10);
	...
	diaInt = Integer.parseInt(diaStr);
        ...
        //
	Day fechaFinalFormateada = new Day(anoInt,mesInt,diaInt);
        ...
        double xVrPresupuestoMes        =
                          lucroBonificacionUsuarioBean.valorTrimestre(
                                              fechaInicialFormateada.getMonth(),
                                              fechaFinalFormateada.getMonth());
        //
        ...
        //
        double xCumplimiento           = getPorcentajeCumplimiento();

        //
        if (xVrPresupuestoMes != 0) {

           //
           if (xTotalVentaEfectiva < xVrPresupuestoMes)  {
        ...
        //
        pars.put("p_VrBonificacion",(xCumplimiento *
    ...
    public void setPorcentajeCumplimiento(String porcentajeCumplimientoStr) {
        this.porcentajeCumplimiento =  new Double(porcentajeCumplimientoStr).doubleValue();
    }
