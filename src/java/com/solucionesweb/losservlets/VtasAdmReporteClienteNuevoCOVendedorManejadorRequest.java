...
public class VtasAdmReporteClienteNuevoCOVendedorManejadorRequest implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmReporteClienteNuevoCOVendedorManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("Consultar") == 0 ) {
           ...
           campoAValidar.setPaginaRetorno("/jsp/vtaContenedorReporteClienteNuevoCOVendedor.jsp");
           ...
           campoAValidar.validarCampoFecha();
           campoAValidar.setPaginaRetorno("/ControlTrafico/vtaContenedorReporteClienteNuevoCOVendedor.jsp");
           ...
           if (idDestinacion.compareTo("Pantalla")==0){
               return "/jsp/vtaFrmLstReporteClienteNuevoCOVendedor.jsp";
           } else {
               return "/jsp/vtaFrmLstReporteClienteNuevoCOVendedorArchivo.jsp";
          }
        }
    }
