...
/**
 * El reporte muestra las ventas que ha hecho cada vendedor por categoría y su respectiva rentabilidad./
 * vtaContenedorRepRentabilidadCategoria.jsp/
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepRentbilidadCategoriaManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepRentbilidadCategoriaManejadorRequest (){ }
/**
     * BUTTON PARAMETER--
...
//            String xIndicadorCadena     = "1,2";
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepRendadCategoria.jsp";

           }


            //
            GeneraPdfAllRentbilidadCategoria generaPdfAllRentbilidadCategoria
                                        = new GeneraPdfAllRentbilidadCategoria();

            //
            generaPdfAllRentbilidadCategoria.setTituloReporte("REPORTE VENTAS" +
                                                   "RENTABILIDAD POR CATEGORIA");
            generaPdfAllRentbilidadCategoria.setFechaInicial(xFechaInicial);
            generaPdfAllRentbilidadCategoria.setFechaFinal(xFechaFinal);
            generaPdfAllRentbilidadCategoria.setIdLocal(xIdLocalUsuario);
            generaPdfAllRentbilidadCategoria.setIdVendedor(xIdVendedor);
            generaPdfAllRentbilidadCategoria.setIdTipoOrdenINI(9);
            generaPdfAllRentbilidadCategoria.setIdTipoOrdenFIN(29);
            generaPdfAllRentbilidadCategoria.setIndicadorINI(xIndicadorInicial);
            generaPdfAllRentbilidadCategoria.setIndicadorFIN(xIndicadorFinal);


            generaPdfAllRentbilidadCategoria.setNombreReporte("AudtoriaRepRentbilidadCategoria");
            

            //
            generaPdfAllRentbilidadCategoria.generaPdf(request, response);
