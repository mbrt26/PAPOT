...
public class GeneraPDFHistoriaCxC implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        String reportName =
          "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepEmpresaHistoriaCxC";
        ...
        //
        pars.put("p_numeroDctos", fachadaDctoBean.getNumeroDctos());
        pars.put("p_vrBase",     fachadaDctoBean.getVrBase());
        pars.put("p_vrSaldo",     fachadaDctoBean.calculaVrPedidoConIva());
        ...
        Collection lista = colaboraDctoBean.listaHistoriaDetalle();
