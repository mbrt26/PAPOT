...
public class GeneraPDFCompraLegal implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        String reportName =
          "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepCompraLegal";
        ...
        Collection lista = colaboraDctoBean.listaCompra(
                                            getFechaInicialSqlServer(),
                                            getFechaFinalSqlServer(),
                                            "1,21",
                                            "1");
