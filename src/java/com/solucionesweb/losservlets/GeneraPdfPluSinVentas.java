...
public class GeneraPdfPluSinVentas implements GralManejadorRequest {
...
//
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        //
        pars.put("p_idLocal",fachadaLocalBean.getIdLocal());
        ...
        //
           ...
           ColaboraIndicadorInventario colaboraIndicadorInventario =
                                            new ColaboraIndicadorInventario();

           colaboraIndicadorInventario.setIdLocal(getIdLocal());
           colaboraIndicadorInventario.setFechaInicialStr(getFechaInicial());
           colaboraIndicadorInventario.setFechaFinalStr(getFechaFinal());
           colaboraIndicadorInventario.setIdTipoOrdenINI(getIdTipoOrdenINI());
           colaboraIndicadorInventario.setIdTipoOrdenFIN(getIdTipoOrdenFIN());
           colaboraIndicadorInventario.setIndicadorInicial(getIndicadorINI());
           colaboraIndicadorInventario.setIndicadorFinal(getIndicadorFIN());


        //1-Llenar el datasource con la informacion de la base de datos
        Collection lista =
                colaboraIndicadorInventario.listaIndicadorSinVentas();
