...
public class GeneraPDFCxPDetalleAll implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        String reportName =
          "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepEmpresaCxPDetalle";
       ...
       //   "c:\\proyectoWeb\\Commerce\\web\\imagenes\\Logo_SmallBrilloColor.JPG";
        ...
        pars.put("p_titulo", "COMPRAS DETALLE CXP AL DIA " + strFechaHoy );
        ...
        Collection lista = colaboraDctoBean.listaCxCDetalladoAll("");
