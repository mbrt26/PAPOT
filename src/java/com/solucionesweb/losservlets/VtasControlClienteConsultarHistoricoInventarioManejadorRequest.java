...
*/
public class VtasControlClienteConsultarHistoricoInventarioManejadorRequest
                                                 implements GralManejadorRequest
{

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlClienteConsultarHistoricoInventarioManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    // Aqui escribe el Bean de Validacion en el Request para manejar el error
    request.setAttribute("fachadaAgendaLogVisitaBean",fachadaAgendaLogVisitaBean);
    return "/jsp/vtaFrmConClienteConsultarHistoricoInventario.jsp";
