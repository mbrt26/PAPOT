...
*/
public class VtasControlClienteAutorizaProspectoUnCOUnCOManejadorRequest
                                               implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlClienteAutorizaProspectoUnCOUnCOManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    //
    return "/jsp/vtaContenedorClienteAutorizaProspectoUnCO.jsp";
