...
public class GeneraPdfAllRentbilidadCliente implements GralManejadorRequest {
...
//
       ...
       //
       fachadaDctoBean =
         colaboraIndicadorRentabilidad.listaIndicadorRentabilidadClienteTotal();
       
               //
        pars.put("p_vrBase",fachadaDctoBean.getVrBase());
        pars.put("p_vrIva",fachadaDctoBean.getVrIva());
        pars.put("p_vrCostoMV",fachadaDctoBean.getVrCostoMV());
        pars.put("p_vrCostoIND",fachadaDctoBean.getVrCostoIND());
        pars.put("p_margenCliente",fachadaDctoBean.getMargenCliente());
