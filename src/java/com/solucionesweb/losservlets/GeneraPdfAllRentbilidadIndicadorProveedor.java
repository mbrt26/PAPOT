...
public class GeneraPdfAllRentbilidadIndicadorProveedor implements GralManejadorRequest {
   ...
   //
    public String generaPdf(HttpServletRequest request,
       ...
       colaboraRentabilidad.setFechaInicialStr(getFechaInicial());
      ...
      //
       ...
       lista =
         colaboraRentabilidad.listaIndicadorRentabilidadProveedor();
