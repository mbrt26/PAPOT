...
/**
 * El reporte muestra las ventas del vendedor por plu y la respectiva rentabilidad de cada uno de los plu vendidos. /
 * vtaContenedorRepRentabilidadVendedorPlu.jsp/
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepRentbilidadVendedorPluManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepRentbilidadVendedorPluManejadorRequest (){ }
...
//            String xIndicadorCadena     = "1,2";
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepRendadVendPlu.jsp";

           }


            //
            GeneraPdfAllRentbilidadVendedor generaPdfAllRentbilidadVendedor
                                        = new GeneraPdfAllRentbilidadVendedor();
            ...
            generaPdfAllRentbilidadVendedor.setIdTipoOrdenINI(xTipoOrdenINI);
            generaPdfAllRentbilidadVendedor.setIdTipoOrdenFIN(xTipoOrdenFIN);
           ...
           generaPdfAllRentbilidadVendedor.setNombreReporte("AudtoriaRepRentbilidadVendedor");
