...
/**
 * Permite digitar el nombre o NIT del cliente y se selecciona la opcion Buscar
 * para desplegar los registros de clientes que coincidan con este nombre o NIT.
 * vtaContenedorEmpresaSelecciona.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest
 */

public class VtasAdmEmpresaSeleccionaManejadorRequest
                                               implements GralManejadorRequest {
     /**
     * BUTTON--
     * ("Buscar")-Permite ver una lista de clientes o un cliente/
     * ("Regresar")-Permite regresar al menu principal /
     * 
     * Metodo contructor por defecto, es decir, sin parametros/
     */

  public VtasAdmEmpresaSeleccionaManejadorRequest () { }

  /**
  * BUTTON PARAMETER--
  * "NombreTercero"-Corresponde al nombre del cliente /
  * 
  * Retorna la URL de la pagina que deber? ser entregada como respuesta(normalmente un pagina jsp)./
  */
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("Confirmar") == 0 )  {
                ...
                try {
                    ...
                    Logger.getLogger(VtasAdmEmpresaSeleccionaManejadorRequest.class.getName()).log(Level.SEVERE, null, ex);
                }
