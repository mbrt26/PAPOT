...
/**
 * El reporte lista los plu que se han vendido en el rango de fechas y los ordena de mayor a menor cantidad vendida /
 * vtaContenedorRepPluMasVendidos.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepPlusMasVendidosManejadorRequest
     ...
     */
    public VtasAdmRepPlusMasVendidosManejadorRequest() {
    }
...
//            String xIndicadorCadena     = "1,2";
                ...
                //
                GeneraPdfPluMasVendidos generaPdfPluMasVendidos = new GeneraPdfPluMasVendidos();

                //
                generaPdfPluMasVendidos.setTituloReporte("REPORTE PLU MAS VENDIDOS");
                generaPdfPluMasVendidos.setFechaInicial(xFechaInicial);
                generaPdfPluMasVendidos.setFechaFinal(xFechaFinal);
                generaPdfPluMasVendidos.setIdLocal(xIdLocalUsuario);
                generaPdfPluMasVendidos.setIdVendedor(xIdVendedor);
                generaPdfPluMasVendidos.setIdTipoOrdenINI(9);
                generaPdfPluMasVendidos.setIdTipoOrdenFIN(29);
                generaPdfPluMasVendidos.setIndicadorINI(xIndicadorInicial);
                generaPdfPluMasVendidos.setIndicadorFIN(xIndicadorFinal);
                generaPdfPluMasVendidos.setIdBodega(1);
                generaPdfPluMasVendidos.setNombreReporte("AudtoriaRepPluMasVendidos");

                //
                generaPdfPluMasVendidos.generaPdf(request, response);
