...
public class GeneraPDFDetallaCxP implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        String reportName =
        "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepEmpresaProveedorDetalleCxP";
        ...
        //
        colaboraOrdenVentaBean.setIdLocal(this.getIdLocal());
        colaboraOrdenVentaBean.setIdOrden(this.getIdOrden());
        colaboraOrdenVentaBean.setIdTipoOrden(this.getIdTipoOrden());
        ...
        //
        String xTextoFactura     = "ORDEN COMPRA";
        ...
        FachadaDctoBean fachadaDctoBean
                                 = new FachadaDctoBean();
        //
        dctoBean.setIdLocal(this.getIdLocal());
        dctoBean.setIdTipoOrden(this.getIdTipoOrden());
        dctoBean.setIdOrden(this.getIdOrden());

        //
        fachadaDctoBean          = dctoBean.listaUnDctoOrden();

        //
        String xIdDcto           = fachadaDctoBean.getIdDctoNitCC();
        xTextoFactura            = xTextoFactura + " " + xIdDcto ;

        //
        pars.put("p_textoFactura",xTextoFactura);
        pars.put("p_fechaOrden", "FECHA FRA " +
                                      fachadaDctoBean.getFechaDctoNitCCCorta());
        ...
        pars.put("p_vrVentaConIva", fachadaDctoBean.getVrBase()      +
        ...
        // DetallaOrden
        colaboraOrdenVentaBean.setIdLocal(getIdLocal());
        colaboraOrdenVentaBean.setIdOrden(getIdOrden());
        colaboraOrdenVentaBean.setIdTipoOrden(getIdTipoOrden());
