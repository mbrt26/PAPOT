...
/**
 * El reportes muestra las ventas que cada vendedor a realizado a los clientes 
 * y la rentabilidad correspondiente a cada uno./
 * vtaContenedorRepRentabilidadVendedorCliente.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepRentbilidadVendedorClienteManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepRentbilidadVendedorClienteManejadorRequest(){ }
...
//            
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepRendadVendCliente.jsp";

           }


            //
            GeneraPdfAllRentbilidadVendedorClienteCliente
             generaPdfAllRentbilidadVendedorClienteCliente
                          = new GeneraPdfAllRentbilidadVendedorClienteCliente();

            //
            generaPdfAllRentbilidadVendedorClienteCliente.setTituloReporte("REPORTE " +
                                                   "RENTABILIDAD VENDEDOR/CLIENTE");
            generaPdfAllRentbilidadVendedorClienteCliente.setFechaInicial(xFechaInicial);
            generaPdfAllRentbilidadVendedorClienteCliente.setFechaFinal(xFechaFinal);
            generaPdfAllRentbilidadVendedorClienteCliente.setIdLocal(xIdLocalUsuario);
            generaPdfAllRentbilidadVendedorClienteCliente.setIdVendedor(xIdVendedor);
            generaPdfAllRentbilidadVendedorClienteCliente.setIdTipoOrdenINI(9);
            generaPdfAllRentbilidadVendedorClienteCliente.setIdTipoOrdenFIN(29);
            generaPdfAllRentbilidadVendedorClienteCliente.setIndicadorINI(xIndicadorInicial);
            generaPdfAllRentbilidadVendedorClienteCliente.setIndicadorFIN(xIndicadorFinal);
            
            generaPdfAllRentbilidadVendedorClienteCliente.setNombreReporte("AudtoriaRepRentbilidadVendedorCliente");
            
            //
            generaPdfAllRentbilidadVendedorClienteCliente.generaPdf(request, response);
