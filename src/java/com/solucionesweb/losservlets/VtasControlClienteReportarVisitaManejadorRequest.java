...
*/
public class VtasControlClienteReportarVisitaManejadorRequest implements GralManejadorRequest
{

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlClienteReportarVisitaManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    request.setAttribute("fachadaAgendaLogVisitaBean",fachadaAgendaLogVisitaBean);
    return "/jsp/vtaFrmConClienteReportarVisita.jsp";
