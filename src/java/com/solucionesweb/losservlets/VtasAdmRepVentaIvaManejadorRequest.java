...
public class VtasAdmRepVentaIvaManejadorRequest
...
/**
    ...
    public VtasAdmRepVentaIvaManejadorRequest() {
    }
/**
   * BUTTON PARAMETER--
...
//            String xIndicadorCadena     = "1,2";
                ...
                //
                generaPdfAllResurtido.setTituloReporte("REPORTE DETALLE VENTAS");
                ...
                if (generaPdfAllResurtido.getIdVendedor() > 0) {
                    ...
                    generaPdfAllResurtido.setNombreReporte("VtasRepAllVenta");
                }
