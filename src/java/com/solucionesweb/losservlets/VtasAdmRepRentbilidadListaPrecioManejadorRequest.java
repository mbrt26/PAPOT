...
/**
 * El reporte muestra las ventas hechas por lista de precios. /
 * vtaContenedorRepRentabilidadListaPrecio.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepRentbilidadListaPrecioManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepRentbilidadListaPrecioManejadorRequest (){ }
...
//            String xIndicadorCadena     = "1,2";
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepRendadListaPrecio.jsp";

           }


            //
            GeneraPdfAllRentbilidadListaPrecio generaPdfAllRentbilidadListaPrecio
                                        = new GeneraPdfAllRentbilidadListaPrecio();

            //
            generaPdfAllRentbilidadListaPrecio.setTituloReporte("REPORTE VENTAS" +
                                                   "RENTABILIDAD POR LISTA PRECIO");
            generaPdfAllRentbilidadListaPrecio.setFechaInicial(xFechaInicial);
            generaPdfAllRentbilidadListaPrecio.setFechaFinal(xFechaFinal);
            generaPdfAllRentbilidadListaPrecio.setIdLocal(xIdLocalUsuario);
            generaPdfAllRentbilidadListaPrecio.setIdVendedor(xIdVendedor);
            generaPdfAllRentbilidadListaPrecio.setIdTipoOrdenINI(9);
            generaPdfAllRentbilidadListaPrecio.setIdTipoOrdenFIN(29);
            generaPdfAllRentbilidadListaPrecio.setIndicadorINI(xIndicadorInicial);
            generaPdfAllRentbilidadListaPrecio.setIndicadorFIN(xIndicadorFinal);


            //
            generaPdfAllRentbilidadListaPrecio.setNombreReporte("AudtoriaRepRentbilidadListaPrecio");
            

            //
            generaPdfAllRentbilidadListaPrecio.generaPdf(request, response);
