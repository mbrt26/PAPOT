...
/**
 * 
 * En esta ventana se listan las facturas pendientes por pagar al proveedor
 * seleccionado, detallando la fecha de elaboracion, los dias transcurridos y el saldo de cada factura. /
 * vtaContenedorEmpresaProveedorCxC.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest
 */

public class VtasAdmEmpresaProveedorCxCManejadorRequest
                                               implements GralManejadorRequest {
  /**
    * BUTTON--
    * ("Listar")-Genera pdf con listado de facturas pendientes por paga al proveedor seleccionado /
    * ("Regresar")- Regresa  al menu principal/
    * 
    * Metodo contructor por defecto, es decir, sin parametros/
    */
  public VtasAdmEmpresaProveedorCxCManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    if (accionContenedor != null ) {
        ...
        if (accionContenedor.compareTo("Listar") == 0 ) {
            ...
            //
            GeneraPDFProveedorCxC generaPDFCxC = new GeneraPDFProveedorCxC();
