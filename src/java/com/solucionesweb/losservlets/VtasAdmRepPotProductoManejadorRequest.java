...
/**
 * El reporte muestra la productividad P.O.T en el rango de fechas seleccionadas,
 * la operación y operario responsable. /
 * vtaContenedorRepPotProducto.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepPotProductoManejadorRequest
     ...
     */
    public VtasAdmRepPotProductoManejadorRequest() { }
/**
     * BUTTON PARAMETER--
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstRepPotProductoArchivo.jsp";

                } else {

                    //
                    return "/jsp/vtaFrmLstRepPotProducto.jsp";
                }
            }
        }
