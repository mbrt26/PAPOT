...
/**
 * Este servlet permite que se listen las facturas pendientes del cliente seleccionado,
 * detallando la fecha de elaboracion, los dias transcurridos y el saldo de cada factura /
 * vtaContenedorEmpresaCxC.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmEmpresaCxCManejadorRequest
                                               implements GralManejadorRequest {

  /**
     * BUTTON--
     * ("Listar")-Permite generar un pdf del estado de la cuenta de un cliente previamente seleccionado /
     * ("Regresar")-Regresa al menu principal /
     * 
     * Metodo contructor por defecto, es decir, sin parametros /
     */
  public VtasAdmEmpresaCxCManejadorRequest () { }
