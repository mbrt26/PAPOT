...
*/
public class VtasControlInventarioCategoriaManejadorRequest
                                                 implements GralManejadorRequest
{

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlInventarioCategoriaManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,
    ...
    return "/jsp/vtaContenedorInventarioCategoria.jsp";
