...
/**
 * El reporte muestra las ventas por marca del vendedor y la respectiva rentabilidad de cada marca. /
 * vtaContenedorRepRentabilidadMarca.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepRentbilidadMarcaManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepRentbilidadMarcaManejadorRequest (){ }
...
//            String xIndicadorCadena     = "1,2";
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepRendadMarca.jsp";

           }


            //
            GeneraPdfAllRentbilidadMarca generaPdfAllRentbilidadMarca
                                        = new GeneraPdfAllRentbilidadMarca();

            //
            generaPdfAllRentbilidadMarca.setTituloReporte("REPORTE VENTAS" +
                                                   "RENTABILIDAD POR MARCA");
            generaPdfAllRentbilidadMarca.setFechaInicial(xFechaInicial);
            generaPdfAllRentbilidadMarca.setFechaFinal(xFechaFinal);
            generaPdfAllRentbilidadMarca.setIdLocal(xIdLocalUsuario);
            generaPdfAllRentbilidadMarca.setIdVendedor(xIdVendedor);
            generaPdfAllRentbilidadMarca.setIdTipoOrdenINI(9);
            generaPdfAllRentbilidadMarca.setIdTipoOrdenFIN(29);
            generaPdfAllRentbilidadMarca.setIndicadorINI(xIndicadorInicial);
            generaPdfAllRentbilidadMarca.setIndicadorFIN(xIndicadorFinal);


            //
            generaPdfAllRentbilidadMarca.setNombreReporte("AudtoriaRepRentbilidadMarca");
           
            //
            generaPdfAllRentbilidadMarca.generaPdf(request, response);
