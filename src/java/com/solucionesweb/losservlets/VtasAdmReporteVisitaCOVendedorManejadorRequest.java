...
public class VtasAdmReporteVisitaCOVendedorManejadorRequest implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmReporteVisitaCOVendedorManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    if (accionContenedor != null ) {
        ...
        //
	    if (accionContenedor.compareTo("contacto") == 0 ) {

            //
            String idLog = request.getParameter("idLog");

            //
            request.setAttribute("idLog",idLog);
            return "/jsp/vtaFrmLstReporteVisitaCOVendedorContacto.jsp";
	    ...
	    if (accionContenedor.compareTo("Consultar") == 0 ) {
    	   ...
    	   colaboraReporteLogBean.setIdLocal(idLocal);
           ...
           if (idDestinacion.compareTo("Pantalla") == 0 ){
              return "/jsp/vtaFrmLstReporteVisitaCOVendedor.jsp";
           } else {
              return "/jsp/vtaFrmLstReporteVisitaCOVendedorArchivo.jsp";
          }              
        }
    }
