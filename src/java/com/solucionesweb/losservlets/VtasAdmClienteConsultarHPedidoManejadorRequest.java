...
public class VtasAdmClienteConsultarHPedidoManejadorRequest
        implements GralManejadorRequest {

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasAdmClienteConsultarHPedidoManejadorRequest() {
    }
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                request.setAttribute("fachadaColaboraLogisticaBean",
                        fachadaColaboraLogisticaBean);
                return "/jsp/vtaFrmLstClienteConsultarHPedido.jsp";
            ...
            if (accionContenedor.compareTo("Seleccionar") == 0) {
                ...
                request.setAttribute("fachadaAgendaLogVisitaBean",
                        fachadaAgendaLogVisitaBean);
                return "/jsp/vtaFrmConClienteConsultarHPedido.jsp";
            }
