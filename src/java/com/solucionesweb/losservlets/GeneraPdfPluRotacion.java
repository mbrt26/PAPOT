...
public class GeneraPdfPluRotacion implements GralManejadorRequest {
	...
	JasperReport jasperReport;
        ...
        colaboraIndicadorInventario.setIdTipoOrden(getIdTipoOrdenINI());
        colaboraIndicadorInventario.setIdBodega(getIdBodega());

        //1-Llenar el datasource con la informacion de la base de datos
        Collection lista =
                colaboraIndicadorInventario.listaIndicadorPluRotacion(
