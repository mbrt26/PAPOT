...
public class GeneraPDFCompraTotalLegal implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        //
        fachadaDctoBean  = colaboraDctoBean.listaCompraFCH(
        ...
        Collection lista = colaboraDctoBean.listaCompraTotal(
                                            getFechaInicialSqlServer(),
                                            getFechaFinalSqlServer(),
                                            "1,21",
                                            "1");
