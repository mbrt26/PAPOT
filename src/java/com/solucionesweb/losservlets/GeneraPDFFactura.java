...
public class GeneraPDFFactura implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        String xSoftware = "Emitida por computador por Plásticos Unión S.A.S" ;

        //---
        String xTextoProductoUno = "Empaques Flexibles";
        String  xTextoProductoDos = "Polipropileno, Polietilenos";
        String   xTextoContribuyente= "No Somos Grandes Contribuyentes";
        String   xTextoResposableIva= "No Somos Retenedores de Iva";
        ...
        //
        String reportName =
                "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepFacturaAnual";
        ...
        pars.put("p_textoProductoUno", xTextoProductoUno);
        pars.put("p_textoProductoDos", xTextoProductoDos);
        pars.put("p_textoContribuyente", xTextoContribuyente);
        pars.put("p_textoResposableIva", xTextoResposableIva);

        //
        FachadaColaboraDctoOrdenBean fachadaColaboraCliente
        ...
        //
        String xTextoFactura =
                fachadaOrdenVenta.getTxtFactura().trim() + " "
                + fachadaLocalCaja.getPrefijo();
        ...
        pars.put("p_telefonoFijo", 
                 fachadaTerceroBean.getTelefonoFijo());
        pars.put("p_diasPago",
                fachadaTerceroBean.getIdFormaPagoStr() + " DIAS");
        ...
        pars.put("p_fechaVencimiento", fachadaDctoBean.getFechaVencimientoFacAmbi());
        pars.put("p_fechaOrden", fachadaDctoBean.getFechaDctoFactAmbi());
        ...
        pars.put("p_idOrden",geIdOrdenStr());
        ...
        //
        String xValorLetras =
                valorLetra.convertNumberToLetter(fachadaDctoBean.getVrFacturaSf0());
        ...
        Collection lista = colaboraOrdenVentaBean.detallaUnPedidoOrdenCopia();
