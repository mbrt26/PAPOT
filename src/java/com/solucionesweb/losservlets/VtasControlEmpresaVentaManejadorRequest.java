...
//
public class VtasControlEmpresaVentaManejadorRequest
        implements GralManejadorRequest {

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasControlEmpresaVentaManejadorRequest() {
    }
    ...
    public String generaPdf(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!xOkProceso) {
            ...
            if (!xOkOcupado) {
                ...
                //
                agendaLogVisitaBean.setIdUsuario(xIdUsuario);
                agendaLogVisitaBean.setIdCliente(xIdClienteMostrador);
        ...
        //
        terceroBean.setIdCliente(xIdClienteMostrador);
