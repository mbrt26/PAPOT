...
*/
public class VtasControlClienteAutorizaPedidoFinancieroManejadorRequest
                                               implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlClienteAutorizaPedidoFinancieroManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    //
    return "/jsp/vtaContenedorClienteAutorizaPedidoFinanciero.jsp";
