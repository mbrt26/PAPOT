...
public class GeneraPDFVentaIngresoCaja implements GralManejadorRequest {
    ...
    public GeneraPDFVentaIngresoCaja() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPDFVentaIngresoCaja.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (this.getIdVendedor()>0) {
           ...
           reportName =
           "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepVentaIngresoCaja";
