...
/**
 *  El sistema muestra las ventas hechas por zona geográfica. /
 * vtaContenedorRepRentabilidadZonaGeografica.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepRentbilidadZonaGeograficaManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepRentbilidadZonaGeograficaManejadorRequest (){ }
...
//            String xIndicadorCadena     = "1,2";
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepRendadZona.jsp";

           }


            //
            GeneraPdfAllRentbilidadZonaGeografica generaPdfAllRentbilidadZonaGeografica
                                        = new GeneraPdfAllRentbilidadZonaGeografica();

            //
            generaPdfAllRentbilidadZonaGeografica.setTituloReporte("REPORTE VENTAS" +
                                                   "RENTABILIDAD POR ZONA GEOGRAFICA");
            generaPdfAllRentbilidadZonaGeografica.setFechaInicial(xFechaInicial);
            generaPdfAllRentbilidadZonaGeografica.setFechaFinal(xFechaFinal);
            generaPdfAllRentbilidadZonaGeografica.setIdLocal(xIdLocalUsuario);
            generaPdfAllRentbilidadZonaGeografica.setIdVendedor(xIdVendedor);
            generaPdfAllRentbilidadZonaGeografica.setIdTipoOrdenINI(9);
            generaPdfAllRentbilidadZonaGeografica.setIdTipoOrdenFIN(29);
            generaPdfAllRentbilidadZonaGeografica.setIndicadorINI(xIndicadorInicial);
            generaPdfAllRentbilidadZonaGeografica.setIndicadorFIN(xIndicadorFinal);


            generaPdfAllRentbilidadZonaGeografica.setNombreReporte("AudtoriaRepRentbilidadZonaGeografica");
            
            //
            generaPdfAllRentbilidadZonaGeografica.generaPdf(request, response);
