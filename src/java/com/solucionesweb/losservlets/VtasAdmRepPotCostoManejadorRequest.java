...
/**
 * El reporte muestra los costos P.O.T en el rango de fechas seleccionadas y la operación correspondiente. /
 * vtaContenedorRepPotCosto.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepPotCostoManejadorRequest
     ...
     */
    public VtasAdmRepPotCostoManejadorRequest() { }
    /**
     * BUTTON PARAMETER--
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstRepPotCostoArchivo.jsp";

                } else {

                   //
                   return "/jsp/vtaFrmLstRepPotCosto.jsp";
                }
            }
        }
