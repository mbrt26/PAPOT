...
/**
 * El reporte muestra los descuentos hechos a las facturas realizadas en el rango
 * de fechas seleccionadas y el responsable correspondiente./
 * vtaContenedorRepDEsctoFact.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepDesctoFactManejadorRequest
                                                 implements GralManejadorRequest
{
  ...
  /**
     ...
     */
  public VtasAdmRepDesctoFactManejadorRequest (){ }
...
//            String xIndicadorCadena     = "1,2";
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
            ...
            //
            GeneraPdfPluDesctoFact generaPdfPluDesctoFact
                                        = new GeneraPdfPluDesctoFact();

            //
            generaPdfPluDesctoFact.setTituloReporte("REPORTE DESCUENTO POR PLU");
            generaPdfPluDesctoFact.setFechaInicial(xFechaInicial);
            generaPdfPluDesctoFact.setFechaFinal(xFechaFinal);
            generaPdfPluDesctoFact.setIdLocal(xIdLocalUsuario);
            generaPdfPluDesctoFact.setIdVendedor(xIdVendedor);
            generaPdfPluDesctoFact.setIdTipoOrdenINI(9);
            generaPdfPluDesctoFact.setIdTipoOrdenFIN(29);
            generaPdfPluDesctoFact.setIndicadorINI(xIndicadorInicial);
            generaPdfPluDesctoFact.setIndicadorFIN(xIndicadorFinal);
            generaPdfPluDesctoFact.setNombreReporte("AudtoriaRepDesctoFact");

            //
            generaPdfPluDesctoFact.generaPdf(request, response);
