...
public class GeneraPdfComisionEfectiva implements GralManejadorRequest {
    ...
    public GeneraPdfComisionEfectiva() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        if (this.getIdVendedor()>0) {
           ...
           //
           lista = colaboraLucro.listaRecaudoEfectivoUn();
           ...
           //
           lista = colaboraLucro.listaRecaudoEfectivo();
