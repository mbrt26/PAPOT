...
public class GeneraPdfAllRentbilidadVendedorClienteCliente implements GralManejadorRequest {
   ...
   //
    public String generaPdf(HttpServletRequest request,
      ...
      //
       ...
       lista =
         colaboraIndicadorRentabilidad.listaIndicadorRentabilidadVendCliente();
