...
*/
public class VtasControlClienteNuevoDesactivarManejadorRequest
                                        implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlClienteNuevoDesactivarManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    return "/jsp/vtaContenedorClienteNuevoDesactivar.jsp";
