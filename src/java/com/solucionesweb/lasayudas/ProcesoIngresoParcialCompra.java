...
public class ProcesoIngresoParcialCompra {

    // Metodo contructor por defecto, es decir, sin parametros
    public ProcesoIngresoParcialCompra() {
    }
    ...
    public DctoBean ingresa(int xIdLocal,
        ...
        //---
        dctoOrdenDetalleBean.ingresoParcialCompra(xIdLocal,
                                                  xIdTipoOrdenNew,
                                                  xIdOrdenMax);

        //---
        dctoOrdenDetalleBean.actualizaParcialCompra(xIdLocal,
                                                  xIdTipoOrdenNew,
                                                  xIdOrdenMax);
    ...
    public DctoBean ingresaRecepcion(int xIdLocal,
            int xIdTipoOrdenNew,
            int xIdLog,
            int xIdTipoOrdenOld,
            FachadaColaboraDctoOrdenBean fachadaProveedorBean) {
        ...
        //
        dctoOrdenDetalleBean.actualizaBodegaMPRecep();
    ...
    public DctoBean ingresaCompra(int xIdLocal,
            int xIdTipoOrdenNew,
            int xIdLog,
            int xIdTipoOrdenOld,
            FachadaColaboraDctoOrdenBean fachadaProveedorBean) {
        ...
        dctoBean.setIdTipoNegocio(xIdTipoNegocioVenta);
        dctoBean.setVrRteFuente(fachadaProveedorBean.getVrCostoRteFuente());
        dctoBean.setVrRteCree(fachadaProveedorBean.getVrCostoRteCree());
        dctoBean.setVrDescuento(fachadaProveedorBean.getVrDescuento());
        dctoBean.setVrRteIva(0);
        dctoBean.setVrRteIca(0);
        dctoBean.setIdUsuario(xIdUsuario);
        ...
        dctoBean.setVrPagarDctoNitCC(fachadaProveedorBean.getVrCostoSinIva()
                - fachadaProveedorBean.getVrImpoconsumo()
                - fachadaProveedorBean.getVrCostoRteFuente()
                - fachadaProveedorBean.getVrCostoRteCree());
        dctoBean.setVrDsctoFcro(0);
        dctoBean.setIdDctoCruce(0);
        dctoBean.setVrCostoMV(xVrCosto);
        dctoBean.setEstadoDcto(0);
...
//                xIdOrdenMax);
    ...
    public DctoBean ingresaCompras(int xIdLocal,
            int xIdTipoOrdenNew,
            int xIdLog,
            int xIdTipoOrdenOld,
            FachadaColaboraDctoOrdenBean fachadaProveedorBean) {
    ...
    fachadaDctoOrdenBean = dctoOrdenBean.listaDctoOrdenLog();
    ...
    String ordenCompra = fachadaDctoOrdenBean.getOrdenCompra();
    String descuentoComercial = fachadaDctoOrdenBean.getDescuentoComercialStr();
    ...
    double xVrVentaSinIva = fachadaDctoOrdenDetalleBean.getVrVentaSinIva();
    
    double xVrVentaSinDscto = fachadaDctoOrdenDetalleBean.getVrVentaSinDscto();
    
    double xVrIva = fachadaDctoOrdenDetalleBean.getVrIvaVenta();
    
    double xVrCosto = fachadaDctoOrdenDetalleBean.getVrCostoConIva();
    
    double xVrImpoconsumo = fachadaDctoOrdenDetalleBean.getVrImpoconsumo();
    
    double xVrCostoIND = fachadaDctoOrdenDetalleBean.getVrCostoIND();
    


    int xIdOrdenMax = dctoOrdenBean.maximaIdOrdenIdLocal() + 1;
    ...
    dctoBean.setFechaDcto(fachadaProveedorBean.getFechaOrdenCorta());
    dctoBean.setIdDcto(xIdDctoMax);
    dctoBean.setVrBase(fachadaProveedorBean.getVrCostoSinIva() - fachadaProveedorBean.getVrImpoconsumo());
    
    dctoBean.setVrPago(0.0D);
    dctoBean.setEstado(1);
    ...
    dctoBean.setVrRteIva(0.0D);
    dctoBean.setVrRteIca(0.0D);
    dctoBean.setIdUsuario(xIdUsuario);
    dctoBean.setIdCliente(xIdTercero);
    dctoBean.setDiasPlazo(xIdFormaPago);
    dctoBean.setPorcentajeDscto(0.0D);
    dctoBean.setIdCausa(0);
    dctoBean.setIdDctoNitCC(fachadaProveedorBean.getIdDctoNitCC());
    dctoBean.setFechaDctoNitCC(fachadaProveedorBean.getFechaEntregaCorta());
    dctoBean.setVrPagarDctoNitCC(fachadaProveedorBean.getVrCostoSinIva() - fachadaProveedorBean.getVrImpoconsumo() - fachadaProveedorBean.getVrCostoRteFuente() - fachadaProveedorBean.getVrCostoRteCree());
    


    dctoBean.setVrDsctoFcro(0.0D);
    dctoBean.setIdDctoCruce(0.0D);
    dctoBean.setVrCostoMV(xVrCosto);
    dctoBean.setEstadoDcto(0);
    dctoBean.setIdLocalAdicional(xIdLocal);
    dctoBean.setIdPeriodo(0);
    ...
    dctoOrdenDetalleBean.ingresoParcialCompra(xIdLocal, xIdTipoOrdenNew, xIdOrdenMax);
    



    dctoOrdenDetalleBean.setIdLocalOrigen(xIdLocal);
    dctoOrdenDetalleBean.setIdTipoOrdenOrigen(xIdTipoOrdenOld);
    dctoOrdenDetalleBean.setIdOrdenOrigen(xIdOrdenOld);
    ...
    dctoOrdenDetalleBean.actualizaParcialCompra(xIdLocal, xIdTipoOrdenNew, xIdOrdenMax);
    ...
    pluBean.actualizaCosto(xIdLocal, xIdTipoOrdenNew, xIdOrdenMax);
...
//    procesoIventario.actualizaInventarioEstado(xIdLocal, xIdTipoOrdenNew, xIdOrdenMax);
