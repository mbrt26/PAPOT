...
public class ProcesoIngresoES {

    // Metodo contructor por defecto, es decir, sin parametros
    public ProcesoIngresoES() { }
    ...
    public int ingresa(int xIdLocal,
        ...
        int xIndicador = 1;
        int xIdTipoOrdenTraslado = 18;
        
        //--
        int xIdPlu = 209;
        int xIdBodegaActualExtrusion = 2;
        ...
        //--
        if (xIdBodegaActualExtrusion == xIdBodegaActual) {
            
           //---
           dctoOrdenDetalleBean.setIdPlu(xIdPlu);                
           dctoOrdenDetalleBean.setIdBodega(xIdBodegaActualExtrusion);              

           //---
           dctoOrdenDetalleBean.ingresaPTComplementoES(xIdBodegaActualExtrusion);  
    ...
    public boolean retira(int xIdLocal,
        ...
        //----------------------------------------------------------------------
        xPesoTerminada      = xPesoTerminada * (-1);
        xCantidadTerminada  = xCantidadTerminada * (-1);
        ...
        if (xIdBodegaActualExtrusion == xIdBodegaActual) {
           ...
           //---
           dctoOrdenDetalleBean.ingresaPTComplemento(xIdBodegaActualExtrusion);  
    ...
    //
    public boolean retiraOTCruce(double xIdVendedor,
            String xIdCliente,
            int xIdLocalCruce,
        ...
        agendaLogVisitaBean.setIdCliente(xIdCliente);
        agendaLogVisitaBean.setIdUsuario(xIdVendedor);
        agendaLogVisitaBean.setIdLocal(xIdLocalCruce);
        agendaLogVisitaBean.setFechaVisita(xFechaHoy);
        agendaLogVisitaBean.setIdEstadoVisita(xEstadoVisita);
        agendaLogVisitaBean.setEstado(xEstadoCerrado);
        agendaLogVisitaBean.setIdTipoOrden(xIdTipoOrdenCruce);
        ...
        //----------------------------------------------------------------------
        dctoOrdenBean.setIdLocal(xIdLocalCruce);
        ...
        // ingresaPedido
        dctoOrdenBean.setIdLocal(xIdLocalCruce);
        dctoOrdenBean.setIdTipoOrden(xIdTipoOrdenCruce);
        dctoOrdenBean.setIdOrden(xIdOrdenMax);
        dctoOrdenBean.setFechaOrden(fechaHoy.getFechaFormateada());
        dctoOrdenBean.setEstado(xEstadoDcto);
        dctoOrdenBean.setIdCliente(xIdCliente);
        ...
        dctoOrdenBean.setIdLog(xIdLogMax);
        dctoOrdenBean.setFechaEntrega(fechaHoy.getFechaFormateada());
        dctoOrdenBean.setTipoDcto(new Integer(xIdTipoOrdenCruce).toString());
        dctoOrdenBean.setEmail(email);
        dctoOrdenBean.setFax(fax);
        dctoOrdenBean.setContacto(contacto);
        dctoOrdenBean.setObservacion(observacion);
        ...
        //
        dctoOrdenDetalleBean.setIdLocal(xIdLocalCruce);
        dctoOrdenDetalleBean.setIdTipoOrden(xIdTipoOrdenCruce);
        dctoOrdenDetalleBean.setIdOrden(xIdOrdenCruce);

        //
        dctoOrdenDetalleBean.ingresaOTCruce(xIdLocalCruce,
                                            xIdTipoOrdenCruce,
                                            xIdOrdenMax);
        ...
        //
        dctoBean.setIdLocal(xIdLocalCruce);
        ...
        //
        colaboraDctoOrdenBean.setIdLog(xIdLogMax);
        colaboraDctoOrdenBean.setIdTipoOrden(xIdTipoOrdenCruce);
        ...
        dctoBean.setVrCostoMV(xVrCosto);
        dctoBean.setEstadoDcto((int) xVrCero);
        dctoBean.setIdLocalAdicional(xIdLocalCruce);
        dctoBean.setIdPeriodo((int) xVrCero);
        dctoBean.setNombreTercero(xNombreTercero);
        dctoBean.setIdVendedor(xIdVendedor);
        dctoBean.setVrImpoconsumo(xVrImpoconsumo);
        ...
        // actualizaInventarioEstado
        procesoIventario.actualizaInventarioEstado(xIdLocalCruce,
                xIdTipoOrdenCruce,
                xIdOrdenMax);
