...
public class ProcesoGuardaPluOrden {
  ...
  //
  public int guardaTraslado(int xIdLog,
                    String xIdPlu,
                    double xCantidad,
                    double xVrVentaUnitario,
                    int    xItemPadre,
         ...
         // dctoOrdenDetalleBean.setIdEstadoRefOriginal(idEstadoRefOriginal);
          ...
          dctoOrdenDetalleBean.setVrCostoIND(fachadaPluBean.getVrCostoIND() -
                                             fachadaPluBean.getVrImpoconsumo());
          dctoOrdenDetalleBean.setVrCostoResurtido(xSubtotal);
          dctoOrdenDetalleBean.setCantidad(xCantidad);
          dctoOrdenDetalleBean.setCantidadPedida(xCantidad);
          ...
          if(xCantidad==0){
              ...
              dctoOrdenDetalleBean.setVrCostoIND(xSubtotal/xCantidad);
              dctoOrdenDetalleBean.setVrCosto(
                    (xSubtotal*(1+(fachadaPluBean.getPorcentajeIva()/100)))
                                                                /xCantidad);
          }
