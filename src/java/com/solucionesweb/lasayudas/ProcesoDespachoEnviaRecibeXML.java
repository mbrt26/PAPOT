...
import com.solucionesweb.losbeans.negocio.DctoOrdenDetalleDespachoTx;

//
public class ProcesoDespachoEnviaRecibeXML extends Thread {
    ...
    //
    public ProcesoDespachoEnviaRecibeXML(String xPagina,
                                         Double xIdUsuario,
                                         int xIdLocalOrigen) {
       ...
       this.idLocalOrigen = xIdLocalOrigen;
    ...
    public void run() {
        ...
        //
        DctoOrdenDetalleDespachoTx  dctoOrdenDetalleDespachoTx
                                             = new DctoOrdenDetalleDespachoTx();
        ...
        try {
            ...
            XmlParser parser = new XmlParser(xmlReader);
               ...
               try {
                    ...
                    //
                    dctoOrdenDetalleDespachoTx.traverse_DctoOrdenDetalleDespachoTx(parser,
                                                                                   "",
                                                                                   getIdUsuario(),
                                                                                   getIdLocalOrigen());
