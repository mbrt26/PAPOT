...
public class ProcesoIngresoNotaComprobante {

  // Metodo contructor por defecto, es decir, sin parametros
  public ProcesoIngresoNotaComprobante () { }
  ...
  public DctoBean ingresa(int xIdLocal,
                          ...
                          int xIdAlcance,
                          int xIndicador,
                          String xIdOrdenCruce)  {

  System.out.println(""+xIdLog+" "+xIdTipoOrdenNew+" "+xIdTipoOrdenOld +" "+xIdAlcance+" "+xIndicador+" "+xIdOrdenCruce);

   
      int xIdTipoOrdenCruce = xIdTipoOrdenNew;
      ...
      dctoOrdenBean.setFechaOrden(xFechaCorte);
      ...
      dctoOrdenBean.setObservacion(xDescripcion);
      ...
      //
      int xIdDctoMax                =
                                dctoBean.maximoDctoLocalAlcance(xIdAlcance) + 1;
      ...
      dctoBean.setIndicador(xIndicador);
      dctoBean.setFechaDcto(xFechaCorte);
      ...
      dctoBean.setFechaDctoNitCC(xFechaCorte);
      ...
      dctoBean.setIdOrdenCruce(xIdOrdenCruce);
