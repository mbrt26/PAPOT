...
public class ProcesoPagoNota {

    // Metodo contructor por defecto, es decir, sin parametros
    public ProcesoPagoNota() { }
    ...
    public void confirma(DctoBean dctoBean,
        ...
        //
        int xIdTipoOrdenNota       = dctoBean.getIdTipoOrden();
        ...
        pagoBean.setIdTipoOrden(xIdTipoOrdenNota);
        ...
        pagoBean.setIdVendedor(dctoBean.getIdVendedor());
        ...
        pagoMedioBean.setIdTipoOrden(xIdTipoOrdenNota);
