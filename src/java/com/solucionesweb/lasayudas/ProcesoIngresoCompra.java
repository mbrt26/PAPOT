...
public class ProcesoIngresoCompra {

  // Metodo contructor por defecto, es decir, sin parametros
  public ProcesoIngresoCompra () { }
  ...
  public DctoBean ingresa(int xIdLocal,
      ...
      colaboraDctoOrdenBean.setIdLog(xIdLog);
      colaboraDctoOrdenBean.setIdTipoOrden(xIdTipoOrdenOld);

      //
      fachadaBeanDcto                  = colaboraDctoOrdenBean.liquidaLog();

      //
      double xVrVentaSinIva            = xVrBase;
      double xVrCosto                  = fachadaBeanDcto.getVrCosto();
      ...
      dctoBean.setIndicador(xIndicador);
      dctoBean.setFechaDcto(xFechaDctoNitCC);
      dctoBean.setIdDcto(xIdDctoMax);
      dctoBean.setVrBase(xVrVentaSinIva);
      dctoBean.setVrPago(0);
      dctoBean.setEstado(1);
      dctoBean.setVrIva(xVrIva);
      dctoBean.setIdTipoNegocio(2);
      dctoBean.setVrRteFuente(xVrRteFuente);
      dctoBean.setVrDescuento(xVrDescuento);
      ...
      dctoBean.setIdDctoNitCC(xIdDctoNitCC);
      dctoBean.setFechaDctoNitCC(xFechaDctoNitCC);
      ...
      //
      pluBean.actualizaCosto(xIdLocal, xIdTipoOrdenNew, xIdLog);
