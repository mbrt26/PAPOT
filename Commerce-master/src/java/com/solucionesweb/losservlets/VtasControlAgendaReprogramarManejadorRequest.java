...
*/
public class VtasControlAgendaReprogramarManejadorRequest implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlAgendaReprogramarManejadorRequest () { }
  ...
  {
    return "/jsp/vtaContenedorAgendaReprogramar.jsp";
  }
}