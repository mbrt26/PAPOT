...
/**
 * Reportes ventas x costo /
 * vtaContenedorRepVentaCosto.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepVentaCostoManejadorRequest
  ...
  /**
     ...
     */
  public VtasAdmRepVentaCostoManejadorRequest (){ }
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("Consultar") == 0 ) {
           ...
           if (xIdDestinacion.compareTo("Archivo")==0) {
              ...
              //
              return "/jsp/vtaFrmLstRepVentaCostoArchivo.jsp";

           }

           //
           return "/jsp/vtaFrmLstRepVentaCosto.jsp";
