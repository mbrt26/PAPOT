...
public class GeneraPdfPluDesctoFact implements GralManejadorRequest {
...
//
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPdfPluDesctoFact.class.getName()).log(Level.SEVERE, null, ex);
