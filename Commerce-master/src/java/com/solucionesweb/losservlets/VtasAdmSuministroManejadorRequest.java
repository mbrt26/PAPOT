...
/**
 * Esta interfaz permite crear órdenes de compra de suministros, que son 
 * considerados como otros gastos. /
 * vtaContenedorSuministro.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
// 
public class VtasAdmSuministroManejadorRequest implements GralManejadorRequest {
    ...
    public VtasAdmSuministroManejadorRequest() {
    }
    /**
     * BUTTON PARAMETER--
     *  "#Dias Historia"-ingreso de numero de dias /
     * "Fecha Corte"-Fecha corte /
     * "#Dias Inventario"-Ingreso numero de dias de inventario /
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Confirmar") == 0) {
                ...
                //
                return "/jsp/vtaFrmLegSuministro.jsp";
            ...
            if (accionContenedor.compareTo("Iniciar") == 0) {
                ...
                //
                return "/jsp/vtaContenedorSuministro.jsp";
            ...
            if (accionContenedor.compareTo("+Productos") == 0) {
                ...
                //
                return "/jsp/vtaFrmAdiSuministro.jsp";
            ...
            if (accionContenedor.compareTo("O.T.") == 0) {
                ...
                //---
                ProcesoGuardaSuministro procesoGuardaSuministro
                                                = new ProcesoGuardaSuministro();
            ...
            if (accionContenedor.compareTo("Listar") == 0) {
                ...
                //
                return "/jsp/vtaFrmConSuministro.jsp";
            ...
            if (accionContenedor.compareTo("Traer") == 0) {
                ...
                //
                return "/jsp/vtaFrmLstSuministro.jsp";
            ...
            if ((accionContenedor.compareTo("Elaborar") == 0)
                ...
                //
                return "/jsp/vtaFrmIngSuministro.jsp";
