...
*/
public class VtasControlAgendaCargarManejadorRequest implements GralManejadorRequest
{

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlAgendaCargarManejadorRequest () { }
  ...
  {
    return "/jsp/vtaContenedorAgendaCargar.jsp";
  }
}