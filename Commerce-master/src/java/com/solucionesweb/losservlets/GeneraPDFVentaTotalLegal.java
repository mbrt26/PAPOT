...
public class GeneraPDFVentaTotalLegal implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        String reportName =
          "c:\\proyectoWeb\\Commerce\\web\\WEB-INF\\reports\\VtasRepVentaTotalLegal";
        ...
        //
        fachadaDctoBean  = colaboraDctoBean.listaTotalAllFCH(
        ...
        //
        pars.put("p_vrBaseTotal", fachadaDctoBean.getVrBase());
        pars.put("p_vrIvaTotal",fachadaDctoBean.getVrIva());
        ...
        Collection lista = colaboraDctoBean.listaVentaTotal(
                                            getFechaInicialSqlServer(),
                                            getFechaFinalSqlServer(),
                                            "9,29",
                                            "1,2");
