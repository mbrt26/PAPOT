...
public class GeneraPdfComisionSenior implements GralManejadorRequest {
    ...
    public GeneraPdfComisionSenior() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        colaboraLucro.setDiasPlazo(getDiasPlazo());
        colaboraLucro.setPorcentajeComision(getPorcentajeComision());
        colaboraLucro.setDiasExcluidos(getDiasExcluidos());
        colaboraLucro.setPorcentajeSancion(getPorcentajeSancion());
        ...
        if (this.getIdVendedor()>0) {
           ...
           //
           lista = colaboraLucro.listaComisionSeniorUn();
           ...
           //
           lista = colaboraLucro.listaComisionSenior();
