...
/**
 * El reporte muestra tiempo perdido P.O.T en el rango de fechas seleccionadas,
 * la operación, operario responsable, cantidad de minutos perdidos, la máquina y la causa./
 * vtaContenedorRepPotTiempoPerdido.jsp/
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepPotTiempoPerdidoManejadorRequest
     ...
     */
    public VtasAdmRepPotTiempoPerdidoManejadorRequest() { }
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstRepPotTiempoPerdidoArchivo.jsp";

                } else {

                    //
                    return "/jsp/vtaFrmLstRepPotTiempoPerdido.jsp";
                }
            }
        }
