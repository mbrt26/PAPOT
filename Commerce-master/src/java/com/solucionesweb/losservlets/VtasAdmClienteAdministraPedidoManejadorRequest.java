...
public class VtasAdmClienteAdministraPedidoManejadorRequest implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmClienteAdministraPedidoManejadorRequest () { }
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("Consultar") == 0 ) {
           ...
           if (fachadaAgendaLogVisitaBean.getIdCliente()==null) {
               return "/jsp/vtaContenedorClienteSeleccionar.jsp";
           }
           ...
           // Aqui escribe el Bean de Validacion en el Request para manejar el error
           request.setAttribute("fachadaColaboraLogisticaBean",fachadaColaboraLogisticaBean);
           return "/jsp/vtaFrmLstClienteAdministraPedido.jsp";
	    ...
	    if (accionContenedor.compareTo("Seleccionar") == 0 ) {
    	   ...
    	   fachadaAgendaLogVisitaBean.setIdCliente(fachadaDctoOrdenBean.getIdCliente());
    	   fachadaAgendaLogVisitaBean.setIdLog(fachadaDctoOrdenBean.getIdLog());
           fachadaAgendaLogVisitaBean.setIdUsuario(fachadaDctoOrdenBean.getIdUsuario());
           ...
           return "/jsp/vtaFrmConClientePedido.jsp";
        }
