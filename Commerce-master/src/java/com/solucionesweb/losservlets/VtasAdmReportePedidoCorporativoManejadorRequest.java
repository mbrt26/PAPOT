...
public class VtasAdmReportePedidoCorporativoManejadorRequest implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmReportePedidoCorporativoManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("Consultar") == 0 ) {
           ...
           campoAValidar.setPaginaRetorno("/jsp/vtaContenedorReportePedidoCorporativo.jsp");
           ...
           if (idDestinacion.compareTo("Pantalla")==0){
               return "/jsp/vtaFrmLstReportePedidoCorporativo.jsp";
           } else {
               return "/jsp/vtaFrmLstReportePedidoCorporativoArchivo.jsp";
          }
        }
    }

    return "/mnuControlPedidoBB.jsp";
