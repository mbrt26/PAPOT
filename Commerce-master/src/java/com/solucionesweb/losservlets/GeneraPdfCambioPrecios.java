...
public class GeneraPdfCambioPrecios implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPdfCambioPrecios.class.getName()).log(Level.SEVERE, null, ex);
