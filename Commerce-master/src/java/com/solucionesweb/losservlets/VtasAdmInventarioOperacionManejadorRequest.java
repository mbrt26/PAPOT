...
public class VtasAdmInventarioOperacionManejadorRequest
        implements GralManejadorRequest {

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasAdmInventarioOperacionManejadorRequest() {
    }
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                fachadaDctoOrdenBean.setIdTipoOrden(xIdTipoOrdenPedido);
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstInventarioOperacionArchivo.jsp";

                }

                //
                return "/jsp/vtaFrmLstInventarioOperacion.jsp";
