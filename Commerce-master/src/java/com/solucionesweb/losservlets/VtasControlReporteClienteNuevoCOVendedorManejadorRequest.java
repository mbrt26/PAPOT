...
*/
public class VtasControlReporteClienteNuevoCOVendedorManejadorRequest
                             implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlReporteClienteNuevoCOVendedorManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    //
    return "/jsp/vtaContenedorReporteClienteNuevoCOVendedor.jsp";
