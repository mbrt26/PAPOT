...
public class VtasAdmRepInventarioMPMaquinaManejadorRequest
        implements GralManejadorRequest {

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasAdmRepInventarioMPMaquinaManejadorRequest() {
    }
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstInventarioMPMaquinaArchivo.jsp";

                }

                //
                return "/jsp/vtaFrmLstInventarioMPMaquina.jsp";
