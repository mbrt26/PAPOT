...
public class GeneraPdfPluVendosSinInvt implements GralManejadorRequest {
...
//
    ...
    public GeneraPdfPluVendosSinInvt() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPdfPluVendosSinInvt.class.getName()).log(Level.SEVERE, null, ex);
