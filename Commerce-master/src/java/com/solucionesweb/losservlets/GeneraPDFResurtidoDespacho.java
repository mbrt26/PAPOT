...
public class GeneraPDFResurtidoDespacho implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        pars.put("p_fechaOrden", "FEC.FACTURA " +
        ...
        colaboraOrdenVentaBean.setIdOrden(geIdOrden());
        colaboraOrdenVentaBean.setIdTipoOrden(getIdTipoOrden());
        colaboraOrdenVentaBean.setIdOrdenOrigen(getIdOrdenOrigen());

        //
        JRBeanCollectionDataSource dataSource;

        //1-Llenar el datasource con la informacion de la base de datos
        Collection lista = colaboraOrdenVentaBean.detallaUnPedidoOrdenOrigen();
