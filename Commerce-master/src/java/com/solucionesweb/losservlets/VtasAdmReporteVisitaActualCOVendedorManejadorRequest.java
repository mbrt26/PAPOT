...
public class VtasAdmReporteVisitaActualCOVendedorManejadorRequest implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmReporteVisitaActualCOVendedorManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("Consultar") == 0 ) {
           ...
           campoAValidar.setPaginaRetorno("/jsp/ControlTrafico/vtaContenedorReporteVisitaCOVendedor.jsp");
           ...
           if (idDestinacion.compareTo("Pantalla") == 0 ){
              return "/jsp/vtaFrmLstReporteVisitaActualCOVendedor.jsp";
           } else {
              return "/jsp/vtaFrmLstReporteVisitaActualCOVendedorArchivo.jsp";
          }
        }
    }
