...
/**
 * Donde se lista los documentos de los ajustes negativos hechos en el sistema. /
 * vtaContenedorRepNegativo.jsp /
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */

public class VtasAdmRepAjusteNegativoManejadorRequest
                                              implements GralManejadorRequest {
    /**
     * BUTTON--
     * ("Consultar")-Permite Consultar una referencia/
     * ("Salir")-Retorna al menu principal /
     * 
     *  Metodo contructor por defecto, es decir, sin parametros /
     */

    public VtasAdmRepAjusteNegativoManejadorRequest() {
    }
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        if (accionContenedor != null) {
            ...
            fachadaDctoBean.setIdTipoOrden(xIdTipoOrden);
                ...
                //
                generaPdfAjuste.setTituloReporte("REPORTE AJUSTE NEGATIVO");
