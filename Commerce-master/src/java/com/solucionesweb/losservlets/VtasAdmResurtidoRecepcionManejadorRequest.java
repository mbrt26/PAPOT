...
/**
 * Esta ventana permite elaborar órdenes de compra por la persona que se encuentra en bodega,
 * donde permite que el inventario ingrese, pero no ingresa costos, ni valores unitarios de
 * los productos a diferencia de Legaliza Compra /
 * vtaContenedorResurtidoRecepcion.jsp/
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
// 
public class VtasAdmResurtidoRecepcionManejadorRequest
                                               implements GralManejadorRequest {
    /**
     * BUTTON--
     * ("Regresar")-Retorna al menu principal /
     * ("Traer")-permite traer una lista de resurtido /
     * 
     * Metodo contructor por defecto, es decir, sin parametros /
     */

    public VtasAdmResurtidoRecepcionManejadorRequest() { }

     /**
     * BUTTON PARAMETER--
     * "Proveedor"-selecciona proveedor /
     * "Cantidad recibidad"-Ingreso de cantidad producto recibido /
     * "Nombre Referencia"-Ingreso nombrede producto /
     * "Fecha Recibo"-Ingreso de fecha de recibo /
     * "Fecha Factura Remision"-Ingreso de fecha remision /
     * "#Factura-#Remision"-ingreso de numero de factura o remision /
     */
        ...
        if (accionContenedor != null) {
	        ...
	        if (accionContenedor.compareTo("Confirmar") == 0 )  {
               ...
               for (int indice=0;indice<xIdPluArr.length;indice++){
                   ...
                   //
                   if (xCantidadPedidaArr[indice].length()==0) continue;
                   ...
                   //
                   if (xCostoPedidoArr[indice].length()==0) continue;
	        ...
	        if (accionContenedor.compareTo("retira") == 0 )  {
               ...
               //
               return "/jsp/vtaFrmLegResurtidoRecepcion.jsp";
            }
            ...
            if (accionContenedor.compareTo("Imprimir") == 0) {
                ...
                //
                GeneraPDFResurtidoCompraSolicitado
                              generaPDFResurtidoSolicitado =
            ...
            if (accionContenedor.compareTo("Legalizar") == 0) {
                ...
                String xVrSubtotal = "0.0";
                String xPorcentajeIva = "0.0";
                String xVrIvaResurtidoStr = "0.0";
                String xVrImpoconsumoStr = "0.0";

                //--------------------------------------------------------------
                String xVrBase            = "0.0";
                String xVrImpoconsumo     = "0.0";
                String xVrDescuento       = "0.0";
                String xVrIva             = "0.0";
                String xVrRteFuente       = "0.0";
                ...
                for (int indice = 0; indice < xCantidadArr.length; indice++) {
                    ...
                    dctoOrdenDetalleBean.setVrCostoResurtido(xVrCero);
                    dctoOrdenDetalleBean.setVrIvaResurtido(xVrCero);
                    dctoOrdenDetalleBean.setVrImpoconsumo(xVrCero);
                    dctoOrdenDetalleBean.setPorcentajeIva(xVrCero);

                    //---
                    double xVrIvaResurtido    = 0.0;
                ...
                // confirmaPedido
                ProcesoIngresoParcialCompra proceso
                                          = new ProcesoIngresoParcialCompra();

                //
                fachadaDctoBean = proceso.ingresaRecepcion(
                ...
                generaPDF.setTituloReporte("INFORME RECEPCION");
                generaPDF.setReporteName("RepEmpresaResurtidoRecepcionLegalizado");
            ...
            /*
            if (accionContenedor.compareTo("LegalizarOLD") == 0) {
                ...
                // confirmaPedido
                ProcesoIngresoResurtidoCompra proceso
                                          = new ProcesoIngresoResurtidoCompra();
            ...
            if (accionContenedor.compareTo("Traer") == 0) {
                ...
                //
                return "/jsp/vtaFrmLstResurtidoRecepcion.jsp";
