...
public class VtasControlRepCierreCuadreCajaManejadorRequest
                                               implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlRepCierreCuadreCajaManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,
    ...
    if ((xIdNivel == xNivelConIndicador51)
                        ...
                        || (xIdNivel == xNivelConIndicador13)) {

                    //
                    return "/jsp/vtaContenedorCierreCuadreCajaIndicador.jsp";

                } else {

                    //
                    return "/jsp/vtaContenedorCierreCuadreCaja.jsp";
