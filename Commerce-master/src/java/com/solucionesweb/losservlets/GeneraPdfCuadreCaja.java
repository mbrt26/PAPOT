...
public class GeneraPdfCuadreCaja implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        pars.put("p_saldoInicial",getSaldoInicial());
    ...
    public void setSaldoInicial(String saldoInicialStr) {
        this.saldoInicial =  new Double(saldoInicialStr).doubleValue();
    }
}
