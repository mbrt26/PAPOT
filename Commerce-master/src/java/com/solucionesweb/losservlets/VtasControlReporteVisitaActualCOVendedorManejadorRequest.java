...
*/
public class VtasControlReporteVisitaActualCOVendedorManejadorRequest
                             implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlReporteVisitaActualCOVendedorManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    //
    return "/jsp/vtaContenedorReporteVisitaActualCOVendedor.jsp";
