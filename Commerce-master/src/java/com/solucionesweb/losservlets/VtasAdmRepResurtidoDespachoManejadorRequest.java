...
public class VtasAdmRepResurtidoDespachoManejadorRequest
        implements GralManejadorRequest {

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasAdmRepResurtidoDespachoManejadorRequest() {
    }
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                //
                String xIdTipoOrdenCadena = "5,25";
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstRepAllResurtidoDespachoArchivo.jsp";
                ...
                //
                generaPdfAllResurtido.setTituloReporte("REPORTE RESURTIDO DESPACHO");
                ...
                //
                generaPdfAllResurtido.setIdTipoOrdenINI(5);
                generaPdfAllResurtido.setIdTipoOrdenFIN(25);
