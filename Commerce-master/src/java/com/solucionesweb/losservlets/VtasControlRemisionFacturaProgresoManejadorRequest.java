...
//
public class VtasControlRemisionFacturaProgresoManejadorRequest
        implements GralManejadorRequest {

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasControlRemisionFacturaProgresoManejadorRequest() {
    }
    ...
    public String generaPdf(HttpServletRequest request, HttpServletResponse response)
        ...
        fachadaDctoOrdenBean.setPdfFE(1);
        fachadaDctoOrdenBean.setIdOrden(0);
