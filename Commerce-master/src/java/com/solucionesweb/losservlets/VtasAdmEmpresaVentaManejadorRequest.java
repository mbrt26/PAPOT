...
public class VtasAdmEmpresaVentaManejadorRequest
        implements GralManejadorRequest {

    private Object req;

    // Metodo contructor por defecto, es decir, sin parametros
    public VtasAdmEmpresaVentaManejadorRequest() {
    }
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Finalizar") == 0) {
                ...
                try {
                    ...
                    Logger.getLogger(VtasAdmEmpresaVentaManejadorRequest.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (accionContenedor.compareTo("Confirmar Cantidad") == 0) {
                ...
                if ((xIdNivel == xNivelConIndicador51)
                    ...
                    //
                    return "/jsp/vtaContenedorEmpresaVentaIndicador.jsp";

                } else {

                    //
                    return "/jsp/vtaContenedorEmpresaVenta.jsp";
            ...
            if (accionContenedor.compareTo("modifica") == 0) {
                ...
                //
                return "/jsp/vtaFrmModEmpresaVenta.jsp";
            ...
            if (accionContenedor.compareTo("+Productos") == 0) {
                ...
                return "/jsp/vtaFrmSelEmpresaVenta.jsp";
