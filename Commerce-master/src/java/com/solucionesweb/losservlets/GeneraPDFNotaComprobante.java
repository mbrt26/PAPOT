...
public class GeneraPDFNotaComprobante implements GralManejadorRequest {
    ...
    public GeneraPDFNotaComprobante() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        //
        String xNombreTipoAlcanceEgreso  = "REVERSION EGRESO";
        String xNombreTipoAlcanceIngreso = "REVERSION INGRESO";
        ...
        pars.put("p_observacion", "CONCEPTO " +
                               fachadaTipoOrden.getNombreTipoOrden() +
                               " " +
