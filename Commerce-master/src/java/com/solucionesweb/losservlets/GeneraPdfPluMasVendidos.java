...
public class GeneraPdfPluMasVendidos implements GralManejadorRequest {
...
//
    ...
    public GeneraPdfPluMasVendidos() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPdfPluMasVendidos.class.getName()).log(Level.SEVERE, null, ex);
