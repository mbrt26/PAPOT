...
public class VtasAdmClienteFinalizaPedidoProveedorManejadorRequest
                                               implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmClienteFinalizaPedidoProveedorManejadorRequest () { }
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("CONFIRMAR") == 0 ) {
           ...
           try {
                ...
                Logger.getLogger(VtasAdmClienteFinalizaPedidoProveedorManejadorRequest.class.getName()).log(Level.SEVERE, null, ex);
