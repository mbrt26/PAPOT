...
public class VtasAdmClienteElaboraPedidoManejadorRequest
                                              implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasAdmClienteElaboraPedidoManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,
    ...
    if (accionContenedor != null ) {
	    ...
	    if (accionContenedor.compareTo("ModificarItem") == 0 )  {
	       ...
	       if ( itemStr != null ) {
              ...
              //
              return "/jsp/vtaFrmModClienteElaboraPedido.jsp";
	    ...
	    if (accionContenedor.compareTo("+Productos") == 0 )  {
           ...
           return "/jsp/vtaFrmSelClienteElaboraPedido.jsp";
	...
	if (accionContenedor.compareTo("ModificaDescuento") == 0 )  {
           ...
           //
           return "/jsp/vtaFrmDesClienteElaboraPedido.jsp";
