...
public class GeneraPdfDctoOT implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        pars.put("p_ipServidor",getIpServidor());
        pars.put("p_puerto",getPuertoHttp());
        ...
        colaboraDctoOrdenDetalleBean.setIdTipoOrdenINI(getIdTipoOrdenINI());
        colaboraDctoOrdenDetalleBean.setIdTipoOrdenFIN(getIdTipoOrdenFIN());
        colaboraDctoOrdenDetalleBean.setFechaInicial(getFechaInicial());
        colaboraDctoOrdenDetalleBean.setFechaFinal(getFechaFinal());
        colaboraDctoOrdenDetalleBean.setIndicadorInicial(getIndicadorINI());
        colaboraDctoOrdenDetalleBean.setIndicadorFinal(getIndicadorFIN());

        //
        colaboraDctoOrdenDetalleBean.listaDctoOT();

        //1-Llenar el datasource con la informacion de la base de datos
        Collection lista = colaboraDctoOrdenDetalleBean.listaDctoOT();
    ...
    /**
     * @param puertoHttp the puertoHttp to set
     */
