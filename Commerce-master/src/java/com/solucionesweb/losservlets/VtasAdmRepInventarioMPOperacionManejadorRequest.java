...
/**
 * En el que se muestra el inventario de M.P. (Materia Prima) por operación, donde
 * se puede ver O.T., referencia Cliente, operario, Inventario Cantidad (UN) e Inventario Peso (Kg). /
 * vtaContenedorRepInventarioMPOperacion.jsp/
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepInventarioMPOperacionManejadorRequest
     ...
     */
    public VtasAdmRepInventarioMPOperacionManejadorRequest() {
    }
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstInventarioMPOperacionArchivo.jsp";

                }

                //
                return "/jsp/vtaFrmLstInventarioMPOperacion.jsp";
