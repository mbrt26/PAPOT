...
*/
public class VtasControlReportePedidoCorporativoManejadorRequest
                             implements GralManejadorRequest {

  // Metodo contructor por defecto, es decir, sin parametros
  public VtasControlReportePedidoCorporativoManejadorRequest () { }
  ...
  public String generaPdf(HttpServletRequest request,HttpServletResponse response)
    ...
    //
    return "/jsp/vtaContenedorReportePedidoCorporativo.jsp";
