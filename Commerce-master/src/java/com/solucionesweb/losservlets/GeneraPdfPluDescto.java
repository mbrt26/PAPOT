...
public class GeneraPdfPluDescto implements GralManejadorRequest {
...
//
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPdfPluDescto.class.getName()).log(Level.SEVERE, null, ex);
