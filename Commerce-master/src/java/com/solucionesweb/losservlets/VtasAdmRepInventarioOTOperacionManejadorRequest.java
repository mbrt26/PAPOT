...
/**
 * En el que se muestra el inventario de O.T.(ordenes de trabajo) por Operación, 
 * donde se puede ver O.T., referencia Cliente, cliente, Inventario Peso (Kg) e inventario Cantidad (UN). /
 * vtaContenedorRepInventarioOTOperacion.jsp/
 * 
 * Este servlet implementa la interface GralManejadorRequest /
 */
public class VtasAdmRepInventarioOTOperacionManejadorRequest
     ...
     */
    public VtasAdmRepInventarioOTOperacionManejadorRequest() {
    }
        ...
        if (accionContenedor != null) {
            ...
            if (accionContenedor.compareTo("Consultar") == 0) {
                ...
                if (xIdDestinacion.compareTo("Archivo") == 0) {
                    ...
                    //
                    return "/jsp/vtaFrmLstInventarioOTOperacionArchivo.jsp";

                }

                //
                return "/jsp/vtaFrmLstInventarioOTOperacion.jsp";
