...
public class GeneraPDF_OT implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        pars.put("p_mpLinealAlta", fachadaOTExtrusion.getMpLinealAlta());
        ...
        colaboraOT.setNumeroOrden(fachadaPluFichaENC.getNumeroOrden());
          ...
          String[] tornillosDetalle = colaboraOT.listaExtrusionTornillosMP(getIdMix(), getIdOption());

        int i = 1;
        for (String tornilloMP : tornillosDetalle) {
            pars.put("p_mpOtraRfcia" + i, tornilloMP.trim());
            i++;
        }
        ...
        //TODO: Ratios Tornillos
        List<String> listaFrec = colaboraOT.listaFrecsTornillos(getIdMix(), getIdOption());
        i = 1;
        for (String frec : listaFrec) {
            pars.put("p_FRECT" + i, frec);
            i++;
        ...
        //
        fachadaOTExtrusion
                = colaboraOT.listaExtrusionUnOT_TipoEscala_6_7();

        //
        pars.put("p_mpPigmento", fachadaOTExtrusion.getMpPigmento());
