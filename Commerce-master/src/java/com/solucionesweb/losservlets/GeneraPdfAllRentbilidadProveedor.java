...
public class GeneraPdfAllRentbilidadProveedor implements GralManejadorRequest {
...
//
    ...
    public GeneraPdfAllRentbilidadProveedor() {
    ...
    public String generaPdf(HttpServletRequest request,
        ...
        try {
            ...
            Logger.getLogger(GeneraPdfAllRentbilidadProveedor.class.getName()).log(Level.SEVERE, null, ex);
