...
public class AgendaControlEstadoBean  implements Serializable {
    ...
    public AgendaControlEstadoBean() {
    ...
    public Vector listaEstados() {
      ...
      String selectStr =
        "SELECT tblAgendaControlEstados.estadoRegistro, " +
        "       tblAgendaControlEstados.nombreEstado,   " +
        "       tblAgendaControlEstados.estado          " +
        "FROM tblAgendaControlEstados                   " +
        "ORDER BY tblAgendaControlEstados.estado        " ;
      ...
      try {
        ...
        FachadaAgendaControlEstadoBean fachadaBean;

        while (rs.next()) {

              fachadaBean = new FachadaAgendaControlEstadoBean();
    ...
    // seleccionaUnEstado
    public Vector seleccionaUnEstado() {
      ...
      String selectStr =
        ...
        "       tblAgendaControlEstados.estado          " +
        "FROM tblAgendaControlEstados                   " +
        "WHERE tblAgendaControlEstados.estado   = ( ? ) " ;
