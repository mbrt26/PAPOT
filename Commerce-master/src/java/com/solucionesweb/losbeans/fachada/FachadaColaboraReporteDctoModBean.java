...
public class FachadaColaboraReporteDctoModBean implements IConstantes {
    ...
    private double cantidadFacturado;
    ...
    public String getCantidadFacturadoDf0() {
        return df0.format(getCantidadFacturado());
    }

    public void setCantidadFacturado(double cantidadFacturado) {
