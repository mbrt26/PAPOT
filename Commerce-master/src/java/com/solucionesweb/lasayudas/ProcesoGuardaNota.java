...
public class ProcesoGuardaNota {

  //
  public int guarda(int    xIdLog,
                    String xIdPlu,
                    double xCantidad,
                    double xPesoFacturado,
          ...
          String xIdLista               = "1";
          int   xIdBodega               = 1;
          int   xIdLocalOrigen          = xIdLocalUsuario;
         ...
         // dctoOrdenDetalleBean.setIdEstadoRefOriginal(idEstadoRefOriginal);
          ...
          colaboraDctoOrdenDetalleBean.setIdTipoOrden(xIdTipoOrdenOrigen);
          colaboraDctoOrdenDetalleBean.setIdOrden(xIdOrdenOrigen);
          colaboraDctoOrdenDetalleBean.setItem(xItemPadre);

          //
          fachadaDctoOrdenDetalleBean  =
                                    colaboraDctoOrdenDetalleBean.itemOrdenFCH();
          ...
          dctoOrdenDetalleBean.setPesoFacturado(xPesoFacturado);
