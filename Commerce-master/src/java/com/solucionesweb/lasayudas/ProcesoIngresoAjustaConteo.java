...
public class ProcesoIngresoAjustaConteo {

  // Metodo contructor por defecto, es decir, sin parametros
  public ProcesoIngresoAjustaConteo () { }
  ...
  public DctoBean ingresa(int xIdLocal,
      ...
      // ajustaInventario
      procesoInventario.ajustaInventario(xIdLocal,
                                        xIdTipoOrdenNew,
                                        xIdOrdenMax);
      ...
      // actualizaAjuste
      dctoOrdenDetalleBean.actualizaAjuste(xEstadoInventario);
      ...
      colaboraOrdenDetalleBean.setIdTipoOrden(xIdTipoOrdenNew);
