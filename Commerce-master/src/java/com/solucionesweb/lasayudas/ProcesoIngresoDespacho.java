...
public class ProcesoIngresoDespacho {

  // Metodo contructor por defecto, es decir, sin parametros
  public ProcesoIngresoDespacho () { }
  ...
  public DctoBean ingresa(int xIdLocal,
      ...
      dctoBean.setIdTipoOrden(xidTipoOrdenOriginal);
      dctoBean.setIndicador(xIndicador);
      dctoBean.setIdOrden(xIdOrdenOriginal);
      ...
      int xIdTipoOrdenCruce = fachadaDctoBean.getIdTipoOrden();
      int xIdOrdenCruce = fachadaDctoBean.getIdOrden();
      double xIdDctoCruce = fachadaDctoBean.getIdDcto();

      //
      String xNombreTerceroOrigen = fachadaDctoBean.getNombreTercero();
