...
public class ProcesoInternoInventario {

    // Metodo contructor por defecto, es decir, sin parametros
    public ProcesoInternoInventario() {
    }
    ...
    public DctoBean ingresa(int xIdLocal,
        ...
        int xSignoMovimientoDestino = -1;

        //
        int xIdLocalOrigen = 0;
        int xIdTipoOrdenOrigen = 0;
        int xIdOrdenOrigen = 0;
        ...
        if (xNumeroOrden != 0 ) {
           ...
           //---
           xIdLocalOrigen = fachadaDctoOrdenBean.getIdLocal();
           xIdTipoOrdenOrigen = fachadaDctoOrdenBean.getIdTipoOrden();
           xIdOrdenOrigen = fachadaDctoOrdenBean.getIdOrden();
        ...
        //
        dctoOrdenDetalleBean.ingresaInterno(xIdBodegaDestino,
                xSignoMovimientoDestino);
        ...
        dctoOrdenDetalleBean.setIdPlu(xIdPluProducto);

        //
        dctoOrdenDetalleBean.actualizaOrdenOrigen();
        
        /*
        dctoOrdenDetalleBean.setIdBodega(xIdBodegaDestino);

        //
        dctoOrdenDetalleBean.actualizaOrdenOrigenProducto();*/
