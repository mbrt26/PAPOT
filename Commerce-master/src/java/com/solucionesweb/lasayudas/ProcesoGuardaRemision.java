...
public class ProcesoGuardaRemision {
  ...
  public DctoOrdenDetalleBean guarda(int    xIdLog,
                    ...
                    double xCantidadEntregada,
                    double xPesoEntregado,
         ...
         // dctoOrdenDetalleBean.setIdEstadoRefOriginal(idEstadoRefOriginal);
          ...
          dctoOrdenDetalleBean.setCantidadEntregada(xCantidadEntregada);
          dctoOrdenDetalleBean.setPesoEntregado(xPesoEntregado);
          dctoOrdenDetalleBean.setCantidadFacturada(xCero);
          dctoOrdenDetalleBean.setPesoFacturado(xCero);
