...
public class ListaInventarioMPOperacionTag extends TagSupport
    ...
    //
    int xIdOperacionRetal = 666;
    int xIdOperacionMaterial = 888;
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("nombrePluVar",fachadaPluFicha.getNombrePlu());
        ...
        pageContext.setAttribute("numeroOrdenVar", fachadaPluFicha.getNumeroOrdenSf0());
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        if (getIdOperacion() == xIdOperacionRetal) {

           //
           vectorBean = colaboraOrdenTrabajo.listaMPRetalInv();

        }

        //
        if (getIdOperacion() == xIdOperacionMaterial) {

           //
           vectorBean = colaboraOrdenTrabajo.listaMPMaterial();

        }

        // NO es RETAL y NO es Material
        if ((getIdOperacion() != xIdOperacionRetal) &&
            (getIdOperacion() != xIdOperacionMaterial))  {

           //
           vectorBean = colaboraOrdenTrabajo.listaMPUnOperacion();
