...
public class ListaVentaTag extends TagSupport implements IterationTag {
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("vrImpoconsumoVar",fachada.getVrImpoconsumoDf0());
      ...
      pageContext.setAttribute("horaTxVar",fachada.getHoraTx());

      pageContext.setAttribute("idDctoNitCCVar",fachada.getIdDctoNitCC());
      pageContext.setAttribute("prefijoVar",fachada.getPrefijo());
      pageContext.setAttribute("idCajaVar",fachada.getIdCajaStr());
