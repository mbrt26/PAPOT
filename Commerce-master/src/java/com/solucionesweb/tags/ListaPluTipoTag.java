...
public class ListaPluTipoTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("nombreMaterialVar",
                fachadaPluBean.getNombreMaterial());
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        Vector listaLineaVector = colaboraPlu.listaPluTipo();
