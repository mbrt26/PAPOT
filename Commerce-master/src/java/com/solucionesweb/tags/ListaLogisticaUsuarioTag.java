...
public class ListaLogisticaUsuarioTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("placaVehiculoVar",fachadaColaboraLogisticaBean.getPlacaVehiculo());
      pageContext.setAttribute("fechaLogisticaVar",fachadaColaboraLogisticaBean.getFechaPedido());
	...
	public int doStartTag() throws JspTagException {
        ...
        Vector vectorBean = colaboraLogisticaBean.consultaLogistica();
