...
public class ListaCategoriaSeleccionTag extends TagSupport
	...
	public int doStartTag() throws JspTagException {
        ...
        categoriaBean.setIdCategoria(getIdCategoriaTag());

        //
		Vector vectorBean        = categoriaBean.listaCategoriaSeleccion();
