...
public class ListaFechaTipoOrdenClienteTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idUsuarioVar",
                              fachadaColaboraReporteDctoBean.getIdUsuarioStr());
      ...
      pageContext.setAttribute("fechaOrdenVar",
                                fachadaColaboraReporteDctoBean.getFechaOrden());
