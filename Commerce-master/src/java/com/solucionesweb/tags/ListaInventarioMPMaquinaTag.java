...
public class ListaInventarioMPMaquinaTag extends TagSupport
    ...
    public int doStartTag() throws JspTagException {
        ...
        if (getIdOperacion() == xIdOperacionRetal) {
           ...
           //
           vectorBean = colaboraOrdenTrabajo.listaMPRetalMaquina();
        ...
        if ((getIdOperacion() != xIdOperacionRetal) &&
           ...
           //
           //vectorBean = colaboraOrdenTrabajo.listaMPMaquina_XXX();
