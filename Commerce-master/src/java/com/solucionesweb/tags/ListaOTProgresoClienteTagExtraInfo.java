...
public class ListaOTProgresoClienteTagExtraInfo extends TagExtraInfo {
  public VariableInfo[] getVariableInfo(TagData data) {
    return new VariableInfo[] {
      ...
      new VariableInfo("nombreTerceroVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("cantidadTerminadaStrVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      ...
      new VariableInfo("cantidadFacturadaVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("cantidadPendienteFacturaVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("tipoAlcance", "java.lang.String", true,
                       VariableInfo.NESTED),
    };
  }
}
