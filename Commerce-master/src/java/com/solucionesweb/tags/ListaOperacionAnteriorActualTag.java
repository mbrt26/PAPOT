...
public class ListaOperacionAnteriorActualTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("idOperacionAnteriorVar",
                fachadaJobOperacion.getIdOperacionStr());
        pageContext.setAttribute("nombreOperacionAnteriorVar",
                fachadaJobOperacion.getNombreOperacionAnterior());
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean = jobOperacionBean.listaOperacionAnteriorActual(
                getIdFicha(),
                xIdEscala);
