...
public class ListaAudtoriaRepRentabilidadZonaTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idCiudadVar",fachada.getIdCiudadStr());
      pageContext.setAttribute("zonaVar",fachada.getNombreCiudad());
	...
	public int doStartTag() throws JspTagException {
      ...
      //
        Vector vectorBean =
             colaboraRentabilidad.listaIndicadorRentabilidadZona();
