...
public class ListaCxCDetalleTagExtraInfo extends TagExtraInfo {
  public VariableInfo[] getVariableInfo(TagData data) {
    return new VariableInfo[] {
      ...
      new VariableInfo("nombreTerceroVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("edadFraVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("nombreVendedorVar", "java.lang.String", true,
                       VariableInfo.NESTED),
    };
  }
}