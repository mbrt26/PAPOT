...
public class ListaPluCategoriaTagExtraInfo extends TagExtraInfo {
  public VariableInfo[] getVariableInfo(TagData data) {
    return new VariableInfo[] {
      ...
      new VariableInfo("vrCostoINDDf2Var", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("vrMayoristaDf0Var", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("vrSucursalDf0Var", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("existenciaDf2Var", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("margenVrGeneralVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("margenVrMayoristaVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("margenVrSucursalVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("letraEstiloVar", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("existenciaSf2Var", "java.lang.String", true,
                       VariableInfo.NESTED),
      new VariableInfo("vrExistenciaCostoSf2Var", "java.lang.String", true,
                       VariableInfo.NESTED),
    };
  }
}