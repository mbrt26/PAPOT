...
public class ListaAudtoriaRepRentabilidadListaPrecioTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idListaPrecioVar",fachada.getIdListaPrecioStr());
     pageContext.setAttribute("idLocalVar",fachada.getIdLocalStr());
      ...
      pageContext.setAttribute("vrPagoVar",fachada.getVrPagoStr());
	...
	public int doStartTag() throws JspTagException {
      ...
      //
        Vector vectorBean =
             colaboraRentabilidad.listaIndicadorRentabilidadListaPrecio();
