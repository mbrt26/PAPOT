...
public class ListaUsuarioDefectoOpcionTag extends TagSupport
                             implements IterationTag {

    //
    private String idClienteTag;
    private int    idLocalUsuarioTag;
    ...
    public String getIdClienteTag()
    {
     ...
     public void setIdLocalUsuarioTag( int idLocalUsuarioTag )
    {
        this.idLocalUsuarioTag = idLocalUsuarioTag ;
    }

    public int getIdLocalUsuarioTag()
    {
	...
	usuarioBean = new UsuarioBean();
        ...
        //
	Vector listaVector = usuarioBean.listaUsuarioPorDefecto(getIdClienteTag(),
                                                                getIdNivelTag());
