...
//
public class ListaSuministroTag
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("itemOrdenVar",fachada.getItemOrdenSf0());
        pageContext.setAttribute("idOperacionVar",fachada.getIdOperacionSf0());
