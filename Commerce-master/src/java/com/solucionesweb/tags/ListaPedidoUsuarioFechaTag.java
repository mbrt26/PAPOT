...
public class ListaPedidoUsuarioFechaTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      String numeroCotizacionVar  = fachadaDctoOrdenBean.getStrNumeroCotizacion();

      // listaUnaSucursal
      colaboraAgendaControlBean.setIdCliente(idCliente);
      colaboraAgendaControlBean.setIdSucursal(strIdSucursal);
      ...
      pageContext.setAttribute("idEstadoTx", fachadaColaboraDctoOrdenBean.getIdEstadoTxStr());
      pageContext.setAttribute("nombreEstadoTxVar", fachadaColaboraDctoOrdenBean.getNombreEstado() );
	...
	public int doStartTag() throws JspTagException {
		...
		//
        Vector vectorBean = colaboraDctoOrdenBean.listaAllPedidoUsuarioFecha();
