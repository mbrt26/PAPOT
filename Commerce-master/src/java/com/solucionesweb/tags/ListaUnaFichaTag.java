...
public class ListaUnaFichaTag
    ...
    private String referenciaClienteTag;

    public String getReferenciaClienteTag() {
        return referenciaClienteTag;
    }

    public void setReferenciaClienteTag(String referenciaClienteTag) {
        this.referenciaClienteTag = referenciaClienteTag;
    }
    ...
    public int doStartTag() throws JspTagException {
        ...
        colaboraOrdenTrabajo.setReferenciaCliente(getReferenciaClienteTag());
