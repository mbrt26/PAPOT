...
public class ListaContableDctoTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("vrDebitoVar",
                                fachadaTipoOrdenSubcuenta.getVrDebitoSf0());
      pageContext.setAttribute("vrCreditoVar",
                                fachadaTipoOrdenSubcuenta.getVrCreditoSf0());
      pageContext.setAttribute("vrDiferenciaVar",
                                fachadaTipoOrdenSubcuenta.getVrDiferenciaStr());
      pageContext.setAttribute("fechaDctoVar",
                                fachadaTipoOrdenSubcuenta.getFechaDctoCorta());
      pageContext.setAttribute("idClienteVar",
                                fachadaTipoOrdenSubcuenta.getIdCliente());
      pageContext.setAttribute("idReciboVar",
                                fachadaTipoOrdenSubcuenta.getIdReciboStr());
	...
	public int doStartTag() throws JspTagException {
        ...
        //
	Vector vectorBean = colaboraContable.listaDcto();
