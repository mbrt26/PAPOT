...
public class ListaResurtidoLocalTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      //
      fachadaBean = (FachadaColaboraDctoOrdenBean)iteratorBean.next();

      // Variable que retornan al JSP
      pageContext.setAttribute("idLogVar",fachadaBean.getIdLogStr());
      pageContext.setAttribute("fechaOrdenVar",
                                              fachadaBean.getFechaOrdenCorta());
      pageContext.setAttribute("idLocalVar",fachadaBean.getIdLocalStr());
      pageContext.setAttribute("nombreLocalVar",fachadaBean.getNombreLocal());
      pageContext.setAttribute("cantidadArticulosVar",
                                         fachadaBean.getCantidadArticulosStr());
	...
	public int doStartTag() throws JspTagException {
        ...
        //
	Vector vectorBean    = colaboraDctoOrdenBean.listaResurtidoLocal();
