...
public class ListaFechaVisitaVendedorTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idUsuarioVar",fachadaColaboraReporteLogBean.getIdUsuarioStr());
      pageContext.setAttribute("fechaVisitaVar",fachadaColaboraReporteLogBean.getFechaVisita());
	}
	...
	public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean = colaboraReporteLogBean.listaFechasVendedor();
