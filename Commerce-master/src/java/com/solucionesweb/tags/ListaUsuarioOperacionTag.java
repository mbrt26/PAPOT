...
public class ListaUsuarioOperacionTag extends TagSupport
    ...
    {
        return new Integer(getIdOperacionTag());
    }
	...
	public int doStartTag() throws JspTagException {
        ...
        //
        usuarioBean.setIdLocalUsuario(getIdLocalTag());

        //
        Vector vectorBean    = usuarioBean.listaUsuarioOperacion(
                                                              getIdOperacion());
