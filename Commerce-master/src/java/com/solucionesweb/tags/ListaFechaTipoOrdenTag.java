...
public class ListaFechaTipoOrdenTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idUsuarioVar",fachadaColaboraReporteDctoBean.getIdUsuarioStr());
      pageContext.setAttribute("idTipoOrdenVar",fachadaColaboraReporteDctoBean.getIdTipoOrdenStr());
      pageContext.setAttribute("fechaOrdenVar",fachadaColaboraReporteDctoBean.getFechaOrden());
	...
	public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean = colaboraReporteDctoBean.listaFechasRuta(idRuta);
