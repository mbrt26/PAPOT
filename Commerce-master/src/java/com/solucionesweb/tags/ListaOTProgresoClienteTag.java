...
public class ListaOTProgresoClienteTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("cantidadTerminadaStrVar",
        ...
        pageContext.setAttribute("cantidadFacturadaVar",
                fachadaDctoOrdenProgreso.getCantidadFacturadaDf0());
        pageContext.setAttribute("cantidadPendienteFacturaVar",
                fachadaDctoOrdenProgreso.getCantidadPendienteFacturaSf0());
        pageContext.setAttribute("tipoAlcance",
                String.valueOf(fachadaDctoOrdenProgreso.getIdControl()));
    ...
    public int doStartTag() throws JspTagException {
        ...
        if (getIdOperacion() == 0) {
           ...
           //
           if (( getIdClienteTag() == null ) ||
                                 ( getIdClienteTag().compareTo("00") == 0 ))  {
               ...
               //
               vectorBean=
                  colaboraOrdenProgreso.listaOTAllOperacionCliente(
                                                            getIdTipoTercero());
           }
        }*/
        ...
        if (getIdOperacion() > 0) {
           ...
           if (( getIdClienteTag() == null ) ||
               ...
               //
               vectorBean=
                  colaboraOrdenProgreso.listaOTUnOperacionCliente(
                                                            getIdTipoTercero());
           }
        }
