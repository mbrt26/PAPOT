...
public class ListaOperacionTouchTag extends TagSupport
    ...
    private void inicializarVariablesDeRetorno() {
        ...
        pageContext.setAttribute("idColorVar",
                fachadaJobOperacion.getIdColor());
    ...
    public int doStartTag() throws JspTagException {
        ...
        //
        Vector vectorBean = jobOperacionBean.listaOperacionTouch();
