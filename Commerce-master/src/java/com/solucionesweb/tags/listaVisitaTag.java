...
public class listaVisitaTag extends TagSupport
                                     implements IterationTag {

    // Variable que recibe del JSP
    private String idUsuarioTag;
    private String fechaInicialVisitaTag;
    private String fechaFinalVisitaTag;
    ...
    public void setFechaInicialVisitaTag( String fechaInicialVisitaTag )
    {
        this.fechaInicialVisitaTag = fechaInicialVisitaTag ;
    }

    public String getFechaInicialVisitaTag()
    {
        return fechaInicialVisitaTag;
    }
    ...
    public void setFechaFinalVisitaTag( String fechaFinalVisitaTag )
    {
        this.fechaFinalVisitaTag = fechaFinalVisitaTag ;
    }

    public String getFechaFinalVisitaTag()
    {
        return fechaFinalVisitaTag;
    }
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      nombreEstadoVar    = fachadaAgendaBean.getNombreEstado();
      ...
      pageContext.setAttribute("nombreEstadoVar",nombreEstadoVar);
	...
	public int doStartTag() throws JspTagException {
        ...
        agendaBean.setIdUsuario(getIdUsuarioTag());


		Vector vectorBean    = agendaBean.listaVisita(getFechaInicialVisitaTag() ,
                                                     getFechaFinalVisitaTag());
