...
public class ListaLogVisitaVendedorTag extends TagSupport
	...
	// Variable para usar el bean de ColaboraReporteLogBean
    ...
    private void inicializarVariablesDeRetorno() {
      ...
      pageContext.setAttribute("idEstadoVisitaVar",fachadaColaboraAgendaLogVisitaBean.getIdEstadoVisitaStr());
      pageContext.setAttribute("nombreEstadoVar",fachadaColaboraAgendaLogVisitaBean.getNombreEstado());
      pageContext.setAttribute("horaVisitaVar",fachadaColaboraAgendaLogVisitaBean.getHoraVisita());
	...
	public int doStartTag() throws JspTagException {
		...
		colaboraAgendaLogVisitaBean.setIdUsuario(getIdUsuarioTag());
        colaboraAgendaLogVisitaBean.setFechaVisita(getFechaVisitaTag());

        //
        Vector vectorBean = colaboraAgendaLogVisitaBean.listaVisitaVendedor();
