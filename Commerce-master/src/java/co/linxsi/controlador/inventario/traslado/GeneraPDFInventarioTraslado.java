...
public class GeneraPDFInventarioTraslado implements GralManejadorRequest {
    ...
    public GeneraPDFInventarioTraslado() {
    ...
    public String generaPdf(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            try {
                ...
                Logger.getLogger(GeneraPDFInventarioTraslado.class.getName()).log(Level.SEVERE, null, ex);
