 ...
 */
package co.linxsi.controlador.compras.orden_compra;
 ...
 */
public class Control_Orden_Compra implements GralManejadorRequest{
    ...
    public String generaPdf(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return "vista/compras/orden_compra/ControlOrdenCompra.jsp";
    }
