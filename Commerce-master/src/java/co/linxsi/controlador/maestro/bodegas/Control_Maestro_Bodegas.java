 ...
 */
package co.linxsi.controlador.maestro.bodegas;
 ...
 */
public class Control_Maestro_Bodegas implements GralManejadorRequest {
    ...
    public String generaPdf(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return "vista/maestros/Bodegas/ControlMaestroBodega.jsp";
    }
