<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmConResurtidoCompra.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="10%" align="right" class="letraTitulo">NIT/CC</td>
                ...
                <lst:listaResurtidoAjusteCompra idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="5%" align="right" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmConResurtidoCompra.jsp&accionContenedor=tomar&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrden=<%=idOrdenVar%>"><%=idDctoNitCCVar%></a>
                        </td>
                        <td width="10%" align="right" class="letraDetalle"><%=idTerceroVar%></td>
