...
<html>
<head>
    <title>Reporte Margen Venta Factura</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepMargen.jsp">

        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE MARGEN VENTA FACTURA</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
