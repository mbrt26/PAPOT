...
<html>
<head>
    <title>Reporte Total Ventas Iva</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepVentaIvaTotal.jsp">

        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE TOTAL VENTAS</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
