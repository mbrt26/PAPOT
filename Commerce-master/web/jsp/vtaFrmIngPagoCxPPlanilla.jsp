<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngPagoCxPPlanilla.jsp">
                ...
                <lsu:listaCuentaLocalDetalle idClienteTag="<%=fachadaTerceroBean.getIdCliente()%>"
                    ...
                    <tr>
                        ...
                        <td width="5%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngPagoCxPPlanilla.jsp&accionContenedor=PagoParcial&xIdLocal=<%=fachadaTerceroBean.getIdLocalStr()%>&xIdTipoOrden=<%=idTipoOrdenVar%>&xIndicador=<%=indicadorVar%>&xIdCliente=<%=fachadaTerceroBean.getIdCliente()%>&xIdDcto=<%=idDctoVar%>&xIdVendedor=<%=fachadaPagoBean.getIdVendedorDi0()%>&xFechaPago=<%=fachadaPagoBean.getFechaPagoCorta()%>">Parcial</a>
                        </td>
                        <td width="5%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngPagoCxPPlanilla.jsp&accionContenedor=PagoTotal&xIdLocal=<%=fachadaTerceroBean.getIdLocalStr()%>&xIdTipoOrden=<%=idTipoOrdenVar%>&xIndicador=<%=indicadorVar%>&xIdCliente=<%=fachadaTerceroBean.getIdCliente()%>&xIdDcto=<%=idDctoVar%>&xIdVendedor=<%=fachadaPagoBean.getIdVendedorDi0()%>&xFechaPago=<%=fachadaPagoBean.getFechaPagoCorta()%>">Total</a>
                        </td>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">
                        <input type="submit" value="Cambiar Proveedor" name="accionContenedor">
                    </td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
            </table>
