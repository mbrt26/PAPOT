<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstEmpresaHPedido.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    ...
                    <td width="10%" align="center" class="letraTitulo">#ARTICULOS</td>
                    <td width="20%" align="center" class="letraTitulo">VR.FACTURA</td>
                    <td width="20%" align="center" class="letraTitulo">FRA.ORIGEN</td>
                </tr>   
                <lsu:listaPedidoPeriodoLocal idTipoOrdenCadenaTag = "<%=fachadaColaboraLogisticaBean.getIdTipoOrdenCadena()%>"
                    ...
                    <tr>
                        <%if(dctoDianVar.equals("0")){%>
                        <td width="20%" align="center" class="letraDetalle">
                            <a href="<%=urlDianVar%>" target="_blank"><%=idDctoVar%></a>
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaHPedido.jsp&accionContenedor=detallarCotizacion&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&idOrden=<%=idOrdenVar%>"><%=idDctoVar%></a>
                            <!--a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaHPedido.jsp&accionContenedor=detallarCotizacion&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&idOrden=<%=idOrdenVar%>"><%=idDctoVar%></a-->
                        </td>
                        <%}else{%>
                        <td width="20%" align="center" class="letraDetalle">
                            <a href="<%=urlDianVar%>" target="_blank"><%=dctoDianVar%></a>
       <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaHPedido.jsp&accionContenedor=detallarCotizacion&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&idOrden=<%=idOrdenVar%>"><%=idDctoVar%></a>                 </td>
                        <%}%>
                        ...
                        <td width="10%" align="center" class="letraDetalle"><%=numeroArticuloVar%></td>
                        <td width="20%" align="center" class="letraDetalle"><%=vrFacturaDf0Var%></td>
                        <td width="20%" align="center" class="letraDetalle"><%=idDctoCruceVar%></td>
                    </tr>
