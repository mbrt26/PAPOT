...
<html>
<head>
    <title>Reporte Plu Mas Vendidos</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepPluMasVendidos.jsp">

		<table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE PLU MAS VENDIDOS</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
