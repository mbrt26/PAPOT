<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelCatalogoClienteLocal.jsp">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">LISTA CLIENTE LOCAL(+)</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
            ...
            <tr>
                ...
                <td width="10%" align="left" class="letraDetalle">VENDEDOR</td>
            </tr>
            <lista:seleccionaTerceroxIdTipoTercero nombreTerceroTag="<%=fachadaTerceroBean.getNombreTercero()%>"
                ...
                <tr>
                    <td width="40%" align="left" class="letraDetalle">
                        <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmSelCatalogoClienteLocal.jsp&accionContenedor=trae&xIdTipoTercero=<%=fachadaTerceroBean.getIdTipoTerceroStr()%>&xIdCliente=<%=idClienteVar%>"><%=nombreTerceroVar%></a>
                        </td>
                    ...
                    <td width="10%" align="left" class="letraDetalle"><%=idVendedorVar%></td>
                </tr>
