<html>
    ...
    <head>
        <title>Movimiento Interno Ajuste</title>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngInventarioAjuste.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">MOVIMIENTO INTERNO AJUSTE</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                ...
                <lsv:listaOrden idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="5%"  nowrap align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngInventarioAjuste.jsp&accionContenedor=retira&xItem=<%=itemVar%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xIdTercero=<%=fachadaDctoOrdenBean.getIdCliente()%>&xFechaCorte=<%=fachadaDctoOrdenBean.getFechaOrdenCorta()%>&xIdBodegaOrigen=<%=fachadaDctoOrdenBean.getIdBodegaOrigenStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>">R</a>
                        </td>
                        ...
                        <td width="5%" nowrap align="right" class="letraDetalle"><%=vrVentaSinDsctoDf0Var%></td>
                        <td width="5%" nowrap align="right" class="letraDetalle"><%=porcentajeDsctoVar%></td>
                        ...
                        <td width="15%" nowrap align="right" class="letraDetalle"><%=vrVentaConIvaVar%></td>
                    </tr>
