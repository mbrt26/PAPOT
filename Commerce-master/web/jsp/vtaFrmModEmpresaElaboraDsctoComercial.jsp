<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmModEmpresaElaboraDsctoComercial.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">%DSCTO.PIE FACTURA</td>
                    <td width="33%" align="center" class="letraTitulo">AUTORIZACION</td>
                </tr>
