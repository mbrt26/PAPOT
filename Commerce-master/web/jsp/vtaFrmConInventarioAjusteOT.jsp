...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmConInventarioAjusteOT.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="34%" align="center" class="letraTitulo">LISTA AJUSTE O.T.</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="10%" align="center" class="letraTitulo">C.O.</td>
    ...
    <lst:listaResurtidoAjuste idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmConInventarioAjusteOT.jsp&accionContenedor=tomar&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrden=<%=idOrdenVar%>"><%=idDctoVar%></a>
            </td>
            <td width="10%" align="center" class="letraDetalle"><%=idTerceroVar%></td>
            <td width="10%" align="center" class="letraDetalle"><%=fechaOrdenVar%></td>
            <td width="10%" align="center" class="letraDetalle"><%=nombreLocalVar%></td>
