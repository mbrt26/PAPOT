...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelPagoCxCPlanilla.jsp">
    ...
    <lista:listaEmpresaNombre idTipoTerceroTag = "<%=fachadaTerceroBean.getIdTipoTerceroStr()%>"
        ...
        <tr>
            <td width="10%" align="left" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmSelPagoCxCPlanilla.jsp&accionContenedor=Confirmar&xIdCliente=<%=idClienteSinFormatoVar%>&xIdVendedor=<%=fachadaPagoBean.getIdVendedorDi0()%>&xFechaPago=<%=fachadaPagoBean.getFechaPagoCorta()%>&xIdLocalTercero=<%=idLocalTerceroVar%>"><%=idClienteVar%></a>
            </td>
