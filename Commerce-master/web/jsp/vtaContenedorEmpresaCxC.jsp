<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorEmpresaCxC.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="13%" align="center" class="letraTitulo">#DCTO</td>
                    <td width="12%" align="center" class="letraTitulo">#FE</td>
                ...
                <lsu:listaCuentaLocalDetalle idClienteTag="<%=fachadaTerceroBean.getIdCliente()%>"
                    ...
                    <tr>
                        ...
                        <td width="13%" align="center" class="<%=letraEstiloVar%>"><%=idDctoVar%></td>
                        <td width="12%" align="center" class="<%=letraEstiloVar%>"><%=fe%></td>
                ...
                <lst:listaCuentaLocalTotal idClienteTag="<%=fachadaTerceroBean.getIdCliente()%>"
                                           ...
                                           idLocalTag="<%=fachadaTerceroBean.getIdLocalStr()%>">
                    <tr>
                        <td width="12%" align="left" class="letraDetalle"></td>
                        <td width="13%" align="left" class="letraDetalle">TOTALES </td>
                        <td width="25%" align="right" class="letraDetalle"><%=tipoCarteraVar%></td>
