<html>
    ...
    <head>
        <title>Registra Produccion Externa</title>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngOTExterna.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">REGISTRA PRODUCCION EXTERNA</td>
                    <td width="33%" class="letraResaltadaTituloGrande">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="100%" align="center" class="letraResaltadaTituloGrande">DETALLE SALIDAS</td>
                </tr>
            </table>
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="5%" align="center" class="letraTitulo">#SALIDA</td>
                ...
                <lsw:liquidaSalidaOT idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
                ...
                itemPadreTag="<%=fachadaDctoOrdenBean.getItemPadreStr()%>">
                    ...
                    <tr>
                        <td width="5%" align="center" class="letraDetalle"><%=idControlVar%>
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngOTExterna.jsp&accionContenedor=retiraSalida&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xItem=<%=itemVar%>&xIdOperacion=<%=fachadaDctoOrdenBean.getIdOperacionStr()%>&xItemPadre=<%=fachadaDctoOrdenBean.getItemPadreStr()%>&xIdOrdenCruce=<%=idOrdenCruceVar%>">Retirar</a>
                            <br><a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngOTExterna.jsp&accionContenedor=listaSalida&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xItem=<%=itemVar%>&xIdOperacion=<%=fachadaDctoOrdenBean.getIdOperacionStr()%>&xItemPadre=<%=fachadaDctoOrdenBean.getItemPadreStr()%>&xIdControl=<%=idControlVar%>">Listar</a>                                                        
                        </td>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="100%" align="center" class="letraResaltadaTituloGrande">DETALLE ENTRADAS</td>
                </tr>
            </table>
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="5%" align="center" class="letraTitulo">#ENTRADA</td>
                    <td width="5%" align="left" class="letraTitulo">OPERARIO</td>
                    <td width="5%" align="right" class="letraTitulo">PESO(KG)
                        <br>ENTRADA</td>
                    <td width="5%" align="right" class="letraTitulo">CANTIDAD
                        <br>ENTRADA</td>
                    <td width="5%" align="right" class="letraTitulo">#DCTO
                        <br>TERCERO</td>
                    <td width="5%" align="center" class="letraTitulo">FECHA
                        <br>HORA</td>
                </tr>
                ...
                itemPadreTag="<%=fachadaDctoOrdenBean.getItemPadreStr()%>">
                    ...
                    <tr>
                        <td width="5%" align="center" class="letraDetalle"><%=idControlVar%>
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngOTExterna.jsp&accionContenedor=retira&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xItem=<%=itemVar%>&xIdOperacion=<%=fachadaDctoOrdenBean.getIdOperacionStr()%>&xItemPadre=<%=fachadaDctoOrdenBean.getItemPadreStr()%>&xIdOrdenCruce=<%=idOrdenCruceVar%>">Retirar</a>
                            <br><a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngOTExterna.jsp&accionContenedor=listaEntrada&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xItem=<%=itemVar%>&xIdOperacion=<%=fachadaDctoOrdenBean.getIdOperacionStr()%>&xItemPadre=<%=fachadaDctoOrdenBean.getItemPadreStr()%>&xIdControl=<%=idControlVar%>">Listar</a>                            
                        </td>
                        <td width="5%" align="left" class="letraDetalle"><%=nombreOperarioVar%>
                        </td>
                        <td width="5%" align="right" class="letraDetalle"><%=pesoTerminadoVar%></td>
                ...
                <tr>
                    ...
                    <% }%>  
                    <td width="5%" align="right" class="letraDetalle">
                        <input name="xIdDctoNitCC" size="10" maxlength="10" value="">
                    </td>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">
                        <input type="submit" value="Confirmar Salida" name="accionContenedor">
                    </td>
                    <td width="34%" align="center" class="letraTitulo">
                        <input type="submit" value="Confirmar Entrada" name="accionContenedor">                        
                    </td>
                </tr>
            </table>
