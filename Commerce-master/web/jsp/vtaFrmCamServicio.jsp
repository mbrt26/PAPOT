<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmCamServicio.jsp">
            <input type="hidden" name="xIdCliente" value="<%=fachadaPluFicha.getIdLocal()%>">
            <input type="hidden" name="xIdTipoOrden" value="<%=fachadaPluFicha.getIdTipoOrden()%>">
                        ...
                        <table border="0" width="90%" id="tablaTitulo">
                            <tr>
                                ...
                                <td width="50%" align="left" class="letraTitulo">
                                    <input type="submit" value="Imprimir Servicio" name="accionContenedor">
                                </td>
                            </tr>
                        </table>
                    </td>
