<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaInventarioCostoCategoria" prefix="lst" %>
    ...
    <body>
        ...
        <table border="0" width="90%" id="tablaTitulo">
            ...
            <lst:listaInventarioCostoCategoria idLineaTag="<%=fachadaCategoriaBean.getIdLineaStr()%>"
                                   idCategoriaTag="<%=fachadaCategoriaBean.getIdCategoriaStr()%>"
                                   idLocalTag="<%=fachadaCategoriaBean.getIdLocalStr()%>"
                                   idBodegaTag="<%=fachadaCategoriaBean.getIdBodegaStr()%>">
                <tr>
            ...
            </lst:listaInventarioCostoCategoria>
        </table>
    </body>
</html>