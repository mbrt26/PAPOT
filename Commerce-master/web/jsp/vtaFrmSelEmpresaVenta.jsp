...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelEmpresaVenta.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    ...
    <tr>
        <td width="5%" align="center" class="letraDetalle"><%=strIdReferenciaVar%></td>
        <td width="5%" align="right" class="letraDetalle">
        <input type="text" name="chkCantidad" id="chkCantidad" value="" size="6"></td>
