<%@page import="com.solucionesweb.losbeans.colaboraciones.ColaboraDctoBean"%>
<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngPagoCxCPlanilla.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="5%" align="center" class="letraTitulo">#FE</td>
                    <td width="5%" align="center" class="letraTitulo">&nbsp;</td>
                    <td width="5%" align="center" class="letraTitulo">&nbsp;</td>
                    <td width="10%" align="right" class="letraTitulo">SALDO</td>
                    <td width="10%" align="right" class="letraTitulo">VR.PAGADO</td>
                    ...
                    <td width="10%" align="right" class="letraTitulo">VR.RTECREE</td>                    
                ...
                idLocalTag="<%=fachadaTerceroBean.getIdLocalStr()%>">
                    ...
                    <tr>
                        <%
                            // int fe=0;
                            ColaboraDctoBean dctoBean = new ColaboraDctoBean();
                            int idDian = dctoBean.dameFacturaElectronica(Integer.parseInt(idDctoVar));
                       // fe=Integer.parseInt(idDctoVar)-29737;
                               //}
%>
                        <td width="5%" align="center" class="letraDetalle"><%=idDctoVar%></td>
                        <td width="5%" align="center" class="letraDetalle"><%=idDian%></td>
                        <td width="5%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngPagoCxCPlanilla.jsp&accionContenedor=PagoParcial&xIdLocal=<%=fachadaTerceroBean.getIdLocalStr()%>&xIdTipoOrden=<%=idTipoOrdenVar%>&xIndicador=<%=indicadorVar%>&xIdCliente=<%=fachadaTerceroBean.getIdCliente()%>&xIdDcto=<%=idDctoVar%>&xIdOrden=<%=idOrdenVar%>&xIdVendedor=<%=fachadaPagoBean.getIdVendedorDi0()%>&xFechaPago=<%=fachadaPagoBean.getFechaPagoCorta()%>">Parcial</a>
                        </td>
                        <td width="5%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmIngPagoCxCPlanilla.jsp&accionContenedor=PagoTotal&xIdLocal=<%=fachadaTerceroBean.getIdLocalStr()%>&xIdTipoOrden=<%=idTipoOrdenVar%>&xIndicador=<%=indicadorVar%>&xIdCliente=<%=fachadaTerceroBean.getIdCliente()%>&xIdDcto=<%=idDctoVar%>&xIdOrden=<%=idOrdenVar%>&xIdVendedor=<%=fachadaPagoBean.getIdVendedorDi0()%>&xFechaPago=<%=fachadaPagoBean.getFechaPagoCorta()%>">Total</a>
                        </td>
