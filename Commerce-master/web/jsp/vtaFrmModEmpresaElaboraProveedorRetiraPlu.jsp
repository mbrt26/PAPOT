...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmModEmpresaElaboraProveedorRetiraPlu.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        <td width="50%" align="right" class="letraTitulo">NUEVA CANTIDAD</td>
        <td width="50%" align="left" class="letraTitulo">NUEVO VR.SUBTOTAL</td>
    </tr>

    <tr>
        <td width="50%" align="right" class="letraDetalle">
            <input name="cantidad" size="20" value="<%=fachadaDctoOrdenDetalleBean.getCantidadStr()%>">
        </td>
        <td width="50%" align="left" class="letraDetalle">
            <input name="chkVrSubtotal" size="20" value="<%=fachadaDctoOrdenDetalleBean.getVrSubtotalCostoStr()%>">
        </td>
    </tr>
</table>
