...
<%@ taglib uri="/WEB-INF/tlds/listaReferenciaProveedor" prefix="lst" %>
...
<head>
    <title>Reporte Referencias Proveedor</title>
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstRefciasProveedorPlu.jsp">

<table border="0" width="90%" id="tablaTitulo">
    <tr>
        <td width="33%" class="letraTitulo">&nbsp;</td>
        <td width="34%" align="center" class="letraTitulo">REPORTE REFERENCAS PROVEEDOR</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
...
<table border="0" width="90%" id="tablaTitulo">
    ...
    <lst:listaReferenciaProveedor idLocalTag="<%=fachadaColaboraReporteDctoBean.getIdLocalStr()%>"
               idTipoOrdenCadenaTag="<%=fachadaColaboraReporteDctoBean.getIdTipoOrdenCadena()%>"
                      idTerceroTag="<%=fachadaColaboraReporteDctoBean.getIdCliente()%>"
