<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaResurtidoTraslado" prefix="lst" %>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmIngResurtidoTraslado.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                idTipoOrdenTag="<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>">
                    ...
                    existenciaActualTag="<%=existenciaActualSf0Var%>">
                        ...
                        <% //if (new Double(cantidadPedidoSugeridoVar).doubleValue() >= 1.0) {%>
                        <td width="30%" align="left" class="<%=letraEstiloVar%>">
                            <%=nombreCategoriaVar%>
                            <%=nombrePluVar%>
                        </td>
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" value="<%=cantidadPedidoSf0Var%>" size="6" maxlength="6" name="xCantidadPedida"></td>
                        ...
                        <td width="5%" align="right" class="<%=letraEstiloVar%>"><%=existenciaActualVar%></td>
                        <td width="5%" align="right" class="<%=letraEstiloVar%>"><%=cantidadInventarioMaximoVar%></td>
