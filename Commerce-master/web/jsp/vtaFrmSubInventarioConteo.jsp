...
<html>
    ...
    <body>
        ...
        <form method="POST" action="GralFileUpLoadServlet" enctype="multipart/form-data">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSubInventarioConteo.jsp">
            <input type="hidden" name="xFechaCorte" size="10" value="<%=fachadaDctoOrdenBean.getFechaOrdenCorta()%>">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">SUBIR CONTEO</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    ...
                    <td width="25%" align="center" class="letraTitulo">
                        <input type="file" name="accionContenedor">
                    </td>
                    <td width="25%" align="center" class="letraTitulo">
                        <input type="submit" value="SubirConteo" name="accionContenedor">
                        </td>
                    <td width="25%" align="center" class="letraTitulo">&nbsp;</td>
                </tr>
            </table>
