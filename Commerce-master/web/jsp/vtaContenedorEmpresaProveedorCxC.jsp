<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorEmpresaProveedorCxC.jsp">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">CXP CONSOLIDADA</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <lsu:listaCuentaLocalDetalle idClienteTag="<%=fachadaTerceroBean.getIdCliente()%>"
                    ...
                    <tr>
                        <td width="25%" align="center" class="letraDetalle"><%=idDctoNitCCVar%></td>
                        <td width="25%" align="center" class="letraDetalle"><%=fechaVencimientoVar%></td>
                        <td width="25%" align="right" class="letraDetalle"><%=diasMoraVar%></td>
