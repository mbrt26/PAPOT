...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstClienteConsultarHPedido.jsp">
    ...
    <lsu:listaPedidoPeriodoLocal idTipoOrdenCadenaTag = "<%=fachadaColaboraLogisticaBean.getIdTipoOrdenCadena()%>"
            ...
            <tr>
                <td width="20%" align="center" class="letraDetalle">
                    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstClienteConsultarHPedido.jsp&accionContenedor=detallarCotizacion&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&idOrden=<%=idOrdenVar%>"><%=idDctoVar%></a>
                </td>
