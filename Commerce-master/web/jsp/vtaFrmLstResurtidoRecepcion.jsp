...
<head>
    <title>Lista Resurtido Compra</title>
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstResurtidoRecepcion.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="34%" align="center" class="letraTitulo">LISTA RESURTIDO RECEPCION</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="10%" align="center" class="letraTitulo">ESTADO</td>
    ...
    <lst:listaLegalizaAll idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoRecepcion.jsp&accionContenedor=coger&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>"><%=idOrdenVar%></a>
            </td>
            ...
            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoRecepcion.jsp&accionContenedor=cumplir&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>">Cumplida</a>
            </td>
