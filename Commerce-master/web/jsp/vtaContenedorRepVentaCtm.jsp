...
<html>
<head>
    <title>Reporte Cinta Testigo Magnetica Ventas</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepVentaCtm.jsp">

        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE CINTA TESTIGO MAGNETICA VENTAS</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
...
</script>           <td width="25%" align="center" class="letraTitulo">
