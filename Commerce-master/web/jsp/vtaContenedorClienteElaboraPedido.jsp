    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest"
                   value="/jsp/vtaContenedorClienteElaboraPedido.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <lista:listaUnTerceroLocal idClienteTag="<%=fachadaTerceroBean.getIdCliente()%>"
                    ...
                    <tr>
                        ...
                        <td width="33%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorClienteElaboraPedido.jsp&accionContenedor=ModificaDescuento&idLog=<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>"><%=fachadaDctoOrdenBean.getDescuentoComercialStr()%></a>
                        </td>
                ...
                <lsv:listaOrden idLocalTag="<%=fachadaTerceroBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="5%"  nowrap align="center" class="<%=letraDetalleInventarioVar%>">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorClienteElaboraPedido.jsp&accionContenedor=Retirar&item=<%=itemVar%>&idLog=<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>">R</a>
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorClienteElaboraPedido.jsp&accionContenedor=ModificarItem&item=<%=itemVar%>&idLog=<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>">M</a>
                        </td>
