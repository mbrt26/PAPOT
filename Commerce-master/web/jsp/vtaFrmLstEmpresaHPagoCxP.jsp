<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstEmpresaHPagoCxP.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    <td width="10%" align="center" class="letraDetalle">#EGRESO</td>
                    ...
                    <td width="10%" align="center" class="letraDetalle">#FACTURA</td>
                ...
                <lista:listaHPagoCxC idLocalTag  = "<%=fachadaColaboraLogisticaBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="10%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaHPagoCxP.jsp&accionContenedor=listaPlanilla&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=fachadaColaboraLogisticaBean.getIdTipoOrdenStr()%>&xIdPlanilla=<%=idPlanillaVar%>"><%=idPlanillaVar%></a>
                        </td>
                        ...
                        <td width="10%" align="center" class="letraDetalle"><%=idDctoNitCCVar%></td>
                        <!--td width="10%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaHPagoCxP.jsp&accionContenedor=listaRecibo&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=fachadaColaboraLogisticaBean.getIdTipoOrdenStr()%>&xIndicador=<%=indicadorVar%>&xIdRecibo=<%=idReciboVar%>"><%=idReciboVar%></a>
                        </td-->
                    </tr>
