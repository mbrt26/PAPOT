...
<%@ taglib uri="/WEB-INF/tlds/listaClienteDesactivo" prefix="lista" %>
...
<form method="POST" action="GralControladorServlet">
  ...
  <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorClienteNuevoDesactivar.jsp">
  ...
  <input size="17" type="hidden" value="<%=fachadaAgendaLogVisitaBean.getIdUsuarioStr()%>" name="xIdUsuario">
   ...
   <table border="0" width="100%">
        <tr>
          <th width="100%" nowrap><div align="left"><p><font face="Verdana" size="2" color="#0000A0"><strong>DESACTIVAR CLIENTE</strong></font></th>
        </tr>
        <tr>
   ...
   <table border="1" width="100%">
    ...
    <lista:listaClienteDesactivo idUsuarioTag = "<%=fachadaAgendaLogVisitaBean.getIdUsuarioStr()%>">
        <tr>
