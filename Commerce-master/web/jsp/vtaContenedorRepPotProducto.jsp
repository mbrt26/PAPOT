...
<html>
<head>
    <title>Reporte Productividad</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepPotProducto.jsp">
        ...
        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                ...
                <td width="34%" align="center" class="letraTitulo">REPORTE PRODUCTIVIDAD</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
