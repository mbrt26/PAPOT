...
<head>
    <title>LISTA RECIBO COMPRA</title>
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstReciboCompra.jsp">
    ...
    <lst:listaLegalizaAll idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstReciboCompra.jsp&accionContenedor=coger&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>"><%=idOrdenVar%></a>
            </td>
