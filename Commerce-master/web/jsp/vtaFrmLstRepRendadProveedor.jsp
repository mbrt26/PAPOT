<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaAudtoriaRepRentabilidadProveedor" prefix="lst" %>
    ...
    <body>
        ...
        <table border="2" width="90%" id="tablaTitulo">
            <tr bgcolor="green">
            <b><td width="35%" align="left" class="letraTitulo">PROVEEDOR</td>
                <td width="5%" align="left" class="letraTitulo">V.BASE</td>
                <td width="5%" align="leftt" class="letraTitulo">COSTO.MV</td>
                <td width="5%" align="right" class="letraTitulo">COSTO.IND</td>
                <td width="5%" align="right" class="letraTitulo">%MARGEN MARCA</td>
                </b>
            </tr>

            <lst:listaAudtoriaRepRentabilidadProveedor
