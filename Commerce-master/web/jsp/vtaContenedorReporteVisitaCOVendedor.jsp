...
<html>
  <head>
    <title>Reporte Visitas C.O./Vendedor</title>
  </head>

  <body>
    <b><font size="5" face="Verdana" color="#0000A0">Reporte Visitas C.O./Vendedor</font></b>
    <p>
    ...
    <form method="POST" action="GralControladorServlet">
      <table border="0" width="68%">
       ...
       <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorReporteVisitaCOVendedor.jsp">
      </b>
        <tr>
      ...
      <tr>
          <td width="1%" nowrap><font face="Verdana" size="1" color="#0000A0"><b>C.O.</b></font></td>
        <b>
          <td width="100%" style="font-family: Verdana; font-size: 10 px">
          <font face="Verdana">
          <%@ include file="./comboLocalesRadio.jsp" %></font></td>
       </b>
      </tr>
    </table>
  </form>
