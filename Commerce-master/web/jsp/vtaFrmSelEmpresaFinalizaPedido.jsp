<HTML>
    ...
    <BODY>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelEmpresaFinalizaPedido.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    <td width="33%" align="left" class="letraDetalle">AUTORIZACION</td>
                    <td width="34%" align="left" class="letraDetalle">
                        <input type="password" name="xAutorizacion" value="" size="6" maxlength="6">
                    </td>
                    <td width="33%" align="left" class="letraDetalle">&nbsp;</td>
                </tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                idLogTag="<%=fachadaAgendaLogVisitaBean.getIdLogStr()%>">
                    <tr>
                        ...
                        <td width="34%" align="left" class="letraResaltadaGrande"><%=vrPagoVar%></td>
                        <td width="33%" align="left" class="letraResaltadaGrande"><%=vrCambioVar%></td>
                    </tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="left" class="letraDetalle">
                        <jsp:include page="./comboUsuarioPorDefecto.jsp"/>
                    </td>
                    <td width="33%" align="left" class="letraDetalle">&nbsp;</td>
                </tr>
            </table>
