...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmConResurtidoDespacho.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="5%" align="right" class="letraTitulo">AJUSTE(+)</td>
        <td width="5%" align="right" class="letraTitulo">AJUSTE(-)</td>
    ...
    <lst:listaResurtidoAjuste idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmConResurtidoDespacho.jsp&accionContenedor=tomar&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrden=<%=idOrdenVar%>"><%=idOrdenVar%></a>
            </td>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmConResurtidoDespacho.jsp&accionContenedor=ajustePositivo&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrden=<%=idOrdenVar%>">Ajuste(+)</a>
            </td>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmConResurtidoDespacho.jsp&accionContenedor=ajusteNegativo&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>&xIdOrden=<%=idOrdenVar%>">Ajuste(-)</a>
            </td>
