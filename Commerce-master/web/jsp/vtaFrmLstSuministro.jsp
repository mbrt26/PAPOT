...
<head>
    <title>LISTA RESURTIDO SUMINITRO</title>
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstSuministro.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="34%" align="center" class="letraTitulo">Lista Resurtido Suministro</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
    ...
    <lst:listaLegalizaAll idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
        ...
        <tr>
            <td width="5%" align="right" class="letraDetalle">
                <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstSuministro.jsp&accionContenedor=coger&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=idLogVar%>"><%=idOrdenVar%></a>
            </td>
