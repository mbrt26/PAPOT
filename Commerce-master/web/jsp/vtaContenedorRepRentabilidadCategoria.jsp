...
<html>
<head>
    <title>Reporte Rentabilidad Por Categoria</title>
...
<body>
    <form method="POST" action="GralControladorServlet">
        <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorRepRentabilidadCategoria.jsp">

        <table border="0" width="90%" id="tablaTitulo">
            <tr>
                <td width="33%" class="letraTitulo">&nbsp;</td>
                <td width="34%" align="center" class="letraTitulo">REPORTE RENTABILIDAD POR CATEGORIA</td>
                <td width="33%" class="letraTitulo">&nbsp;</td>
            </tr>
            <tr>
