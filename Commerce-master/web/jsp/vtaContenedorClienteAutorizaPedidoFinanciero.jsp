...
<form method="POST" action="GralControladorServlet">
  <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorClienteAutorizaPedidoFinanciero.jsp">
...
<table border="1" class="separado" width="100%" height="30">
  <tr>
    ...
    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaContenedorClienteAutorizaPedidoFinanciero.jsp&accionContenedor=detallarCotizacion&idLog=<%=idLogVar%>&idOrden=<%=idOrdenVar%>"><%=strNumeroCotizacionVar%></a>
    </td>
