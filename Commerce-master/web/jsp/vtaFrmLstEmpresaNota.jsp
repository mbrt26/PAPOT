...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstEmpresaNota.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    ...
    <tr>
        ...
        <td width="20%" align="center" class="letraTitulo">VALOR$</td>
    ...
    <lsu:listaPedidoPeriodoLocal idTipoOrdenCadenaTag = "<%=fachadaColaboraLogisticaBean.getIdTipoOrdenCadena()%>"
            ...
            <tr>
                <td width="20%" align="center" class="letraDetalle">
                    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstEmpresaNota.jsp&accionContenedor=detallarCotizacion&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&xIdDcto=<%=idDctoVar%>&xIdOrden=<%=idOrdenVar%>&xIndicador=<%=indicadorVar%>"><%=idDctoVar%></a>
                </td>
