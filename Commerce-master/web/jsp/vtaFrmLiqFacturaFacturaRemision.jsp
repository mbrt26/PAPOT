<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaOP" prefix="lsv" %>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest"
                   value="/jsp/vtaFrmLiqFacturaFacturaRemision.jsp">
            ...
            <input type="hidden" name="xIdCliente"
                   value="<%=fachadaDctoOrdenBean.getIdCliente()%>">
            <input type="hidden" name="xIdTipoAlcance"
                   value="<%=fachadaDctoOrdenBean.getIdAlcance()%>">

            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">ELABORAR FACTURA</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="5%" nowrap align="left" class="letraTitulo">PRECIO</td>
                    <td width="5%" nowrap align="left" class="letraTitulo">PREC IVA</td>
                    <td width="10%" nowrap align="right" class="letraTitulo">CAN.PEN</td>
                ...
                <lsv:listaOP idLocalTag="<%=fachadaDctoOrdenBean.getIdLocalStr()%>"
                ...
                idBodegaTag="<%=xIdBodega%>">
                   ...
                   <input type="hidden"  name="xItemOrden" value="<%=itemOrdenVar%>">
                   <input type="hidden"  name="xItem" value="<%=itemVar%>">
                    <tr>
                        <td width="5%"  nowrap align="center" class="<%=letraDetalleInventarioVar%>">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLiqFacturaFacturaRemision.jsp.jsp&accionContenedor=Retirar&xIdLocal=<%=fachadaDctoOrdenBean.getIdLocalStr()%>&xIdLog=<%=fachadaDctoOrdenBean.getIdLogStr()%>&xIdBodega=<%=xIdBodega%>&xItem=<%=itemVar%>&xIdOperacion=<%=fachadaDctoOrdenBean.getIdOperacionStr()%>">R</a>
                        </td>
                        ...
                        <td width="5%" nowrap align="left" class="letraResaltadaGrande"><%=vrVentaOriginal%></td>
                        <td width="5%" nowrap align="left" class="letraResaltadaGrande"><%=vrVentaUnitarioVar%></td>
                        <td width="10%" nowrap align="right" class="letraResaltadaGrande"><%=cantidadPendienteVar%></td>
                        ...
                        <td width="10%" nowrap align="right" class="<%=letraDetalleInventarioVar%>">
                            <input type="number" step="0.1" value="<%=pesoPendienteVar%>" name="xPesoPendiente" min ="0" size="6" maxlength="6">
                        </td>
                        <td width="10%" nowrap align="right" class="letraResaltadaGrande">
                            <input type="number" step="0.1" name="xCantidadPendiente" value="<%=cantidadPendienteVar%>"  size="6" maxlength="6">
                        </td>
                    </tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="25%" align="center" class="letraTitulo">
                        <input type="submit" value="Finaliza Factura" name="accionContenedor">
                    </td>
                    <td width="25%" align="center" class="letraTitulo">
