<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmSelRetencion.jsp">
                ...
                <lst:listaRetencion>
                    <tr>
                        <td width="10%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmSelRetencion.jsp&accionContenedor=Traer&xIdConcepto=<%=idConceptoVar%>&xIdSubcuenta=<%=idSubcuentaVar%>&xIdPersona=<%=idPersonaVar%>"><%=idConceptoVar%></a>
                        </td>
