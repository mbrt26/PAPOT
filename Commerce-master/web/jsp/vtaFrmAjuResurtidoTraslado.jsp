<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaAjuste" prefix="lst" %>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmAjuResurtidoTraslado.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">AJUSTAR TRASLADO</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
                ...
                <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="10%" align="right" class="letraTitulo">CANT.AJU</td>
                    <td width="10%" align="right" class="letraTitulo">CAN.TRA</td>
                ...
                <lst:listaAjuste idLocalTag="<%=fachadaColaboraDctoOrdenBean.getIdLocalStr()%>"
                             idTipoOrdenTag="<%=fachadaColaboraDctoOrdenBean.getIdTipoOrdenStr()%>"
                                 idOrdenTag="<%=fachadaColaboraDctoOrdenBean.getIdOrdenStr()%>">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="20%" align="center" class="letraTitulo">
                        <input type="submit" value="Ajustar" name="accionContenedor">
                    </td>
