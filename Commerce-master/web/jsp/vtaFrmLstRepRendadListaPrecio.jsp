<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaAudtoriarepRentabilidadListaPrecio" prefix="lst" %>
    ...
    <body>
        ...
        <table border="2" width="90%" id="tablaTitulo">
            <tr bgcolor="green">
            <b>
                <td width="10%" align="leftt" class="letraTitulo">LISTA PRECIO</td>
            ...
            <lst:listaAudtoriarepRentabilidadListaPrecio
                ...
                <tr>
                    <td width="10%" align="left" class="letraDetalle"><%=idListaPrecioVar%></td>
