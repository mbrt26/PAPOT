...
<%
            ...
            while (iteratorObjetos.hasNext()) {
                ...
                Results.append("<idDcto>" + fachadaBean.getIdDcto() + "</idDcto>");
                Results.append("<idCliente>" + fachadaBean.getIdCliente() + "</idCliente>");
                Results.append("<fechaDcto>" + fachadaBean.getFechaDcto() + "</fechaDcto>");
                Results.append("<vrBase>" + fachadaBean.getVrBase() + "</vrBase>");
                Results.append("<vrPago>" + fachadaBean.getVrPago() + "</vrPago>");
                Results.append("<vrIva>" + fachadaBean.getVrIva() + "</vrIva>");
                ...
                Results.append("<vrRteIva>" + fachadaBean.getVrRteIva() + "</vrRteIva>");
                Results.append("<vrRteIca>" + fachadaBean.getVrRteIca() + "</vrRteIca>");
                ...
                Results.append("<vrDsctoFcro>" + fachadaBean.getVrDsctoFcro() + "</vrDsctoFcro>");
                Results.append("<vrCostoMV>" + fachadaBean.getVrCostoMV() + "</vrCostoMV>");
                Results.append("<vrImpoconsumo>" + fachadaBean.getVrImpoconsumo() + "</vrImpoconsumo>");
                Results.append("<porcentajeIva>" + fachadaBean.getPorcentajeIva() + "</porcentajeIva>");
                Results.append("<vrVentaSinIva>" + fachadaBean.getVrVentaSinIva() + "</vrVentaSinIva>");
                Results.append("<vrIvaVenta>" + fachadaBean.getVrIvaVenta() + "</vrIvaVenta>");
