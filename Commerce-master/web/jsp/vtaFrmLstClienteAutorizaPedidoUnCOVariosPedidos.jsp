...
<jsp:useBean id="fachadaColaboraDctoOrdenBean"
  ...
  <body>
    <b><font size="5" face="Verdana" color="#0000A0">AUTORIZAR PEDIDO</font><font face="Verdana">
	</font> </b>
...
<table border="0" width="100%" class="letraTitulo">
	<tr>
		...
		<img src="./imagenes/logo30.JPG"></font></b></td>
	...
	<tr>
		...
		<td width="8%" align="right" class="letraTitulo">VR.VENTA</td>
  ...
  <lista:listaDetallePedidoIdLog idOrdenTag = "<%=fachadaColaboraDctoOrdenBean.getIdOrdenStr()%>"
 	...
 	<tr>
        ...
        <font face="Verdana">
        <input type="hidden" name="item" value="<%=itemVar%>">
		</font>
	</tr>
	...
	<tr>
       ...
       <table border="1" width="100%" id="table5">
		<tr>
			...
			<td><input type="submit" value="Autorizar" name="accionContenedor"></td>
			<td><input type="submit" value="Cancelar" name="accionContenedor"></td>
		</tr>
       </table>

       <font face="Verdana">

       <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstClienteAutorizaPedidoUnCOVariosPedidos.jsp">
       <input type="hidden" name="idLog" value="<%=fachadaColaboraDctoOrdenBean.getIdLogStr()%>">
       <input type="hidden" name="idOrden" value="<%=fachadaColaboraDctoOrdenBean.getIdOrdenStr()%>">
   </font>
   </form>
    <font face="Verdana">
  	</b>
