...
<head>
    <title>Historico Resurtido</title>
...
<input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLstResurtidoNota.jsp">
...
<table border="0" width="90%" id="tablaTitulo">
    <tr>
        ...
        <td width="34%" align="center" class="letraTitulo">HISTORICO RESURTIDO</td>
        <td width="33%" class="letraTitulo">&nbsp;</td>
    </tr>
    <tr>
...
<table border="0" width="90%" id="tablaTitulo">
    ...
    <tr>
        <td width="20%" align="center" class="letraTitulo">#FACTURA</td>
        <td width="20%" align="center" class="letraTitulo">TIPO</td>
        <td width="20%" align="center" class="letraTitulo">TIPO</td>
        <td width="20%" align="center" class="letraTitulo">FEC.FRA.</td>
        <td width="20%" align="right" class="letraTitulo">#ARTICULOS</td>
        <td width="20%" align="center" class="letraTitulo">V.FACTURA</td>
    </tr>
    ...
    <lsu:listaPedidoPeriodoLocal idTipoOrdenCadenaTag = "<%=fachadaColaboraLogisticaBean.getIdTipoOrdenCadena()%>"
            ...
            <tr>
                ...
                <td width="20%" align="center" class="letraDetalle">
                    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoNota.jsp&accionContenedor=detallarCotizacion&xTipoNota=notaCredito&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&xIdDcto=<%=idDctoSf0Var%>&xIdOrden=<%=idOrdenVar%>&xIndicador=<%=indicadorVar%>&xIdDctoNitCC=<%=idDctoNitCCVar%>">Crédito(-)</a>
                </td>
                <td width="20%" align="center" class="letraDetalle">
                    <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLstResurtidoNota.jsp&accionContenedor=detallarCotizacion&xTipoNota=notaDebito&idLocal=<%=idLocalVar%>&idTipoOrden=<%=idTipoOrdenVar%>&xIdDcto=<%=idDctoSf0Var%>&xIdOrden=<%=idOrdenVar%>&xIndicador=<%=indicadorVar%>&xIdDctoNitCC=<%=idDctoNitCCVar%>">Débito(+)</a>
                </td>
