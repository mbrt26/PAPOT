<html>
    ...
    <jsp:useBean id="fachadaLocalTercero"
                 scope="request"
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmCamCatalogoClienteLocal.jsp">
            <input type="hidden" name="xIdCliente" value="<%=fachadaLocalTercero.getIdCliente()%>">
            <input type="hidden" name="xIdLocalTercero" value="<%=fachadaLocalTercero.getIdLocalTerceroStr()%>">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <%=fachadaLocalTercero.getIdCliente()%>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xNombreEmpresa" type="text" value="<%=fachadaLocalTercero.getNombreEmpresa()%>" size="40" maxlength="40">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xDireccionTercero" type="text" size="50"  maxlength="50" value="<%=fachadaTerceroBean.getDireccionTercero()%>">
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xTelefonoFijo" type="text" value="<%=fachadaLocalTercero.getTelefonoFijo()%>" size="30" maxlength="30">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xTelefonoCelular" type="text" value="<%=fachadaLocalTercero.getTelefonoCelular()%>" size="30" maxlength="30">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xTelefonoFax" type="text" id="telefonoFax" value="<%=fachadaLocalTercero.getTelefonoFax()%>" size="30" maxlength="30">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xContactoTercero" type="text" value="<%=fachadaLocalTercero.getContactoTercero()%>" size="40" value=""  maxlength="40">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="33%" class="letraDetalle">
                        <input name="xEmail" type="text" id="email" value="<%=fachadaLocalTercero.getEmail()%>" size="40" maxlength="40">
                    </td>
                </tr>
