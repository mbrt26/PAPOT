<html>
    ...
    <body>
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmRetEmpresaHPagoCxP.jsp">
                ...
                <lista:listaHPagoCxC idLocalTag  = "<%=fachadaColaboraLogisticaBean.getIdLocalStr()%>"
                    ...
                    <tr>
                        <td width="10%" align="center" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmRetEmpresaHPagoCxP.jsp&accionContenedor=retiraRecibo&xIdLocal=<%=idLocalVar%>&xIdTipoOrden=<%=fachadaColaboraLogisticaBean.getIdTipoOrdenStr()%>&xIndicador=<%=indicadorVar%>&xIdRecibo=<%=idReciboVar%>&xFechaInicial=<%=fachadaColaboraLogisticaBean.getFechaInicial()%>&xFechaFinal=<%=fachadaColaboraLogisticaBean.getFechaFinal()%>&xIdCliente=<%=fachadaColaboraLogisticaBean.getIdCliente()%>"><%=idReciboVar%></a>
                        </td>
