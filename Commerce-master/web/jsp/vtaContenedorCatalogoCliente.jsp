<html>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaContenedorCatalogoCliente.jsp">
          ...
          ArrayList<FachadaTerceroBean> listaFachadaCliente2 = tercero.listaResponsabilidades();
            ...
            %>
            <table class="table" border="0" width="90%" id="tablaTitulo">
                <tr>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                    <td width="34%" align="center" class="letraTitulo">CATALOGO CLIENTE</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                ...
                <tr>
                    <td width="33%" class="letraDetalle">FECHA MAXIMA FACTURACION</td>
                    <td width="34%" align="left" class="letraDetalle">
                ...
                <tr>
                    ...
                    <select name="xIdRes<%=i%>" id="xIdRes<%=i%>">
                       ...
                       for (FachadaTerceroBean listaTercero2 : listaFachadaCliente2){
                            ...
                            if(listaTercero2.getIdResponsabilidad()!= null) {descripcionResponsabilidad = listaTercero2.getIdResponsabilidad()+" - "+ listaTercero2.getNombreResponsabilidad();}else{
                            descripcionResponsabilidad = "SELECCIONE";
                            }
                            %>
