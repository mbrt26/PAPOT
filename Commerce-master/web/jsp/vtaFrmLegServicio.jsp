<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaSuministro" prefix="lst" %>
    ...
    <head>
        <title>Resurtido Servicio</title>
    ...
    <body>
        ...
        <form method="POST" action="GralControladorServlet">
            <input type="hidden" name="nombrePaginaRequest" value="/jsp/vtaFrmLegServicio.jsp">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="34%" align="center" class="letraTitulo">RESURTIDO SERVICIO</td>
                    <td width="33%" class="letraTitulo">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="5%" align="right" class="letraTitulo">OPERACION</td>
                    <td width="35%" align="left" class="letraTitulo">NOMBRE REFERENCIA</td>
                    <td width="5%" align="left" class="letraTitulo">&nbsp;</td>
                </tr>
                <lst:listaSuministro idLocalTag="<%=fachadaColaboraDctoOrdenBean.getIdLocalStr()%>"
                ...
                idLogTag="<%=fachadaColaboraDctoOrdenBean.getIdLogStr()%>">
                    ...
                    <tr>
                        ...
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="xVrSubtotalArr" value="<%=vrCostoResurtidoSf0Var%>" size="10" maxlength="10">
                        </td>
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="xPorcentajeIvaArr" value="<%=porcentajeIvaVar%>" size="4" maxlength="4">
                        </td>
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="xVrIvaResurtidoArr" value="<%=vrIvaResurtidoSf0Var%>" size="10" maxlength="10">
                        </td>
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="xNumeroOrdenArr" value="<%=numeroOrdenVar%>" size="10" maxlength="10" readonly>
                        </td>
                        <td width="5%" align="right" class="letraDetalle">
                            <input type="text" name="xIdOperacionArr" value="<%=idOperacionVar%>" size="10" maxlength="10" readonly>
                        </td>
                        ...
                        <td width="5%" align="left" class="letraDetalle">
                            <a href="GralControladorServlet?nombrePaginaRequest=/jsp/vtaFrmLegSuministro.jsp&accionContenedor=retira&xIdLocal=<%=fachadaColaboraDctoOrdenBean.getIdLocalStr()%>&xIdTipoOrden=<%=fachadaColaboraDctoOrdenBean.getIdTipoOrdenStr()%>&xIdLog=<%=fachadaColaboraDctoOrdenBean.getIdLogStr()%>&xIdPlu=<%=idPluVar%>">RET</a>
                        </td>
                    </tr>
                </lst:listaSuministro>
                <tr>
                    ...
                    <td width="35%" align="left" class="letraDetalle">
                        ...
                        <input type="text" name="xNumeroOrden" id="xNumeroOrden" size="10" tabindex="1" maxlength="10">
            ...
            <table border="0" width="90%" id="tablaTitulo">
                <tr>
                    ...
                    <td width="10%" align="center" class="letraTitulo">FECHA FACTURA</td>
                ...
                <tr>
                    <td width="10%" align="left" class="letraResaltadaGrande">FACTURA PROVEEDOR</td>
