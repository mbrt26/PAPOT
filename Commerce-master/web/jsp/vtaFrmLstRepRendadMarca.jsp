<html>
    ...
    <%@ taglib uri="/WEB-INF/tlds/listaAudtoriaRepRentabilidadMarca" prefix="lst" %>
    ...
    <body>
        ...
        <table border="2" width="90%" id="tablaTitulo">
            <tr bgcolor="green">
            <b><td width="35%" align="left" class="letraTitulo">MARCA</td>
            ...
            <lst:listaAudtoriaRepRentabilidadMarca
                ...
                <tr>
                    <td width="35%" align="left" class="letraDetalle"><%=nombreMarcaVar%></td>
