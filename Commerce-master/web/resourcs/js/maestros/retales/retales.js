function cargarBodegas() {
    ...
    $.post('RetalesServlet', {xopcion: 'listaBodegas'}, function (e) {
        $('#detalle').html(e);
    });
}
function creaBodega() {
    ...
    if (bod == "") {
        ...
        $.post('RetalesServlet', {xopcion: 'crear', xbodega: bod}, function (e) {
            $('#detalle').html(e);
            $('#bodega').val('');
            $('#bodega').focus();
...
function editar(_id) {
    $.post('RetalesServlet', {xopcion: 'ListaBodegaEditar', xskmarca: _id}, function (e) {
...
function ActualizarBodega() {
    ...
    $.post('RetalesServlet', {xopcion: 'ActualizarNombre', xnombre: nombre, skbodega: bodega}, function (e) {
        $('#detalle').html(e);
    });
}
...
function eliminar(_id) {
    $.post('RetalesServlet', {xopcion: 'EliminaBodega', skbodega: _id}, function (e) {
        $('#detalle').html(e);
    });
}
