...
nodo = getFromRoot(2,0); // Administrador Comision
...
nodo = getFromRoot(2,1); // Administrador Bonificacion
...
//
nodo = getFromRoot(3,1); // Reportes Compras
...
//
nodo = getFromRoot(3,2); // Reportes Inventarios
...
//
nodo = getFromRoot(3,3); // Reportes Resurtido
...
//
nodo = getFromRoot(3,4); // Reportes Margen
...
nodo = getFromRoot(3,5); // Reportes Cuadre Caja
