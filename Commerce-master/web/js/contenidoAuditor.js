...
//
//nodo = getFromRoot(2,1); // Catalogos Usuario
...
nodo = getFromRoot(3,0); // Administrador Inventario
...
nodo = getFromRoot(3,1); // Administrador Comision
...
nodo = getFromRoot(3,2); // Administrador Bonificacion
...
//nodo = getFromRoot(3,3); // Administrador Cuadre Caja
...
//nodo = getFromRoot(3,4); // Administrador Contable
...
nodo = getFromRoot(4,4); // Reportes Cuadre Caja
...
nodo = getFromRoot(4,5,0); //Auditorias
...
nodo = getFromRoot(4,5,1); //Auditorias
...
//
nodo = getFromRoot(6) // Salida Segura
