...
<html>
    ...
    <body onload="cargarBodegas()">
        ...
        <form method="post" action="CargarInventario?action=subir" enctype="multipart/form-data">
            ...
            <div  class="h5 titulo" >ORDEN DE COMPRA</div> 
                        ...
                        <div class="panel-body">
                            <div class="input-group mb-3 input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-weight: bold">PROVEEDOR</span>
                                </div>
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-weight: bold">FECHA</span>
                                </div>
                                <input class="col-1" readOnly="readOnly" id="fechainicial">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"  style="font-weight:bold">Nº ORDEN</span>
                                </div>
