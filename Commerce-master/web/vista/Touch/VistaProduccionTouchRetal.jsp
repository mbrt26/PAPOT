    ...
    <body onload="cargar()">
        ...
        <form method="POST" id="formularioRetal" action="GralControladorServlet">
            ...
            <div class="page-header">
                <div  class="p-1 h5 titulo bg-success " ><i class="fas fa-trash"></i> REGISTRAR RETAL </div> 
            </div>
            <div id ="tabs" class="container col-12">

                <input type="hidden" name="nombrePaginaRequest" value="vista/Touch/VistaProduccionTouchRetal.jsp">
                <div id="alerta"  hidden="true" class="alert fade alert-success alert-dismissible fade show" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <h5 class="alert-heading">¡Retal Registrado Exitosamente!  <i class="far fa-check-circle"></i></h5>
                    <h7> Haga click <a onclick="recargarPagina()" name="xoption" value="recargar" type="submit" class="alert-link">AQUI</a> si desea realizar otro registro.</h7>
                </div>
                <div id="alertaError"  hidden="true" class="alert fade alert-danger alert-dismissible fade show" role="alert">
                    ...
                    <h7> Haga click <a onclick="recargarPagina()" name="xoption" value="recargar" type="submit" class="alert-link">AQUI</a> para intentar de nuevo.</h7>
                </div>
                ...
                <div class="card card-body text-white badge-light mb-3 card border-primary mb-2">
                    ...
                    <div class="input-group mb-3 input-group-sm">
                        ...
                        <div class="card col-md-6">
                            <h6 class="card-header text-warning text-center bg-transparent" ><i class="fas fa-trash" ></i> RETAL</h6>
                            <div class="row">
                                <div class="col"></div>
                                <div class="col" > 
                ...
                <div class="modal-content">
                    <div class="modal-header bg-success">
                        <div class="modal-title " id="exampleModalLabel">
                            <h6 class="modal-title text-white text-md-center" >Confirme Cantidad Retal <i class="fa fa-trash-alt"></i></h6>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="ret">Retal:</label>
                            <input  id="retalModal" disabled="true" type="text" class="form-control" id="ret">
                        </div>
                        <div class="row">
                            <div class="col-md-4"></div> 
                            <div class="col-md-4">
                                <input class="form-control form-control-sm input-group-append input-group-sm text-md-center col-12" onkeyup ="confirmarRetalT(event)" onclick="confirmarRetalT(event)" type="number" min="0" id ="cantidadRetal" step="0.1" placeholder="Cantidad Kg">
                            </div> 
                            <div class="col-md-4"></div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id = "botonInsertar" disabled="true" onclick="miFuncion()" type="button" title="Guardar Retal" class="btn btn-success btn-sm col-md-3"><i class="far fa-check-circle"></i> Confirmar </button>
                    </div>
                </div>
            </div>
        </div>
